...
80100394:	e8 b7 02 00 00       	call   80100650 <cprintf>
  cprintf("\n");
80100399:	c7 04 24 cb 78 10 80 	movl   $0x801078cb,(%esp)
...
80100bef:	e8 3c 61 00 00       	call   80106d30 <copyout>
...
80100c01:	e8 da 5d 00 00       	call   801069e0 <freevm>
  return -1;
...
80100c6d:	89 95 60 ff ff ff    	mov    %edx,-0xa0(%ebp)
  if(copyout(pgdir, sp, ustack, (3+argc+1)*4) < 0)
80100c73:	e8 b8 60 00 00       	call   80106d30 <copyout>
...
80100cc5:	8b 77 04             	mov    0x4(%edi),%esi
  curproc->pages = 1;
80100cc8:	c7 47 08 01 00 00 00 	movl   $0x1,0x8(%edi)
  cprintf("Initial number of pages by the process %d\n", curproc->pages);
80100ccf:	c7 44 24 04 01 00 00 	movl   $0x1,0x4(%esp)
80100cd6:	00 
80100cd7:	c7 04 24 d0 6e 10 80 	movl   $0x80106ed0,(%esp)
80100cde:	e8 6d f9 ff ff       	call   80100650 <cprintf>
  sz = PGROUNDUP(sz);
80100ce3:	8b 85 ec fe ff ff    	mov    -0x114(%ebp),%eax
  curproc->pgdir = pgdir;
80100ce9:	8b 95 f0 fe ff ff    	mov    -0x110(%ebp),%edx
  sz = PGROUNDUP(sz);
80100cef:	05 ff 0f 00 00       	add    $0xfff,%eax
80100cf4:	25 00 f0 ff ff       	and    $0xfffff000,%eax
80100cf9:	89 07                	mov    %eax,(%edi)
  curproc->tf->eip = elf.entry;  // main
80100cfb:	8b 47 1c             	mov    0x1c(%edi),%eax
  curproc->pgdir = pgdir;
80100cfe:	89 57 04             	mov    %edx,0x4(%edi)
  curproc->tf->eip = elf.entry;  // main
...
80100d13:	e8 48 59 00 00       	call   80106660 <switchuvm>
  freevm(oldpgdir);
80100d18:	89 34 24             	mov    %esi,(%esp)
80100d1b:	e8 c0 5c 00 00       	call   801069e0 <freevm>
  return 0;
...
80100d46:	c7 44 24 04 fb 6e 10 	movl   $0x80106efb,0x4(%esp)
80100d4d:	80 
...
80100e06:	c3                   	ret    
    panic("filedup");
80100e07:	c7 04 24 02 6f 10 80 	movl   $0x80106f02,(%esp)
...
80100ec7:	e9 b4 1c 00 00       	jmp    80102b80 <end_op>
    panic("fileclose");
80100ecc:	c7 04 24 0a 6f 10 80 	movl   $0x80106f0a,(%esp)
...
80100fb5:	eb d8                	jmp    80100f8f <fileread+0x5f>
  panic("fileread");
80100fb7:	c7 04 24 14 6f 10 80 	movl   $0x80106f14,(%esp)
...
801010cc:	e9 1f 22 00 00       	jmp    801032f0 <pipewrite>
        panic("short filewrite");
801010d1:	c7 04 24 1d 6f 10 80 	movl   $0x80106f1d,(%esp)
801010d8:	e8 83 f2 ff ff       	call   80100360 <panic>
  panic("filewrite");
801010dd:	c7 04 24 23 6f 10 80 	movl   $0x80106f23,(%esp)
...
80101195:	c7 04 24 2d 6f 10 80 	movl   $0x80106f2d,(%esp)
...
801012bd:	c7 04 24 43 6f 10 80 	movl   $0x80106f43,(%esp)
...
80101375:	eb 93                	jmp    8010130a <bmap+0x3a>
  panic("bmap: out of range");
80101377:	c7 04 24 53 6f 10 80 	movl   $0x80106f53,(%esp)
...
80101459:	c7 04 24 66 6f 10 80 	movl   $0x80106f66,(%esp)
...
8010147c:	c7 44 24 04 79 6f 10 	movl   $0x80106f79,0x4(%esp)
80101483:	80 
...
80101499:	c7 44 24 04 80 6f 10 	movl   $0x80106f80,0x4(%esp)
801014a0:	80 
...
801014c6:	c7 04 24 e4 6f 10 80 	movl   $0x80106fe4,(%esp)
...
801015e1:	c7 04 24 86 6f 10 80 	movl   $0x80106f86,(%esp)
...
80101764:	0f 85 76 ff ff ff    	jne    801016e0 <ilock+0x30>
      panic("ilock: no type");
8010176a:	c7 04 24 9e 6f 10 80 	movl   $0x80106f9e,(%esp)
80101771:	e8 ea eb ff ff       	call   80100360 <panic>
    panic("ilock");
80101776:	c7 04 24 98 6f 10 80 	movl   $0x80106f98,(%esp)
...
801017be:	e9 1d 28 00 00       	jmp    80103fe0 <releasesleep>
    panic("iunlock");
801017c3:	c7 04 24 ad 6f 10 80 	movl   $0x80106fad,(%esp)
...
80101c61:	c3                   	ret    
      panic("dirlookup read");
80101c62:	c7 04 24 c7 6f 10 80 	movl   $0x80106fc7,(%esp)
80101c69:	e8 f2 e6 ff ff       	call   80100360 <panic>
    panic("dirlookup not DIR");
80101c6e:	c7 04 24 b5 6f 10 80 	movl   $0x80106fb5,(%esp)
...
80101ee3:	eb e9                	jmp    80101ece <dirlink+0xae>
      panic("dirlink read");
80101ee5:	c7 04 24 d6 6f 10 80 	movl   $0x80106fd6,(%esp)
80101eec:	e8 6f e4 ff ff       	call   80100360 <panic>
    panic("dirlink");
80101ef1:	c7 04 24 c6 75 10 80 	movl   $0x801075c6,(%esp)
...
80101fdf:	c7 04 24 40 70 10 80 	movl   $0x80107040,(%esp)
80101fe6:	e8 75 e3 ff ff       	call   80100360 <panic>
    panic("idestart");
80101feb:	c7 04 24 37 70 10 80 	movl   $0x80107037,(%esp)
...
80102006:	c7 44 24 04 52 70 10 	movl   $0x80107052,0x4(%esp)
8010200d:	80 
...
801021d9:	eb bb                	jmp    80102196 <iderw+0x76>
    panic("iderw: buf not locked");
801021db:	c7 04 24 56 70 10 80 	movl   $0x80107056,(%esp)
801021e2:	e8 79 e1 ff ff       	call   80100360 <panic>
    panic("iderw: ide disk 1 not present");
801021e7:	c7 04 24 81 70 10 80 	movl   $0x80107081,(%esp)
801021ee:	e8 6d e1 ff ff       	call   80100360 <panic>
    panic("iderw: nothing to do");
801021f3:	c7 04 24 6c 70 10 80 	movl   $0x8010706c,(%esp)
...
80102248:	c7 04 24 a0 70 10 80 	movl   $0x801070a0,(%esp)
...
8010237c:	eb bb                	jmp    80102339 <kfree+0x49>
    panic("kfree");
8010237e:	c7 04 24 d2 70 10 80 	movl   $0x801070d2,(%esp)
...
801023eb:	c7 44 24 04 d8 70 10 	movl   $0x801070d8,0x4(%esp)
801023f2:	80 
...
80102e45:	e8 76 3f 00 00       	call   80106dc0 <shminit>
  tvinit();        // trap vectors
...
801035e6:	c7 44 24 04 b5 73 10 	movl   $0x801073b5,0x4(%esp)
801035ed:	80 
...
8010365a:	c7 04 24 bc 73 10 80 	movl   $0x801073bc,(%esp)
80103661:	e8 fa cc ff ff       	call   80100360 <panic>
    panic("mycpu called with interrupts enabled\n");
80103666:	c7 04 24 98 74 10 80 	movl   $0x80107498,(%esp)
...
80103782:	00 
80103783:	c7 44 24 04 e5 73 10 	movl   $0x801073e5,0x4(%esp)
8010378a:	80 
8010378b:	89 04 24             	mov    %eax,(%esp)
8010378e:	e8 cd 0c 00 00       	call   80104460 <safestrcpy>
  p->cwd = namei("/");
80103793:	c7 04 24 ee 73 10 80 	movl   $0x801073ee,(%esp)
...
801037c7:	c7 04 24 cc 73 10 80 	movl   $0x801073cc,(%esp)
...
80103885:	e8 b6 32 00 00       	call   80106b40 <copyuvm>
...
80103a6e:	c7 04 24 f0 73 10 80 	movl   $0x801073f0,(%esp)
80103a75:	e8 e6 c8 ff ff       	call   80100360 <panic>
    panic("sched interruptible");
80103a7a:	c7 04 24 1c 74 10 80 	movl   $0x8010741c,(%esp)
80103a81:	e8 da c8 ff ff       	call   80100360 <panic>
    panic("sched running");
80103a86:	c7 04 24 0e 74 10 80 	movl   $0x8010740e,(%esp)
80103a8d:	e8 ce c8 ff ff       	call   80100360 <panic>
    panic("sched locks");
80103a92:	c7 04 24 02 74 10 80 	movl   $0x80107402,(%esp)
...
80103b96:	e8 65 fe ff ff       	call   80103a00 <sched>
  panic("zombie exit");
80103b9b:	c7 04 24 3d 74 10 80 	movl   $0x8010743d,(%esp)
80103ba2:	e8 b9 c7 ff ff       	call   80100360 <panic>
    panic("init exiting");
80103ba7:	c7 04 24 30 74 10 80 	movl   $0x80107430,(%esp)
...
80103c8e:	c7 04 24 4f 74 10 80 	movl   $0x8010744f,(%esp)
80103c95:	e8 c6 c6 ff ff       	call   80100360 <panic>
    panic("sleep");
80103c9a:	c7 04 24 49 74 10 80 	movl   $0x80107449,(%esp)
...
80103e84:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    ...
    cprintf("\n");
80103e88:	c7 04 24 cb 78 10 80 	movl   $0x801078cb,(%esp)
...
80103eaa:	83 f8 05             	cmp    $0x5,%eax
      state = "???";
80103ead:	ba 60 74 10 80       	mov    $0x80107460,%edx
    if(p->state >= 0 && p->state < NELEM(states) && states[p->state])
80103eb2:	77 11                	ja     80103ec5 <procdump+0x55>
80103eb4:	8b 14 85 c0 74 10 80 	mov    -0x7fef8b40(,%eax,4),%edx
      state = "???";
80103ebb:	b8 60 74 10 80       	mov    $0x80107460,%eax
...
80103ed0:	c7 04 24 64 74 10 80 	movl   $0x80107464,(%esp)
...
80103f4a:	c7 44 24 04 d8 74 10 	movl   $0x801074d8,0x4(%esp)
80103f51:	80 
...
801041a7:	eb ac                	jmp    80104155 <acquire+0x15>
    panic("acquire");
801041a9:	c7 04 24 e3 74 10 80 	movl   $0x801074e3,(%esp)
...
80104209:	c3                   	ret    
    panic("popcli");
8010420a:	c7 04 24 02 75 10 80 	movl   $0x80107502,(%esp)
80104211:	e8 4a c1 ff ff       	call   80100360 <panic>
    panic("popcli - interruptible");
80104216:	c7 04 24 eb 74 10 80 	movl   $0x801074eb,(%esp)
...
8010423f:	75 0f                	jne    80104250 <release+0x20>
    panic("release");
80104241:	c7 04 24 09 75 10 80 	movl   $0x80107509,(%esp)
...
801044d3:	8b 45 08             	mov    0x8(%ebp),%eax
  ...
  if(addr >= USERBASE || addr+4 > USERBASE)
...
8010458e:	78 20                	js     801045b0 <argptr+0x40>
    return -1;
  // Modified
  if(size < 0 || (uint)i >= USERBASE || (uint)i+size > USERBASE)
...
8010463d:	8b 14 85 40 75 10 80 	mov    -0x7fef8ac0(,%eax,4),%edx
...
80104666:	c7 04 24 11 75 10 80 	movl   $0x80107511,(%esp)
...
801047f0:	c7 44 24 04 bc 75 10 	movl   $0x801075bc,0x4(%esp)
801047f7:	80 
...
8010480b:	c7 44 24 04 bb 75 10 	movl   $0x801075bb,0x4(%esp)
80104812:	80 
...
80104821:	79 89                	jns    801047ac <create+0xdc>
      panic("create dots");
80104823:	c7 04 24 af 75 10 80 	movl   $0x801075af,(%esp)
8010482a:	e8 31 bb ff ff       	call   80100360 <panic>
    panic("create: dirlink");
8010482f:	c7 04 24 be 75 10 80 	movl   $0x801075be,(%esp)
80104836:	e8 25 bb ff ff       	call   80100360 <panic>
    panic("create: ialloc");
8010483b:	c7 04 24 a0 75 10 80 	movl   $0x801075a0,(%esp)
...
80104be1:	c7 44 24 04 bc 75 10 	movl   $0x801075bc,0x4(%esp)
80104be8:	80 
...
80104bf9:	c7 44 24 04 bb 75 10 	movl   $0x801075bb,0x4(%esp)
80104c00:	80 
...
80104d4d:	c7 04 24 e0 75 10 80 	movl   $0x801075e0,(%esp)
80104d54:	e8 07 b6 ff ff       	call   80100360 <panic>
    panic("unlink: writei");
80104d59:	c7 04 24 f2 75 10 80 	movl   $0x801075f2,(%esp)
80104d60:	e8 fb b5 ff ff       	call   80100360 <panic>
    panic("unlink: nlink < 1");
80104d65:	c7 04 24 ce 75 10 80 	movl   $0x801075ce,(%esp)
...
80105219:	e8 02 1c 00 00       	call   80106e20 <shm_open>
}
8010521e:	c9                   	leave  
8010521f:	c3                   	ret    
    return -1;
...
80105253:	e8 d8 1b 00 00       	call   80106e30 <shm_close>
}
80105258:	c9                   	leave  
80105259:	c3                   	ret    
...
80105499:	c7 44 24 04 01 76 10 	movl   $0x80107601,0x4(%esp)
801054a0:	80 
...
80105530:	ff 24 85 4c 77 10 80 	jmp    *-0x7fef88b4(,%eax,4)
80105537:	90                   	nop
	}
    break;
...
8010553f:	90                   	nop
80105540:	0f 84 a0 02 00 00    	je     801057e6 <trap+0x2d6>
80105546:	f6 43 3c 03          	testb  $0x3,0x3c(%ebx)
8010554a:	0f 84 96 02 00 00    	je     801057e6 <trap+0x2d6>
...
8010558a:	8b 7d e4             	mov    -0x1c(%ebp),%edi
8010558d:	89 4c 24 1c          	mov    %ecx,0x1c(%esp)
            myproc()->pid, myproc()->name, tf->trapno,
80105591:	83 c6 70             	add    $0x70,%esi
    cprintf("pid %d %s: trap %d err %d on cpu %d "
80105594:	89 54 24 18          	mov    %edx,0x18(%esp)
80105598:	89 7c 24 10          	mov    %edi,0x10(%esp)
            myproc()->pid, myproc()->name, tf->trapno,
8010559c:	89 74 24 08          	mov    %esi,0x8(%esp)
    cprintf("pid %d %s: trap %d err %d on cpu %d "
801055a0:	8b 40 14             	mov    0x14(%eax),%eax
801055a3:	c7 04 24 08 77 10 80 	movl   $0x80107708,(%esp)
...
80105655:	0f 20 d1             	mov    %cr2,%ecx
	if ((procAddress < USERBASE - (procStack * PGSIZE)) && (procAddress > PGROUNDDOWN(USERBASE - (procStack * PGSIZE) - 1))) {
80105658:	8b 40 08             	mov    0x8(%eax),%eax
8010565b:	be ff ff ff 7f       	mov    $0x7fffffff,%esi
80105660:	c1 e0 0c             	shl    $0xc,%eax
80105663:	29 c6                	sub    %eax,%esi
80105665:	39 ce                	cmp    %ecx,%esi
80105667:	0f 86 53 ff ff ff    	jbe    801055c0 <trap+0xb0>
8010566d:	ba fe ff ff 7f       	mov    $0x7ffffffe,%edx
80105672:	29 c2                	sub    %eax,%edx
80105674:	81 e2 00 f0 ff ff    	and    $0xfffff000,%edx
8010567a:	39 ca                	cmp    %ecx,%edx
8010567c:	0f 83 3e ff ff ff    	jae    801055c0 <trap+0xb0>
      if (allocuvm(myproc()->pgdir, PGROUNDDOWN(USERBASE - (procStack * PGSIZE)), USERBASE - (procStack * PGSIZE)) == 0) {
80105682:	e8 19 e0 ff ff       	call   801036a0 <myproc>
80105687:	89 74 24 08          	mov    %esi,0x8(%esp)
8010568b:	81 e6 00 f0 ff ff    	and    $0xfffff000,%esi
80105691:	89 74 24 04          	mov    %esi,0x4(%esp)
80105695:	8b 40 04             	mov    0x4(%eax),%eax
80105698:	89 04 24             	mov    %eax,(%esp)
8010569b:	e8 20 12 00 00       	call   801068c0 <allocuvm>
801056a0:	85 c0                	test   %eax,%eax
801056a2:	0f 85 18 01 00 00    	jne    801057c0 <trap+0x2b0>
...
801056ad:	8b 40 08             	mov    0x8(%eax),%eax
801056b0:	c7 04 24 30 76 10 80 	movl   $0x80107630,(%esp)
801056b7:	89 44 24 04          	mov    %eax,0x4(%esp)
801056bb:	e8 90 af ff ff       	call   80100650 <cprintf>
		  exit();
801056c0:	e8 db e3 ff ff       	call   80103aa0 <exit>
		  break;
...
801056d7:	0f 84 b3 00 00 00    	je     80105790 <trap+0x280>
801056dd:	8d 76 00             	lea    0x0(%esi),%esi
    lapiceoi();
801056e0:	e8 9b d0 ff ff       	call   80102780 <lapiceoi>
    break;
801056e5:	e9 d6 fe ff ff       	jmp    801055c0 <trap+0xb0>
...
801057bb:	e9 1d ff ff ff       	jmp    801056dd <trap+0x1cd>
		  ++myproc()->pages;
801057c0:	e8 db de ff ff       	call   801036a0 <myproc>
801057c5:	83 40 08 01          	addl   $0x1,0x8(%eax)
...
801057ce:	8b 40 08             	mov    0x8(%eax),%eax
801057d1:	c7 04 24 84 76 10 80 	movl   $0x80107684,(%esp)
801057d8:	89 44 24 04          	mov    %eax,0x4(%esp)
801057dc:	e8 6f ae ff ff       	call   80100650 <cprintf>
801057e1:	e9 da fd ff ff       	jmp    801055c0 <trap+0xb0>
801057e6:	0f 20 d7             	mov    %cr2,%edi
      cprintf("unexpected trap %d from cpu %d eip %x (cr2=0x%x)\n",
801057e9:	8b 73 38             	mov    0x38(%ebx),%esi
801057ec:	e8 8f de ff ff       	call   80103680 <cpuid>
801057f1:	89 7c 24 10          	mov    %edi,0x10(%esp)
801057f5:	89 74 24 0c          	mov    %esi,0xc(%esp)
801057f9:	89 44 24 08          	mov    %eax,0x8(%esp)
801057fd:	8b 43 30             	mov    0x30(%ebx),%eax
80105800:	c7 04 24 d4 76 10 80 	movl   $0x801076d4,(%esp)
80105807:	89 44 24 04          	mov    %eax,0x4(%esp)
8010580b:	e8 40 ae ff ff       	call   80100650 <cprintf>
      panic("trap");
80105810:	c7 04 24 06 76 10 80 	movl   $0x80107606,(%esp)
80105817:	e8 44 ab ff ff       	call   80100360 <panic>
...
80105907:	00 
  for(p="xv6...\n"; *p; p++)
80105908:	bb 14 78 10 80       	mov    $0x80107814,%ebx
  ioapicenable(IRQ_COM1, 0);
...
80106631:	c3                   	ret    
      panic("remap");
80106632:	c7 04 24 1c 78 10 80 	movl   $0x8010781c,(%esp)
...
80106741:	c7 04 24 22 78 10 80 	movl   $0x80107822,(%esp)
80106748:	e8 13 9c ff ff       	call   80100360 <panic>
    panic("switchuvm: no pgdir");
8010674d:	c7 04 24 4d 78 10 80 	movl   $0x8010784d,(%esp)
80106754:	e8 07 9c ff ff       	call   80100360 <panic>
    panic("switchuvm: no kstack");
80106759:	c7 04 24 38 78 10 80 	movl   $0x80107838,(%esp)
...
801067ee:	c7 04 24 61 78 10 80 	movl   $0x80107861,(%esp)
...
801068a2:	c7 04 24 7b 78 10 80 	movl   $0x8010787b,(%esp)
801068a9:	e8 b2 9a ff ff       	call   80100360 <panic>
    panic("loaduvm: addr must be page aligned");
801068ae:	c7 04 24 1c 79 10 80 	movl   $0x8010791c,(%esp)
...
80106952:	c7 04 24 99 78 10 80 	movl   $0x80107899,(%esp)
...
80106980:	c7 04 24 b1 78 10 80 	movl   $0x801078b1,(%esp)
...
80106a43:	e9 a8 b8 ff ff       	jmp    801022f0 <kfree>
    panic("freevm: no pgdir");
80106a48:	c7 04 24 cd 78 10 80 	movl   $0x801078cd,(%esp)
...
80106b2b:	c3                   	ret    
    panic("clearpteu");
80106b2c:	c7 04 24 de 78 10 80 	movl   $0x801078de,(%esp)
...
// of it for a child.
pde_t*
copyuvm(pde_t *pgdir, uint sz, uint pgStack)
{
...
80106c3d:	e8 de d6 ff ff       	call   80104320 <memmove>
...
80106cc6:	e9 3d ff ff ff       	jmp    80106c08 <copyuvm+0xc8>
      panic("copyuvm: page not present");
80106ccb:	c7 04 24 02 79 10 80 	movl   $0x80107902,(%esp)
80106cd2:	e8 89 96 ff ff       	call   80100360 <panic>
      panic("copyuvm: pte should exist");
80106cd7:	c7 04 24 e8 78 10 80 	movl   $0x801078e8,(%esp)
...
80106d6c:	e8 af d5 ff ff       	call   80104320 <memmove>
    len -= n;
    buf += n;
...
80106dc6:	c7 44 24 04 40 79 10 	movl   $0x80107940,0x4(%esp)
80106dcd:	80 
80106dce:	c7 04 24 c0 55 11 80 	movl   $0x801155c0,(%esp)
80106dd5:	e8 76 d2 ff ff       	call   80104050 <initlock>
  acquire(&(shm_table.lock));
80106dda:	c7 04 24 c0 55 11 80 	movl   $0x801155c0,(%esp)
80106de1:	e8 5a d3 ff ff       	call   80104140 <acquire>
...
80106e15:	e8 16 d4 ff ff       	call   80104230 <release>
}
80106e1a:	c9                   	leave  
80106e1b:	c3                   	ret    
