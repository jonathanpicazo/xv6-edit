...
801002ad:	8b 40 30             	mov    0x30(%eax),%eax
...
80100394:	e8 b7 02 00 00       	call   80100650 <cprintf>
  cprintf("\n");
80100399:	c7 04 24 a3 78 10 80 	movl   $0x801078a3,(%esp)
...
80100409:	e8 62 56 00 00       	call   80105a70 <uartputc>
...
801004b9:	e8 b2 55 00 00       	call   80105a70 <uartputc>
801004be:	c7 04 24 20 00 00 00 	movl   $0x20,(%esp)
801004c5:	e8 a6 55 00 00       	call   80105a70 <uartputc>
801004ca:	c7 04 24 08 00 00 00 	movl   $0x8,(%esp)
801004d1:	e8 9a 55 00 00       	call   80105a70 <uartputc>
...
80100927:	e9 f4 35 00 00       	jmp    80103f20 <procdump>
        input.buf[input.e++ % INPUT_BUF] = c;
...
80100a2a:	75 d4                	jne    80100a00 <exec+0x60>
  if((pgdir = setupkvm()) == 0)
80100a2c:	e8 2f 62 00 00       	call   80106c60 <setupkvm>
...
80100ad2:	e8 f9 5f 00 00       	call   80106ad0 <allocuvm>
...
80100b13:	e8 f8 5e 00 00       	call   80106a10 <loaduvm>
80100b18:	85 c0                	test   %eax,%eax
80100b1a:	0f 89 40 ff ff ff    	jns    80100a60 <exec+0xc0>
    freevm(pgdir);
80100b20:	8b 85 f0 fe ff ff    	mov    -0x110(%ebp),%eax
80100b26:	89 04 24             	mov    %eax,(%esp)
80100b29:	e8 b2 60 00 00       	call   80106be0 <freevm>
...
80100b6c:	e8 5f 5f 00 00       	call   80106ad0 <allocuvm>
...
80100b84:	e8 57 60 00 00       	call   80106be0 <freevm>
  return -1;
...
80100bc8:	e8 43 61 00 00       	call   80106d10 <clearpteu>
...
80100c31:	e8 3a 62 00 00       	call   80106e70 <copyout>
...
80100c9e:	89 95 60 ff ff ff    	mov    %edx,-0xa0(%ebp)
  if(copyout(pgdir, sp, ustack, (3+argc+1)*4) < 0)
80100ca4:	e8 c7 61 00 00       	call   80106e70 <copyout>
...
80100ceb:	83 c0 78             	add    $0x78,%eax
...
80100cff:	8b 47 24             	mov    0x24(%edi),%eax
  curproc->pgdir = pgdir;
...
80100d14:	89 50 38             	mov    %edx,0x38(%eax)
  curproc->tf->esp = sp;
80100d17:	8b 47 24             	mov    0x24(%edi),%eax
80100d1a:	89 58 44             	mov    %ebx,0x44(%eax)
  switchuvm(curproc);
80100d1d:	89 3c 24             	mov    %edi,(%esp)
80100d20:	e8 5b 5b 00 00       	call   80106880 <switchuvm>
  freevm(oldpgdir);
80100d25:	89 34 24             	mov    %esi,(%esp)
80100d28:	e8 b3 5e 00 00       	call   80106be0 <freevm>
  return 0;
...
80101164:	c3                   	ret    
    panic("freeing free block");
80101165:	c7 04 24 bf 6f 10 80 	movl   $0x80106fbf,(%esp)
...
80101225:	c7 04 24 d2 6f 10 80 	movl   $0x80106fd2,(%esp)
...
8010134d:	c7 04 24 e8 6f 10 80 	movl   $0x80106fe8,(%esp)
...
80101405:	eb 93                	jmp    8010139a <bmap+0x3a>
  panic("bmap: out of range");
80101407:	c7 04 24 f8 6f 10 80 	movl   $0x80106ff8,(%esp)
...
80101c9e:	8b 70 74             	mov    0x74(%eax),%esi
  acquire(&icache.lock);
...
80101eec:	e8 6f e4 ff ff       	call   80100360 <panic>
    panic("dirlink");
80101ef1:	c7 04 24 72 76 10 80 	movl   $0x80107672,(%esp)
...
80102302:	81 fb a8 57 11 80    	cmp    $0x801157a8,%ebx
...
80102da7:	e8 e4 29 00 00       	call   80105790 <idtinit>
...
80102dd3:	83 ec 08             	sub    $0x8,%esp
  switchkvm();
80102dd6:	e8 85 3a 00 00       	call   80106860 <switchkvm>
  seginit();
80102ddb:	e8 c0 39 00 00       	call   801067a0 <seginit>
  lapicinit();
...
80102e13:	e8 d8 3e 00 00       	call   80106cf0 <kvmalloc>
...
80102e25:	e8 76 39 00 00       	call   801067a0 <seginit>
  picinit();       // disable pic
...
80102e3a:	e8 81 2c 00 00       	call   80105ac0 <uartinit>
80102e3f:	90                   	nop
  pinit();         // process table
80102e40:	e8 ab 07 00 00       	call   801035f0 <pinit>
  tvinit();        // trap vectors
80102e45:	e8 a6 28 00 00       	call   801056f0 <tvinit>
  binit();         // buffer cache
...
80103345:	8b 40 30             	mov    0x30(%eax),%eax
...
80103441:	8b 48 30             	mov    0x30(%eax),%ecx
...
801034ec:	0f 84 86 00 00 00    	je     80103578 <allocproc+0xb8>
    if(p->state == UNUSED)
801034f2:	8b 43 14             	mov    0x14(%ebx),%eax
...
801034fe:	c7 04 24 20 2d 11 80 	movl   $0x80112d20,(%esp)
  p->state = EMBRYO;
80103505:	c7 43 14 01 00 00 00 	movl   $0x1,0x14(%ebx)
  p->priority = 10;
8010350c:	c7 43 20 0a 00 00 00 	movl   $0xa,0x20(%ebx)
  p->pid = nextpid++;
80103513:	8d 50 01             	lea    0x1(%eax),%edx
80103516:	89 15 04 a0 10 80    	mov    %edx,0x8010a004
8010351c:	89 43 18             	mov    %eax,0x18(%ebx)
  release(&ptable.lock);
8010351f:	e8 1c 0f 00 00       	call   80104440 <release>

  // Allocate kernel stack.
  if((p->kstack = kalloc()) == 0){
80103524:	e8 77 ef ff ff       	call   801024a0 <kalloc>
80103529:	85 c0                	test   %eax,%eax
8010352b:	89 43 10             	mov    %eax,0x10(%ebx)
8010352e:	74 5c                	je     8010358c <allocproc+0xcc>
    return 0;
  }
  ...
  sp -= sizeof *p->tf;
80103530:	8d 90 b4 0f 00 00    	lea    0xfb4(%eax),%edx
  ...
  *(uint*)sp = (uint)trapret;
  ...
  sp -= sizeof *p->context;
80103536:	05 9c 0f 00 00       	add    $0xf9c,%eax
  sp -= sizeof *p->tf;
8010353b:	89 53 24             	mov    %edx,0x24(%ebx)
  *(uint*)sp = (uint)trapret;
8010353e:	c7 40 14 de 56 10 80 	movl   $0x801056de,0x14(%eax)
  p->context = (struct context*)sp;
  memset(p->context, 0, sizeof *p->context);
80103545:	c7 44 24 08 14 00 00 	movl   $0x14,0x8(%esp)
8010354c:	00 
8010354d:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
80103554:	00 
80103555:	89 04 24             	mov    %eax,(%esp)
  p->context = (struct context*)sp;
80103558:	89 43 28             	mov    %eax,0x28(%ebx)
  memset(p->context, 0, sizeof *p->context);
8010355b:	e8 30 0f 00 00       	call   80104490 <memset>
  p->context->eip = (uint)forkret;
80103560:	8b 43 28             	mov    0x28(%ebx),%eax
80103563:	c7 40 10 a0 35 10 80 	movl   $0x801035a0,0x10(%eax)

  return p;
8010356a:	89 d8                	mov    %ebx,%eax
}
8010356c:	83 c4 14             	add    $0x14,%esp
8010356f:	5b                   	pop    %ebx
80103570:	5d                   	pop    %ebp
80103571:	c3                   	ret    
...
8010357f:	e8 bc 0e 00 00       	call   80104440 <release>
}
...
8010358c:	c7 43 14 00 00 00 00 	movl   $0x0,0x14(%ebx)
    return 0;
80103593:	eb d7                	jmp    8010356c <allocproc+0xac>
...
801035ad:	e8 8e 0e 00 00       	call   80104440 <release>
...
80103605:	e8 56 0c 00 00       	call   80104260 <initlock>
}
8010360a:	c9                   	leave  
8010360b:	c3                   	ret    
...
801036b4:	83 ec 04             	sub    $0x4,%esp
  pushcli();
801036b7:	e8 24 0c 00 00       	call   801042e0 <pushcli>
  c = mycpu();
801036bc:	e8 4f ff ff ff       	call   80103610 <mycpu>
  p = c->proc;
801036c1:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
801036c7:	e8 54 0c 00 00       	call   80104320 <popcli>
}
...
801036f3:	e8 68 35 00 00       	call   80106c60 <setupkvm>
801036f8:	85 c0                	test   %eax,%eax
801036fa:	89 43 0c             	mov    %eax,0xc(%ebx)
801036fd:	0f 84 d5 00 00 00    	je     801037d8 <userinit+0xf8>
...
80103715:	80 
80103716:	e8 75 32 00 00       	call   80106990 <inituvm>
  p->sz = PGSIZE;
8010371b:	c7 43 08 00 10 00 00 	movl   $0x1000,0x8(%ebx)
  memset(p->tf, 0, sizeof(*p->tf));
80103722:	c7 44 24 08 4c 00 00 	movl   $0x4c,0x8(%esp)
80103729:	00 
8010372a:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
80103731:	00 
80103732:	8b 43 24             	mov    0x24(%ebx),%eax
80103735:	89 04 24             	mov    %eax,(%esp)
80103738:	e8 53 0d 00 00       	call   80104490 <memset>
  p->tf->cs = (SEG_UCODE << 3) | DPL_USER;
8010373d:	8b 43 24             	mov    0x24(%ebx),%eax
80103740:	ba 1b 00 00 00       	mov    $0x1b,%edx
  p->tf->ds = (SEG_UDATA << 3) | DPL_USER;
80103745:	b9 23 00 00 00       	mov    $0x23,%ecx
  p->tf->cs = (SEG_UCODE << 3) | DPL_USER;
8010374a:	66 89 50 3c          	mov    %dx,0x3c(%eax)
  p->tf->ds = (SEG_UDATA << 3) | DPL_USER;
8010374e:	8b 43 24             	mov    0x24(%ebx),%eax
80103751:	66 89 48 2c          	mov    %cx,0x2c(%eax)
  p->tf->es = p->tf->ds;
80103755:	8b 43 24             	mov    0x24(%ebx),%eax
80103758:	0f b7 50 2c          	movzwl 0x2c(%eax),%edx
8010375c:	66 89 50 28          	mov    %dx,0x28(%eax)
  p->tf->ss = p->tf->ds;
80103760:	8b 43 24             	mov    0x24(%ebx),%eax
80103763:	0f b7 50 2c          	movzwl 0x2c(%eax),%edx
80103767:	66 89 50 48          	mov    %dx,0x48(%eax)
  p->tf->eflags = FL_IF;
8010376b:	8b 43 24             	mov    0x24(%ebx),%eax
8010376e:	c7 40 40 00 02 00 00 	movl   $0x200,0x40(%eax)
  p->tf->esp = PGSIZE;
80103775:	8b 43 24             	mov    0x24(%ebx),%eax
80103778:	c7 40 44 00 10 00 00 	movl   $0x1000,0x44(%eax)
  p->tf->eip = 0;  // beginning of initcode.S
8010377f:	8b 43 24             	mov    0x24(%ebx),%eax
80103782:	c7 40 38 00 00 00 00 	movl   $0x0,0x38(%eax)
  safestrcpy(p->name, "initcode", sizeof(p->name));
80103789:	8d 43 78             	lea    0x78(%ebx),%eax
8010378c:	c7 44 24 08 10 00 00 	movl   $0x10,0x8(%esp)
80103793:	00 
80103794:	c7 44 24 04 85 74 10 	movl   $0x80107485,0x4(%esp)
8010379b:	80 
8010379c:	89 04 24             	mov    %eax,(%esp)
8010379f:	e8 cc 0e 00 00       	call   80104670 <safestrcpy>
  p->cwd = namei("/");
801037a4:	c7 04 24 8e 74 10 80 	movl   $0x8010748e,(%esp)
801037ab:	e8 50 e7 ff ff       	call   80101f00 <namei>
801037b0:	89 43 74             	mov    %eax,0x74(%ebx)
  acquire(&ptable.lock);
801037b3:	c7 04 24 20 2d 11 80 	movl   $0x80112d20,(%esp)
801037ba:	e8 11 0c 00 00       	call   801043d0 <acquire>
  p->state = RUNNABLE;
801037bf:	c7 43 14 03 00 00 00 	movl   $0x3,0x14(%ebx)
  release(&ptable.lock);
801037c6:	c7 04 24 20 2d 11 80 	movl   $0x80112d20,(%esp)
801037cd:	e8 6e 0c 00 00       	call   80104440 <release>
}
801037d2:	83 c4 14             	add    $0x14,%esp
801037d5:	5b                   	pop    %ebx
801037d6:	5d                   	pop    %ebp
801037d7:	c3                   	ret    
    panic("userinit: out of memory?");
801037d8:	c7 04 24 6c 74 10 80 	movl   $0x8010746c,(%esp)
801037df:	e8 7c cb ff ff       	call   80100360 <panic>
...
80103803:	89 c3                	mov    %eax,%ebx
  sz = curproc->sz;
80103805:	8b 40 08             	mov    0x8(%eax),%eax
  if(n > 0){
80103808:	7e 2e                	jle    80103838 <growproc+0x48>
    if((sz = allocuvm(curproc->pgdir, sz, sz + n)) == 0)
8010380a:	01 c6                	add    %eax,%esi
8010380c:	89 74 24 08          	mov    %esi,0x8(%esp)
80103810:	89 44 24 04          	mov    %eax,0x4(%esp)
80103814:	8b 43 0c             	mov    0xc(%ebx),%eax
80103817:	89 04 24             	mov    %eax,(%esp)
8010381a:	e8 b1 32 00 00       	call   80106ad0 <allocuvm>
8010381f:	85 c0                	test   %eax,%eax
80103821:	74 35                	je     80103858 <growproc+0x68>
  curproc->sz = sz;
80103823:	89 43 08             	mov    %eax,0x8(%ebx)
  switchuvm(curproc);
80103826:	89 1c 24             	mov    %ebx,(%esp)
80103829:	e8 52 30 00 00       	call   80106880 <switchuvm>
  return 0;
...
80103838:	74 e9                	je     80103823 <growproc+0x33>
...
8010384a:	e8 71 33 00 00       	call   80106bc0 <deallocuvm>
8010384f:	85 c0                	test   %eax,%eax
80103851:	75 d0                	jne    80103823 <growproc+0x33>
80103853:	90                   	nop
80103854:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
      return -1;
80103858:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
8010385d:	eb d1                	jmp    80103830 <growproc+0x40>
8010385f:	90                   	nop
...
80103882:	8b 43 08             	mov    0x8(%ebx),%eax
80103885:	89 44 24 04          	mov    %eax,0x4(%esp)
80103889:	8b 43 0c             	mov    0xc(%ebx),%eax
8010388c:	89 04 24             	mov    %eax,(%esp)
8010388f:	e8 ac 34 00 00       	call   80106d40 <copyuvm>
80103894:	85 c0                	test   %eax,%eax
80103896:	89 47 0c             	mov    %eax,0xc(%edi)
80103899:	0f 84 a6 00 00 00    	je     80103945 <fork+0xe5>
  np->sz = curproc->sz;
8010389f:	8b 43 08             	mov    0x8(%ebx),%eax
801038a2:	8b 4d e4             	mov    -0x1c(%ebp),%ecx
801038a5:	89 41 08             	mov    %eax,0x8(%ecx)
  *np->tf = *curproc->tf;
801038a8:	8b 79 24             	mov    0x24(%ecx),%edi
801038ab:	89 c8                	mov    %ecx,%eax
  np->parent = curproc;
801038ad:	89 59 1c             	mov    %ebx,0x1c(%ecx)
  *np->tf = *curproc->tf;
801038b0:	8b 73 24             	mov    0x24(%ebx),%esi
801038b3:	b9 13 00 00 00       	mov    $0x13,%ecx
801038b8:	f3 a5                	rep movsl %ds:(%esi),%es:(%edi)
  for(i = 0; i < NOFILE; i++)
801038ba:	31 f6                	xor    %esi,%esi
  np->tf->eax = 0;
801038bc:	8b 40 24             	mov    0x24(%eax),%eax
801038bf:	c7 40 1c 00 00 00 00 	movl   $0x0,0x1c(%eax)
801038c6:	66 90                	xchg   %ax,%ax
    if(curproc->ofile[i])
801038c8:	8b 44 b3 34          	mov    0x34(%ebx,%esi,4),%eax
...
80103948:	8b 47 10             	mov    0x10(%edi),%eax
8010394b:	89 04 24             	mov    %eax,(%esp)
8010394e:	e8 9d e9 ff ff       	call   801022f0 <kfree>
    return -1;
80103953:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
    np->kstack = 0;
80103958:	c7 47 10 00 00 00 00 	movl   $0x0,0x10(%edi)
    np->state = UNUSED;
8010395f:	c7 47 14 00 00 00 00 	movl   $0x0,0x14(%edi)
    return -1;
...
80103991:	c7 04 24 20 2d 11 80 	movl   $0x80112d20,(%esp)
    int min = 31;
80103998:	be 1f 00 00 00       	mov    $0x1f,%esi
    acquire(&ptable.lock);
8010399d:	e8 2e 0a 00 00       	call   801043d0 <acquire>
    for (p = ptable.proc; p < &ptable.proc[NPROC]; ++p) {
801039a2:	ba 54 2d 11 80       	mov    $0x80112d54,%edx
801039a7:	eb 1e                	jmp    801039c7 <scheduler+0x57>
801039a9:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
			if (p->state == SLEEPING) {
801039b0:	83 f8 02             	cmp    $0x2,%eax
801039b3:	0f 84 af 00 00 00    	je     80103a68 <scheduler+0xf8>
    for (p = ptable.proc; p < &ptable.proc[NPROC]; ++p) {
801039b9:	81 c2 88 00 00 00    	add    $0x88,%edx
801039bf:	81 fa 54 4f 11 80    	cmp    $0x80114f54,%edx
801039c5:	74 1e                	je     801039e5 <scheduler+0x75>
		if (p->state != RUNNABLE) {
801039c7:	8b 42 14             	mov    0x14(%edx),%eax
801039ca:	83 f8 03             	cmp    $0x3,%eax
801039cd:	75 e1                	jne    801039b0 <scheduler+0x40>
		if (p->priority < min) {
801039cf:	8b 42 20             	mov    0x20(%edx),%eax
801039d2:	39 c6                	cmp    %eax,%esi
801039d4:	0f 4f f0             	cmovg  %eax,%esi
    for (p = ptable.proc; p < &ptable.proc[NPROC]; ++p) {
801039d7:	81 c2 88 00 00 00    	add    $0x88,%edx
801039dd:	81 fa 54 4f 11 80    	cmp    $0x80114f54,%edx
801039e3:	75 e2                	jne    801039c7 <scheduler+0x57>
801039e5:	bf 54 2d 11 80       	mov    $0x80112d54,%edi
801039ea:	eb 12                	jmp    801039fe <scheduler+0x8e>
801039ec:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
801039f0:	81 c7 88 00 00 00    	add    $0x88,%edi
801039f6:	81 ff 54 4f 11 80    	cmp    $0x80114f54,%edi
801039fc:	74 52                	je     80103a50 <scheduler+0xe0>
      if(p->state != RUNNABLE || min!=p->priority) {
801039fe:	83 7f 14 03          	cmpl   $0x3,0x14(%edi)
80103a02:	75 ec                	jne    801039f0 <scheduler+0x80>
80103a04:	3b 77 20             	cmp    0x20(%edi),%esi
80103a07:	75 e7                	jne    801039f0 <scheduler+0x80>
		c->proc = p;
80103a09:	89 bb ac 00 00 00    	mov    %edi,0xac(%ebx)
		switchuvm(p);
80103a0f:	89 3c 24             	mov    %edi,(%esp)
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80103a12:	81 c7 88 00 00 00    	add    $0x88,%edi
		switchuvm(p);
80103a18:	e8 63 2e 00 00       	call   80106880 <switchuvm>
        swtch(&(c->scheduler), p->context);
80103a1d:	8b 47 a0             	mov    -0x60(%edi),%eax
        p->state = RUNNING;
80103a20:	c7 47 8c 04 00 00 00 	movl   $0x4,-0x74(%edi)
        swtch(&(c->scheduler), p->context);
80103a27:	89 44 24 04          	mov    %eax,0x4(%esp)
80103a2b:	8b 45 e4             	mov    -0x1c(%ebp),%eax
80103a2e:	89 04 24             	mov    %eax,(%esp)
80103a31:	e8 95 0c 00 00       	call   801046cb <swtch>
        switchkvm();
80103a36:	e8 25 2e 00 00       	call   80106860 <switchkvm>
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80103a3b:	81 ff 54 4f 11 80    	cmp    $0x80114f54,%edi
        c->proc = 0;
80103a41:	c7 83 ac 00 00 00 00 	movl   $0x0,0xac(%ebx)
80103a48:	00 00 00 
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80103a4b:	75 b1                	jne    801039fe <scheduler+0x8e>
80103a4d:	8d 76 00             	lea    0x0(%esi),%esi
    release(&ptable.lock);
80103a50:	c7 04 24 20 2d 11 80 	movl   $0x80112d20,(%esp)
80103a57:	e8 e4 09 00 00       	call   80104440 <release>
}
80103a5c:	e9 2f ff ff ff       	jmp    80103990 <scheduler+0x20>
80103a61:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
				--p->priority;
80103a68:	83 6a 20 01          	subl   $0x1,0x20(%edx)
80103a6c:	e9 48 ff ff ff       	jmp    801039b9 <scheduler+0x49>
...
80103a88:	e8 23 fc ff ff       	call   801036b0 <myproc>
  if(!holding(&ptable.lock))
80103a8d:	c7 04 24 20 2d 11 80 	movl   $0x80112d20,(%esp)
  struct proc *p = myproc();
80103a94:	89 c3                	mov    %eax,%ebx
  if(!holding(&ptable.lock))
80103a96:	e8 f5 08 00 00       	call   80104390 <holding>
...
80103aab:	75 65                	jne    80103b12 <sched+0x92>
  if(p->state == RUNNING)
80103aad:	83 7b 14 04          	cmpl   $0x4,0x14(%ebx)
...
80103abf:	83 c3 28             	add    $0x28,%ebx
  intena = mycpu()->intena;
...
80103ad7:	e8 ef 0b 00 00       	call   801046cb <swtch>
  mycpu()->intena = intena;
...
80103aee:	c7 04 24 90 74 10 80 	movl   $0x80107490,(%esp)
80103af5:	e8 66 c8 ff ff       	call   80100360 <panic>
    panic("sched interruptible");
80103afa:	c7 04 24 bc 74 10 80 	movl   $0x801074bc,(%esp)
80103b01:	e8 5a c8 ff ff       	call   80100360 <panic>
    panic("sched running");
80103b06:	c7 04 24 ae 74 10 80 	movl   $0x801074ae,(%esp)
80103b0d:	e8 4e c8 ff ff       	call   80100360 <panic>
    panic("sched locks");
80103b12:	c7 04 24 a2 74 10 80 	movl   $0x801074a2,(%esp)
...
80103b27:	83 ec 10             	sub    $0x10,%esp
  struct proc *curproc = myproc();
80103b2a:	e8 81 fb ff ff       	call   801036b0 <myproc>
  if(curproc == initproc)
80103b2f:	3b 05 b8 a5 10 80    	cmp    0x8010a5b8,%eax
  struct proc *curproc = myproc();
80103b35:	89 c3                	mov    %eax,%ebx
  if(curproc == initproc)
80103b37:	0f 84 fd 00 00 00    	je     80103c3a <exit+0x11a>
...
80103b4b:	e8 e0 d2 ff ff       	call   80100e30 <fileclose>
      curproc->ofile[fd] = 0;
80103b50:	c7 44 b3 34 00 00 00 	movl   $0x0,0x34(%ebx,%esi,4)
80103b57:	00 
...
80103b5e:	75 e0                	jne    80103b40 <exit+0x20>
  begin_op();
80103b60:	e8 ab ef ff ff       	call   80102b10 <begin_op>
  iput(curproc->cwd);
80103b65:	8b 43 74             	mov    0x74(%ebx),%eax
80103b68:	89 04 24             	mov    %eax,(%esp)
80103b6b:	e8 60 dc ff ff       	call   801017d0 <iput>
  end_op();
80103b70:	e8 0b f0 ff ff       	call   80102b80 <end_op>
  curproc->cwd = 0;
80103b75:	c7 43 74 00 00 00 00 	movl   $0x0,0x74(%ebx)
  acquire(&ptable.lock);
80103b7c:	c7 04 24 20 2d 11 80 	movl   $0x80112d20,(%esp)
80103b83:	e8 48 08 00 00       	call   801043d0 <acquire>
  wakeup1(curproc->parent);
80103b88:	8b 43 1c             	mov    0x1c(%ebx),%eax
static void
wakeup1(void *chan)
{
  struct proc *p;
...
80103b98:	81 c2 88 00 00 00    	add    $0x88,%edx
80103b9e:	81 fa 54 4f 11 80    	cmp    $0x80114f54,%edx
80103ba4:	74 20                	je     80103bc6 <exit+0xa6>
    if(p->state == SLEEPING && p->chan == chan)
80103ba6:	83 7a 14 02          	cmpl   $0x2,0x14(%edx)
80103baa:	75 ec                	jne    80103b98 <exit+0x78>
80103bac:	3b 42 2c             	cmp    0x2c(%edx),%eax
80103baf:	75 e7                	jne    80103b98 <exit+0x78>
      p->state = RUNNABLE;
80103bb1:	c7 42 14 03 00 00 00 	movl   $0x3,0x14(%edx)
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++)
80103bb8:	81 c2 88 00 00 00    	add    $0x88,%edx
80103bbe:	81 fa 54 4f 11 80    	cmp    $0x80114f54,%edx
...
80103bd2:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80103bd8:	81 c1 88 00 00 00    	add    $0x88,%ecx
80103bde:	81 f9 54 4f 11 80    	cmp    $0x80114f54,%ecx
80103be4:	74 3c                	je     80103c22 <exit+0x102>
    if(p->parent == curproc){
80103be6:	39 59 1c             	cmp    %ebx,0x1c(%ecx)
80103be9:	75 ed                	jne    80103bd8 <exit+0xb8>
      if(p->state == ZOMBIE)
80103beb:	83 79 14 05          	cmpl   $0x5,0x14(%ecx)
      p->parent = initproc;
80103bef:	89 41 1c             	mov    %eax,0x1c(%ecx)
      if(p->state == ZOMBIE)
...
80103bfc:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++)
80103c00:	81 c2 88 00 00 00    	add    $0x88,%edx
80103c06:	81 fa 54 4f 11 80    	cmp    $0x80114f54,%edx
80103c0c:	74 ca                	je     80103bd8 <exit+0xb8>
    if(p->state == SLEEPING && p->chan == chan)
80103c0e:	83 7a 14 02          	cmpl   $0x2,0x14(%edx)
80103c12:	75 ec                	jne    80103c00 <exit+0xe0>
80103c14:	3b 42 2c             	cmp    0x2c(%edx),%eax
80103c17:	75 e7                	jne    80103c00 <exit+0xe0>
      p->state = RUNNABLE;
80103c19:	c7 42 14 03 00 00 00 	movl   $0x3,0x14(%edx)
80103c20:	eb de                	jmp    80103c00 <exit+0xe0>
  curproc->state = ZOMBIE;
80103c22:	c7 43 14 05 00 00 00 	movl   $0x5,0x14(%ebx)
  sched();
80103c29:	e8 52 fe ff ff       	call   80103a80 <sched>
  panic("zombie exit");
80103c2e:	c7 04 24 dd 74 10 80 	movl   $0x801074dd,(%esp)
80103c35:	e8 26 c7 ff ff       	call   80100360 <panic>
    panic("init exiting");
80103c3a:	c7 04 24 d0 74 10 80 	movl   $0x801074d0,(%esp)
80103c41:	e8 1a c7 ff ff       	call   80100360 <panic>
...
80103c5d:	e8 6e 07 00 00       	call   801043d0 <acquire>
  myproc()->state = RUNNABLE;
80103c62:	e8 49 fa ff ff       	call   801036b0 <myproc>
80103c67:	c7 40 14 03 00 00 00 	movl   $0x3,0x14(%eax)
  sched();
80103c6e:	e8 0d fe ff ff       	call   80103a80 <sched>
  release(&ptable.lock);
80103c73:	c7 04 24 20 2d 11 80 	movl   $0x80112d20,(%esp)
80103c7a:	e8 c1 07 00 00       	call   80104440 <release>
}
80103c7f:	c9                   	leave  
80103c80:	c3                   	ret    
...
80103c9c:	8b 75 0c             	mov    0xc(%ebp),%esi
  struct proc *p = myproc();
80103c9f:	e8 0c fa ff ff       	call   801036b0 <myproc>
  if(p == 0)
...
80103cc1:	e8 0a 07 00 00       	call   801043d0 <acquire>
    release(lk);
80103cc6:	89 34 24             	mov    %esi,(%esp)
80103cc9:	e8 72 07 00 00       	call   80104440 <release>
  p->chan = chan;
80103cce:	89 7b 2c             	mov    %edi,0x2c(%ebx)
  p->state = SLEEPING;
80103cd1:	c7 43 14 02 00 00 00 	movl   $0x2,0x14(%ebx)
  sched();
80103cd8:	e8 a3 fd ff ff       	call   80103a80 <sched>
  p->chan = 0;
80103cdd:	c7 43 2c 00 00 00 00 	movl   $0x0,0x2c(%ebx)
    release(&ptable.lock);
80103ce4:	c7 04 24 20 2d 11 80 	movl   $0x80112d20,(%esp)
80103ceb:	e8 50 07 00 00       	call   80104440 <release>
    acquire(lk);
...
80103cf9:	5d                   	pop    %ebp
    acquire(lk);
80103cfa:	e9 d1 06 00 00       	jmp    801043d0 <acquire>
80103cff:	90                   	nop
  p->chan = chan;
80103d00:	89 78 2c             	mov    %edi,0x2c(%eax)
  p->state = SLEEPING;
80103d03:	c7 40 14 02 00 00 00 	movl   $0x2,0x14(%eax)
  sched();
80103d0a:	e8 71 fd ff ff       	call   80103a80 <sched>
  p->chan = 0;
80103d0f:	c7 43 2c 00 00 00 00 	movl   $0x0,0x2c(%ebx)
}
...
80103d1e:	c7 04 24 ef 74 10 80 	movl   $0x801074ef,(%esp)
80103d25:	e8 36 c6 ff ff       	call   80100360 <panic>
    panic("sleep");
80103d2a:	c7 04 24 e9 74 10 80 	movl   $0x801074e9,(%esp)
...
80103d45:	83 ec 10             	sub    $0x10,%esp
  struct proc *curproc = myproc();
80103d48:	e8 63 f9 ff ff       	call   801036b0 <myproc>
  acquire(&ptable.lock);
80103d4d:	c7 04 24 20 2d 11 80 	movl   $0x80112d20,(%esp)
  struct proc *curproc = myproc();
80103d54:	89 c6                	mov    %eax,%esi
  acquire(&ptable.lock);
80103d56:	e8 75 06 00 00       	call   801043d0 <acquire>
    havekids = 0;
80103d5b:	31 c0                	xor    %eax,%eax
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80103d5d:	bb 54 2d 11 80       	mov    $0x80112d54,%ebx
80103d62:	eb 12                	jmp    80103d76 <wait+0x36>
80103d64:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
80103d68:	81 c3 88 00 00 00    	add    $0x88,%ebx
80103d6e:	81 fb 54 4f 11 80    	cmp    $0x80114f54,%ebx
80103d74:	74 22                	je     80103d98 <wait+0x58>
      if(p->parent != curproc)
80103d76:	39 73 1c             	cmp    %esi,0x1c(%ebx)
80103d79:	75 ed                	jne    80103d68 <wait+0x28>
      if(p->state == ZOMBIE){
80103d7b:	83 7b 14 05          	cmpl   $0x5,0x14(%ebx)
80103d7f:	74 34                	je     80103db5 <wait+0x75>
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80103d81:	81 c3 88 00 00 00    	add    $0x88,%ebx
      havekids = 1;
80103d87:	b8 01 00 00 00       	mov    $0x1,%eax
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80103d8c:	81 fb 54 4f 11 80    	cmp    $0x80114f54,%ebx
80103d92:	75 e2                	jne    80103d76 <wait+0x36>
80103d94:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    if(!havekids || curproc->killed){
80103d98:	85 c0                	test   %eax,%eax
80103d9a:	74 6e                	je     80103e0a <wait+0xca>
80103d9c:	8b 46 30             	mov    0x30(%esi),%eax
80103d9f:	85 c0                	test   %eax,%eax
80103da1:	75 67                	jne    80103e0a <wait+0xca>
    sleep(curproc, &ptable.lock);  //DOC: wait-sleep
80103da3:	c7 44 24 04 20 2d 11 	movl   $0x80112d20,0x4(%esp)
80103daa:	80 
80103dab:	89 34 24             	mov    %esi,(%esp)
80103dae:	e8 dd fe ff ff       	call   80103c90 <sleep>
  }
80103db3:	eb a6                	jmp    80103d5b <wait+0x1b>
        kfree(p->kstack);
80103db5:	8b 43 10             	mov    0x10(%ebx),%eax
        pid = p->pid;
80103db8:	8b 73 18             	mov    0x18(%ebx),%esi
        kfree(p->kstack);
80103dbb:	89 04 24             	mov    %eax,(%esp)
80103dbe:	e8 2d e5 ff ff       	call   801022f0 <kfree>
        freevm(p->pgdir);
80103dc3:	8b 43 0c             	mov    0xc(%ebx),%eax
        p->kstack = 0;
80103dc6:	c7 43 10 00 00 00 00 	movl   $0x0,0x10(%ebx)
        freevm(p->pgdir);
80103dcd:	89 04 24             	mov    %eax,(%esp)
80103dd0:	e8 0b 2e 00 00       	call   80106be0 <freevm>
        release(&ptable.lock);
80103dd5:	c7 04 24 20 2d 11 80 	movl   $0x80112d20,(%esp)
        p->pid = 0;
80103ddc:	c7 43 18 00 00 00 00 	movl   $0x0,0x18(%ebx)
        p->parent = 0;
80103de3:	c7 43 1c 00 00 00 00 	movl   $0x0,0x1c(%ebx)
        p->name[0] = 0;
80103dea:	c6 43 78 00          	movb   $0x0,0x78(%ebx)
        p->killed = 0;
80103dee:	c7 43 30 00 00 00 00 	movl   $0x0,0x30(%ebx)
        p->state = UNUSED;
80103df5:	c7 43 14 00 00 00 00 	movl   $0x0,0x14(%ebx)
        release(&ptable.lock);
80103dfc:	e8 3f 06 00 00       	call   80104440 <release>
}
...
80103e11:	e8 2a 06 00 00       	call   80104440 <release>
}
...
80103e41:	e8 8a 05 00 00       	call   801043d0 <acquire>
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++)
80103e46:	b8 54 2d 11 80       	mov    $0x80112d54,%eax
80103e4b:	eb 0f                	jmp    80103e5c <wakeup+0x2c>
80103e4d:	8d 76 00             	lea    0x0(%esi),%esi
80103e50:	05 88 00 00 00       	add    $0x88,%eax
80103e55:	3d 54 4f 11 80       	cmp    $0x80114f54,%eax
80103e5a:	74 24                	je     80103e80 <wakeup+0x50>
    if(p->state == SLEEPING && p->chan == chan)
80103e5c:	83 78 14 02          	cmpl   $0x2,0x14(%eax)
80103e60:	75 ee                	jne    80103e50 <wakeup+0x20>
80103e62:	3b 58 2c             	cmp    0x2c(%eax),%ebx
80103e65:	75 e9                	jne    80103e50 <wakeup+0x20>
      p->state = RUNNABLE;
...
80103e78:	75 e2                	jne    80103e5c <wakeup+0x2c>
80103e7a:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
  wakeup1(chan);
  release(&ptable.lock);
80103e80:	c7 45 08 20 2d 11 80 	movl   $0x80112d20,0x8(%ebp)
}
80103e87:	83 c4 14             	add    $0x14,%esp
80103e8a:	5b                   	pop    %ebx
80103e8b:	5d                   	pop    %ebp
  release(&ptable.lock);
80103e8c:	e9 af 05 00 00       	jmp    80104440 <release>
80103e91:	eb 0d                	jmp    80103ea0 <kill>
80103e93:	90                   	nop
80103e94:	90                   	nop
80103e95:	90                   	nop
80103e96:	90                   	nop
...
80103eb1:	e8 1a 05 00 00       	call   801043d0 <acquire>
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80103eb6:	b8 54 2d 11 80       	mov    $0x80112d54,%eax
80103ebb:	eb 0f                	jmp    80103ecc <kill+0x2c>
80103ebd:	8d 76 00             	lea    0x0(%esi),%esi
80103ec0:	05 88 00 00 00       	add    $0x88,%eax
80103ec5:	3d 54 4f 11 80       	cmp    $0x80114f54,%eax
80103eca:	74 3c                	je     80103f08 <kill+0x68>
    if(p->pid == pid){
80103ecc:	39 58 18             	cmp    %ebx,0x18(%eax)
80103ecf:	75 ef                	jne    80103ec0 <kill+0x20>
      p->killed = 1;
      // Wake process from sleep if necessary.
      if(p->state == SLEEPING)
80103ed1:	83 78 14 02          	cmpl   $0x2,0x14(%eax)
      p->killed = 1;
80103ed5:	c7 40 30 01 00 00 00 	movl   $0x1,0x30(%eax)
      if(p->state == SLEEPING)
80103edc:	74 1a                	je     80103ef8 <kill+0x58>
        p->state = RUNNABLE;
      release(&ptable.lock);
80103ede:	c7 04 24 20 2d 11 80 	movl   $0x80112d20,(%esp)
80103ee5:	e8 56 05 00 00       	call   80104440 <release>
      return 0;
    }
  }
  release(&ptable.lock);
...
80103eea:	83 c4 14             	add    $0x14,%esp
      return 0;
80103eed:	31 c0                	xor    %eax,%eax
}
80103eef:	5b                   	pop    %ebx
80103ef0:	5d                   	pop    %ebp
80103ef1:	c3                   	ret    
80103ef2:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
        p->state = RUNNABLE;
80103ef8:	c7 40 14 03 00 00 00 	movl   $0x3,0x14(%eax)
80103eff:	eb dd                	jmp    80103ede <kill+0x3e>
80103f01:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
  release(&ptable.lock);
80103f08:	c7 04 24 20 2d 11 80 	movl   $0x80112d20,(%esp)
80103f0f:	e8 2c 05 00 00       	call   80104440 <release>
}
80103f14:	83 c4 14             	add    $0x14,%esp
  return -1;
...
80103f26:	bb cc 2d 11 80       	mov    $0x80112dcc,%ebx
80103f2b:	83 ec 4c             	sub    $0x4c,%esp
80103f2e:	8d 75 e8             	lea    -0x18(%ebp),%esi
80103f31:	eb 23                	jmp    80103f56 <procdump+0x36>
80103f33:	90                   	nop
80103f34:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    ...
    cprintf("\n");
80103f38:	c7 04 24 a3 78 10 80 	movl   $0x801078a3,(%esp)
80103f3f:	e8 0c c7 ff ff       	call   80100650 <cprintf>
80103f44:	81 c3 88 00 00 00    	add    $0x88,%ebx
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80103f4a:	81 fb cc 4f 11 80    	cmp    $0x80114fcc,%ebx
80103f50:	0f 84 8a 00 00 00    	je     80103fe0 <procdump+0xc0>
    if(p->state == UNUSED)
80103f56:	8b 43 9c             	mov    -0x64(%ebx),%eax
80103f59:	85 c0                	test   %eax,%eax
80103f5b:	74 e7                	je     80103f44 <procdump+0x24>
    if(p->state >= 0 && p->state < NELEM(states) && states[p->state])
80103f5d:	83 f8 05             	cmp    $0x5,%eax
      state = "???";
80103f60:	ba 00 75 10 80       	mov    $0x80107500,%edx
    if(p->state >= 0 && p->state < NELEM(states) && states[p->state])
80103f65:	77 11                	ja     80103f78 <procdump+0x58>
80103f67:	8b 14 85 60 75 10 80 	mov    -0x7fef8aa0(,%eax,4),%edx
      state = "???";
80103f6e:	b8 00 75 10 80       	mov    $0x80107500,%eax
80103f73:	85 d2                	test   %edx,%edx
80103f75:	0f 44 d0             	cmove  %eax,%edx
    cprintf("%d %s %s", p->pid, state, p->name);
80103f78:	8b 43 a0             	mov    -0x60(%ebx),%eax
80103f7b:	89 5c 24 0c          	mov    %ebx,0xc(%esp)
80103f7f:	89 54 24 08          	mov    %edx,0x8(%esp)
80103f83:	c7 04 24 04 75 10 80 	movl   $0x80107504,(%esp)
80103f8a:	89 44 24 04          	mov    %eax,0x4(%esp)
80103f8e:	e8 bd c6 ff ff       	call   80100650 <cprintf>
    if(p->state == SLEEPING){
80103f93:	83 7b 9c 02          	cmpl   $0x2,-0x64(%ebx)
80103f97:	75 9f                	jne    80103f38 <procdump+0x18>
      getcallerpcs((uint*)p->context->ebp+2, pc);
80103f99:	8d 45 c0             	lea    -0x40(%ebp),%eax
80103f9c:	89 44 24 04          	mov    %eax,0x4(%esp)
80103fa0:	8b 43 b0             	mov    -0x50(%ebx),%eax
80103fa3:	8d 7d c0             	lea    -0x40(%ebp),%edi
80103fa6:	8b 40 0c             	mov    0xc(%eax),%eax
80103fa9:	83 c0 08             	add    $0x8,%eax
80103fac:	89 04 24             	mov    %eax,(%esp)
80103faf:	e8 cc 02 00 00       	call   80104280 <getcallerpcs>
80103fb4:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
      for(i=0; i<10 && pc[i] != 0; i++)
80103fb8:	8b 17                	mov    (%edi),%edx
80103fba:	85 d2                	test   %edx,%edx
80103fbc:	0f 84 76 ff ff ff    	je     80103f38 <procdump+0x18>
        cprintf(" %p", pc[i]);
80103fc2:	89 54 24 04          	mov    %edx,0x4(%esp)
80103fc6:	83 c7 04             	add    $0x4,%edi
80103fc9:	c7 04 24 41 6f 10 80 	movl   $0x80106f41,(%esp)
80103fd0:	e8 7b c6 ff ff       	call   80100650 <cprintf>
      for(i=0; i<10 && pc[i] != 0; i++)
80103fd5:	39 f7                	cmp    %esi,%edi
80103fd7:	75 df                	jne    80103fb8 <procdump+0x98>
80103fd9:	e9 5a ff ff ff       	jmp    80103f38 <procdump+0x18>
80103fde:	66 90                	xchg   %ax,%ax
  }
}
80103fe0:	83 c4 4c             	add    $0x4c,%esp
80103fe3:	5b                   	pop    %ebx
80103fe4:	5e                   	pop    %esi
80103fe5:	5f                   	pop    %edi
80103fe6:	5d                   	pop    %ebp
...
80103ff9:	8b 7d 08             	mov    0x8(%ebp),%edi
  ...
  int havekids, pid;
  struct proc *curproc = myproc();
80103ffc:	e8 af f6 ff ff       	call   801036b0 <myproc>
  
  acquire(&ptable.lock);
80104001:	c7 04 24 20 2d 11 80 	movl   $0x80112d20,(%esp)
  struct proc *curproc = myproc();
80104008:	89 45 e4             	mov    %eax,-0x1c(%ebp)
  acquire(&ptable.lock);
8010400b:	e8 c0 03 00 00       	call   801043d0 <acquire>
  for(;;){
    // Scan through table looking for exited children.
    havekids = 0;
80104010:	31 c0                	xor    %eax,%eax
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80104012:	bb 54 2d 11 80       	mov    $0x80112d54,%ebx
80104017:	eb 15                	jmp    8010402e <waitpid+0x3e>
80104019:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
80104020:	81 c3 88 00 00 00    	add    $0x88,%ebx
80104026:	81 fb 54 4f 11 80    	cmp    $0x80114f54,%ebx
8010402c:	74 20                	je     8010404e <waitpid+0x5e>
      if(p->pid!= processID)
8010402e:	8b 73 18             	mov    0x18(%ebx),%esi
80104031:	39 fe                	cmp    %edi,%esi
80104033:	75 eb                	jne    80104020 <waitpid+0x30>
        continue;
      havekids = 1;
      if(p->state == ZOMBIE){
80104035:	83 7b 14 05          	cmpl   $0x5,0x14(%ebx)
80104039:	74 3d                	je     80104078 <waitpid+0x88>
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
8010403b:	81 c3 88 00 00 00    	add    $0x88,%ebx
      havekids = 1;
80104041:	b8 01 00 00 00       	mov    $0x1,%eax
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80104046:	81 fb 54 4f 11 80    	cmp    $0x80114f54,%ebx
8010404c:	75 e0                	jne    8010402e <waitpid+0x3e>
        return pid;
      }
    }
...
80104050:	0f 84 7c 00 00 00    	je     801040d2 <waitpid+0xe2>
80104056:	8b 45 e4             	mov    -0x1c(%ebp),%eax
80104059:	8b 40 30             	mov    0x30(%eax),%eax
8010405c:	85 c0                	test   %eax,%eax
8010405e:	75 72                	jne    801040d2 <waitpid+0xe2>
      release(&ptable.lock);
      return -1;
    }
    ...
    sleep(curproc, &ptable.lock);  //DOC: wait-sleep
80104060:	8b 45 e4             	mov    -0x1c(%ebp),%eax
80104063:	c7 44 24 04 20 2d 11 	movl   $0x80112d20,0x4(%esp)
8010406a:	80 
8010406b:	89 04 24             	mov    %eax,(%esp)
8010406e:	e8 1d fc ff ff       	call   80103c90 <sleep>
  }
80104073:	eb 9b                	jmp    80104010 <waitpid+0x20>
80104075:	8d 76 00             	lea    0x0(%esi),%esi
        kfree(p->kstack);
80104078:	8b 43 10             	mov    0x10(%ebx),%eax
8010407b:	89 04 24             	mov    %eax,(%esp)
8010407e:	e8 6d e2 ff ff       	call   801022f0 <kfree>
        freevm(p->pgdir);
80104083:	8b 43 0c             	mov    0xc(%ebx),%eax
        p->kstack = 0;
80104086:	c7 43 10 00 00 00 00 	movl   $0x0,0x10(%ebx)
        freevm(p->pgdir);
8010408d:	89 04 24             	mov    %eax,(%esp)
80104090:	e8 4b 2b 00 00       	call   80106be0 <freevm>
        release(&ptable.lock);
80104095:	c7 04 24 20 2d 11 80 	movl   $0x80112d20,(%esp)
        p->pid = 0;
8010409c:	c7 43 18 00 00 00 00 	movl   $0x0,0x18(%ebx)
        p->parent = 0;
801040a3:	c7 43 1c 00 00 00 00 	movl   $0x0,0x1c(%ebx)
        p->name[0] = 0;
801040aa:	c6 43 78 00          	movb   $0x0,0x78(%ebx)
        p->killed = 0;
801040ae:	c7 43 30 00 00 00 00 	movl   $0x0,0x30(%ebx)
        p->state = UNUSED;
801040b5:	c7 43 14 00 00 00 00 	movl   $0x0,0x14(%ebx)
        p->exitStatus = 0;
801040bc:	c7 43 04 00 00 00 00 	movl   $0x0,0x4(%ebx)
        release(&ptable.lock);
801040c3:	e8 78 03 00 00       	call   80104440 <release>
}
801040c8:	83 c4 1c             	add    $0x1c,%esp
...
801040d9:	be ff ff ff ff       	mov    $0xffffffff,%esi
      release(&ptable.lock);
801040de:	e8 5d 03 00 00       	call   80104440 <release>
      return -1;
801040e3:	eb e3                	jmp    801040c8 <waitpid+0xd8>
801040e5:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
801040e9:	8d bc 27 00 00 00 00 	lea    0x0(%edi,%eiz,1),%edi

801040f0 <setpriority>:

int setpriority(int prioritySet) {
801040f0:	55                   	push   %ebp
801040f1:	89 e5                	mov    %esp,%ebp
801040f3:	53                   	push   %ebx
801040f4:	83 ec 14             	sub    $0x14,%esp
	struct proc *curproc = myproc(); 
801040f7:	e8 b4 f5 ff ff       	call   801036b0 <myproc>
	acquire(&ptable.lock);
801040fc:	c7 04 24 20 2d 11 80 	movl   $0x80112d20,(%esp)
	struct proc *curproc = myproc(); 
80104103:	89 c3                	mov    %eax,%ebx
	acquire(&ptable.lock);
80104105:	e8 c6 02 00 00       	call   801043d0 <acquire>
	curproc->priority = prioritySet;
8010410a:	8b 45 08             	mov    0x8(%ebp),%eax
8010410d:	89 43 20             	mov    %eax,0x20(%ebx)
	release(&ptable.lock);
80104110:	c7 04 24 20 2d 11 80 	movl   $0x80112d20,(%esp)
80104117:	e8 24 03 00 00       	call   80104440 <release>
	return 0;
}
8010411c:	83 c4 14             	add    $0x14,%esp
8010411f:	31 c0                	xor    %eax,%eax
80104121:	5b                   	pop    %ebx
80104122:	5d                   	pop    %ebp
80104123:	c3                   	ret    
...
8010413a:	c7 44 24 04 78 75 10 	movl   $0x80107578,0x4(%esp)
80104141:	80 
...
80104197:	e8 f4 fa ff ff       	call   80103c90 <sleep>
  while (lk->locked) {
...
801041a2:	c7 03 01 00 00 00    	movl   $0x1,(%ebx)
  lk->pid = myproc()->pid;
801041a8:	e8 03 f5 ff ff       	call   801036b0 <myproc>
...
801041f6:	e8 35 fc ff ff       	call   80103e30 <wakeup>
  release(&lk->lk);
...
80104232:	e8 79 f4 ff ff       	call   801036b0 <myproc>
80104237:	3b 58 18             	cmp    0x18(%eax),%ebx
...
801042f9:	e8 12 f3 ff ff       	call   80103610 <mycpu>
...
8010432b:	75 49                	jne    80104376 <popcli+0x56>
  ...
  if(--mycpu()->ncli < 0)
8010432d:	e8 de f2 ff ff       	call   80103610 <mycpu>
...
80104345:	e8 c6 f2 ff ff       	call   80103610 <mycpu>
...
80104369:	c3                   	ret    
    panic("popcli");
8010436a:	c7 04 24 9a 75 10 80 	movl   $0x8010759a,(%esp)
80104371:	e8 ea bf ff ff       	call   80100360 <panic>
    panic("popcli - interruptible");
80104376:	c7 04 24 83 75 10 80 	movl   $0x80107583,(%esp)
...
801043a8:	e8 63 f2 ff ff       	call   80103610 <mycpu>
...
80104402:	e8 09 f2 ff ff       	call   80103610 <mycpu>
...
80104424:	c3                   	ret    
    panic("acquire");
80104425:	c7 04 24 a1 75 10 80 	movl   $0x801075a1,(%esp)
...
80104472:	e9 a9 fe ff ff       	jmp    80104320 <popcli>
    panic("release");
80104477:	c7 04 24 a9 75 10 80 	movl   $0x801075a9,(%esp)
...
801046e7:	8b 5d 08             	mov    0x8(%ebp),%ebx
  struct proc *curproc = myproc();
801046ea:	e8 c1 ef ff ff       	call   801036b0 <myproc>

  if(addr >= curproc->sz || addr+4 > curproc->sz)
801046ef:	8b 40 08             	mov    0x8(%eax),%eax
801046f2:	39 d8                	cmp    %ebx,%eax
801046f4:	76 1a                	jbe    80104710 <fetchint+0x30>
801046f6:	8d 53 04             	lea    0x4(%ebx),%edx
801046f9:	39 d0                	cmp    %edx,%eax
801046fb:	72 13                	jb     80104710 <fetchint+0x30>
    return -1;
  *ip = *(int*)(addr);
801046fd:	8b 45 0c             	mov    0xc(%ebp),%eax
80104700:	8b 13                	mov    (%ebx),%edx
...
80104715:	eb ef                	jmp    80104706 <fetchint+0x26>
...
80104727:	8b 5d 08             	mov    0x8(%ebp),%ebx
  char *s, *ep;
  struct proc *curproc = myproc();
8010472a:	e8 81 ef ff ff       	call   801036b0 <myproc>

  if(addr >= curproc->sz)
8010472f:	39 58 08             	cmp    %ebx,0x8(%eax)
80104732:	76 28                	jbe    8010475c <fetchstr+0x3c>
    return -1;
  *pp = (char*)addr;
80104734:	8b 4d 0c             	mov    0xc(%ebp),%ecx
80104737:	89 da                	mov    %ebx,%edx
80104739:	89 19                	mov    %ebx,(%ecx)
  ep = (char*)curproc->sz;
8010473b:	8b 40 08             	mov    0x8(%eax),%eax
  for(s = *pp; s < ep; s++){
8010473e:	39 c3                	cmp    %eax,%ebx
80104740:	73 1a                	jae    8010475c <fetchstr+0x3c>
    if(*s == 0)
80104742:	80 3b 00             	cmpb   $0x0,(%ebx)
80104745:	75 0e                	jne    80104755 <fetchstr+0x35>
80104747:	eb 1f                	jmp    80104768 <fetchstr+0x48>
...
8010478b:	e8 20 ef ff ff       	call   801036b0 <myproc>
80104790:	89 75 0c             	mov    %esi,0xc(%ebp)
80104793:	8b 40 24             	mov    0x24(%eax),%eax
...
801047df:	8b 46 08             	mov    0x8(%esi),%eax
801047e2:	39 c2                	cmp    %eax,%edx
801047e4:	73 1a                	jae    80104800 <argptr+0x50>
801047e6:	01 d3                	add    %edx,%ebx
801047e8:	39 d8                	cmp    %ebx,%eax
801047ea:	72 14                	jb     80104800 <argptr+0x50>
    return -1;
  *pp = (char*)i;
...
801047f1:	83 c4 20             	add    $0x20,%esp
  return 0;
801047f4:	31 c0                	xor    %eax,%eax
}
801047f6:	5b                   	pop    %ebx
801047f7:	5e                   	pop    %esi
801047f8:	5d                   	pop    %ebp
...
80104855:	83 ec 10             	sub    $0x10,%esp
  int num;
  struct proc *curproc = myproc();
80104858:	e8 53 ee ff ff       	call   801036b0 <myproc>

  num = curproc->tf->eax;
8010485d:	8b 70 24             	mov    0x24(%eax),%esi
  struct proc *curproc = myproc();
...
80104868:	83 fa 19             	cmp    $0x19,%edx
...
801048d0:	8b 4c 90 34          	mov    0x34(%eax,%edx,4),%ecx
...
801048ec:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
      curproc->ofile[fd] = f;
801048f0:	89 5c 90 34          	mov    %ebx,0x34(%eax,%edx,4)
}
...
80104a20:	c7 44 24 04 68 76 10 	movl   $0x80107668,0x4(%esp)
80104a27:	80 
...
80104a3b:	c7 44 24 04 67 76 10 	movl   $0x80107667,0x4(%esp)
80104a42:	80 
...
80104a51:	79 89                	jns    801049dc <create+0xdc>
      panic("create dots");
80104a53:	c7 04 24 5b 76 10 80 	movl   $0x8010765b,(%esp)
80104a5a:	e8 01 b9 ff ff       	call   80100360 <panic>
    panic("create: dirlink");
80104a5f:	c7 04 24 6a 76 10 80 	movl   $0x8010766a,(%esp)
80104a66:	e8 f5 b8 ff ff       	call   80100360 <panic>
    panic("create: ialloc");
80104a6b:	c7 04 24 4c 76 10 80 	movl   $0x8010764c,(%esp)
...
80104aa9:	e8 02 ec ff ff       	call   801036b0 <myproc>
80104aae:	8b 55 f4             	mov    -0xc(%ebp),%edx
80104ab1:	8b 44 90 34          	mov    0x34(%eax,%edx,4),%eax
...
80104c23:	78 23                	js     80104c48 <sys_close+0x38>
  myproc()->ofile[fd] = 0;
80104c25:	e8 86 ea ff ff       	call   801036b0 <myproc>
80104c2a:	8b 55 f0             	mov    -0x10(%ebp),%edx
80104c2d:	c7 44 90 34 00 00 00 	movl   $0x0,0x34(%eax,%edx,4)
80104c34:	00 
  fileclose(f);
...
80104e11:	c7 44 24 04 68 76 10 	movl   $0x80107668,0x4(%esp)
80104e18:	80 
...
80104e29:	c7 44 24 04 67 76 10 	movl   $0x80107667,0x4(%esp)
80104e30:	80 
...
80104f7d:	c7 04 24 8c 76 10 80 	movl   $0x8010768c,(%esp)
80104f84:	e8 d7 b3 ff ff       	call   80100360 <panic>
    panic("unlink: writei");
80104f89:	c7 04 24 9e 76 10 80 	movl   $0x8010769e,(%esp)
80104f90:	e8 cb b3 ff ff       	call   80100360 <panic>
    panic("unlink: nlink < 1");
80104f95:	c7 04 24 7a 76 10 80 	movl   $0x8010767a,(%esp)
...
801051e5:	83 ec 20             	sub    $0x20,%esp
  ...
  struct inode *ip;
  struct proc *curproc = myproc();
801051e8:	e8 c3 e4 ff ff       	call   801036b0 <myproc>
...
8010522e:	e8 5d c5 ff ff       	call   80101790 <iunlock>
  iput(curproc->cwd);
80105233:	8b 46 74             	mov    0x74(%esi),%eax
...
80105243:	31 c0                	xor    %eax,%eax
  curproc->cwd = ip;
80105245:	89 5e 74             	mov    %ebx,0x74(%esi)
}
...
801053d5:	c7 44 98 34 00 00 00 	movl   $0x0,0x34(%eax,%ebx,4)
801053dc:	00 
    fileclose(rf);
...
80105403:	5d                   	pop    %ebp
  return fork();
80105404:	e9 57 e4 ff ff       	jmp    80103860 <fork>
...
80105433:	e8 e8 e6 ff ff       	call   80103b20 <exit>
...
80105477:	e8 c4 e8 ff ff       	call   80103d40 <wait>
}
8010547c:	c9                   	leave  
8010547d:	c3                   	ret    
...
80105494:	e8 e7 f2 ff ff       	call   80104780 <argint>
...
801054a3:	e8 f8 e9 ff ff       	call   80103ea0 <kill>
}
801054a8:	c9                   	leave  
801054a9:	c3                   	ret    
...
801054cb:	8b 40 18             	mov    0x18(%eax),%eax
}
801054ce:	c9                   	leave  
801054cf:	c3                   	ret    
...
801054e5:	e8 96 f2 ff ff       	call   80104780 <argint>
...
801054f3:	8b 55 f4             	mov    -0xc(%ebp),%edx
  addr = myproc()->sz;
801054f6:	8b 58 08             	mov    0x8(%eax),%ebx
  if(growproc(n) < 0)
801054f9:	89 14 24             	mov    %edx,(%esp)
801054fc:	e8 ef e2 ff ff       	call   801037f0 <growproc>
...
80105535:	e8 46 f2 ff ff       	call   80104780 <argint>
8010553a:	85 c0                	test   %eax,%eax
8010553c:	78 7e                	js     801055bc <sys_sleep+0x9c>
    return -1;
  acquire(&tickslock);
8010553e:	c7 04 24 60 4f 11 80 	movl   $0x80114f60,(%esp)
80105545:	e8 86 ee ff ff       	call   801043d0 <acquire>
  ticks0 = ticks;
  while(ticks - ticks0 < n){
8010554a:	8b 55 f4             	mov    -0xc(%ebp),%edx
  ticks0 = ticks;
8010554d:	8b 1d a0 57 11 80    	mov    0x801157a0,%ebx
  while(ticks - ticks0 < n){
...
80105560:	c7 44 24 04 60 4f 11 	movl   $0x80114f60,0x4(%esp)
80105567:	80 
80105568:	c7 04 24 a0 57 11 80 	movl   $0x801157a0,(%esp)
8010556f:	e8 1c e7 ff ff       	call   80103c90 <sleep>
  while(ticks - ticks0 < n){
80105574:	a1 a0 57 11 80       	mov    0x801157a0,%eax
...
80105585:	8b 40 30             	mov    0x30(%eax),%eax
80105588:	85 c0                	test   %eax,%eax
8010558a:	74 d4                	je     80105560 <sys_sleep+0x40>
      release(&tickslock);
8010558c:	c7 04 24 60 4f 11 80 	movl   $0x80114f60,(%esp)
80105593:	e8 a8 ee ff ff       	call   80104440 <release>
      return -1;
...
801055a4:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
  release(&tickslock);
801055a8:	c7 04 24 60 4f 11 80 	movl   $0x80114f60,(%esp)
801055af:	e8 8c ee ff ff       	call   80104440 <release>
}
...
801055d4:	83 ec 14             	sub    $0x14,%esp
  ...
  acquire(&tickslock);
801055d7:	c7 04 24 60 4f 11 80 	movl   $0x80114f60,(%esp)
801055de:	e8 ed ed ff ff       	call   801043d0 <acquire>
  xticks = ticks;
801055e3:	8b 1d a0 57 11 80    	mov    0x801157a0,%ebx
  release(&tickslock);
801055e9:	c7 04 24 60 4f 11 80 	movl   $0x80114f60,(%esp)
801055f0:	e8 4b ee ff ff       	call   80104440 <release>
  return xticks;
}
...
80105606:	c7 04 24 ad 76 10 80 	movl   $0x801076ad,(%esp)
8010560d:	e8 3e b0 ff ff       	call   80100650 <cprintf>
	return 0;
}
...
80105623:	83 ec 28             	sub    $0x28,%esp
	...
	int* status;
	if (argint(0, &pid) < 0)
80105626:	8d 45 ec             	lea    -0x14(%ebp),%eax
80105629:	89 44 24 04          	mov    %eax,0x4(%esp)
8010562d:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
80105634:	e8 47 f1 ff ff       	call   80104780 <argint>
80105639:	85 c0                	test   %eax,%eax
8010563b:	78 53                	js     80105690 <sys_waitpid+0x70>
		return -1;
...
80105653:	e8 58 f1 ff ff       	call   801047b0 <argptr>
	if (argint(2, &options) < 0)
80105658:	8d 45 f0             	lea    -0x10(%ebp),%eax
8010565b:	89 44 24 04          	mov    %eax,0x4(%esp)
8010565f:	c7 04 24 02 00 00 00 	movl   $0x2,(%esp)
80105666:	e8 15 f1 ff ff       	call   80104780 <argint>
8010566b:	85 c0                	test   %eax,%eax
8010566d:	78 21                	js     80105690 <sys_waitpid+0x70>
		return -1;
...
8010567d:	8b 45 ec             	mov    -0x14(%ebp),%eax
80105680:	89 04 24             	mov    %eax,(%esp)
80105683:	e8 68 e9 ff ff       	call   80103ff0 <waitpid>
}
80105688:	c9                   	leave  
80105689:	c3                   	ret    
...
801056b4:	e8 c7 f0 ff ff       	call   80104780 <argint>
	return setpriority(priority);
801056b9:	8b 45 f4             	mov    -0xc(%ebp),%eax
801056bc:	89 04 24             	mov    %eax,(%esp)
801056bf:	e8 2c ea ff ff       	call   801040f0 <setpriority>
}
801056c4:	c9                   	leave  
801056c5:	c3                   	ret    
...
801056c7:	06                   	push   %es
  pushl %fs
801056c8:	0f a0                	push   %fs
  pushl %gs
801056ca:	0f a8                	push   %gs
  pushal
801056cc:	60                   	pusha  
  
  # Set up data segments.
  movw $(SEG_KDATA<<3), %ax
801056cd:	66 b8 10 00          	mov    $0x10,%ax
  movw %ax, %ds
801056d1:	8e d8                	mov    %eax,%ds
  movw %ax, %es
801056d3:	8e c0                	mov    %eax,%es
...
80105704:	66 89 0c c5 a2 4f 11 	mov    %cx,-0x7feeb05e(,%eax,8)
8010570b:	80 
8010570c:	c6 04 c5 a4 4f 11 80 	movb   $0x0,-0x7feeb05c(,%eax,8)
80105713:	00 
...
80105749:	c7 44 24 04 c5 76 10 	movl   $0x801076c5,0x4(%esp)
80105750:	80 
80105751:	c7 04 24 60 4f 11 80 	movl   $0x80114f60,(%esp)
  SETGATE(idt[T_SYSCALL], 1, SEG_KCODE<<3, vectors[T_SYSCALL], DPL_USER);
80105758:	66 89 15 a2 51 11 80 	mov    %dx,0x801151a2
8010575f:	66 a3 a0 51 11 80    	mov    %ax,0x801151a0
80105765:	c1 e8 10             	shr    $0x10,%eax
80105768:	c6 05 a4 51 11 80 00 	movb   $0x0,0x801151a4
8010576f:	c6 05 a5 51 11 80 ef 	movb   $0xef,0x801151a5
80105776:	66 a3 a6 51 11 80    	mov    %ax,0x801151a6
  initlock(&tickslock, "time");
8010577c:	e8 df ea ff ff       	call   80104260 <initlock>
}
80105781:	c9                   	leave  
80105782:	c3                   	ret    
80105783:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
...
801057de:	77 08                	ja     801057e8 <trap+0x28>
801057e0:	ff 24 85 6c 77 10 80 	jmp    *-0x7fef8894(,%eax,4)
801057e7:	90                   	nop
    lapiceoi();
    break;
...
801057e8:	e8 c3 de ff ff       	call   801036b0 <myproc>
801057ed:	85 c0                	test   %eax,%eax
801057ef:	90                   	nop
801057f0:	0f 84 0a 02 00 00    	je     80105a00 <trap+0x240>
801057f6:	f6 43 3c 03          	testb  $0x3,0x3c(%ebx)
801057fa:	0f 84 00 02 00 00    	je     80105a00 <trap+0x240>
...
80105803:	8b 53 38             	mov    0x38(%ebx),%edx
80105806:	89 4d d8             	mov    %ecx,-0x28(%ebp)
80105809:	89 55 dc             	mov    %edx,-0x24(%ebp)
8010580c:	e8 7f de ff ff       	call   80103690 <cpuid>
80105811:	8b 73 30             	mov    0x30(%ebx),%esi
80105814:	89 c7                	mov    %eax,%edi
80105816:	8b 43 34             	mov    0x34(%ebx),%eax
80105819:	89 45 e4             	mov    %eax,-0x1c(%ebp)
            "eip 0x%x addr 0x%x--kill proc\n",
            myproc()->pid, myproc()->name, tf->trapno,
8010581c:	e8 8f de ff ff       	call   801036b0 <myproc>
80105821:	89 45 e0             	mov    %eax,-0x20(%ebp)
80105824:	e8 87 de ff ff       	call   801036b0 <myproc>
    cprintf("pid %d %s: trap %d err %d on cpu %d "
80105829:	8b 55 dc             	mov    -0x24(%ebp),%edx
8010582c:	89 74 24 0c          	mov    %esi,0xc(%esp)
            myproc()->pid, myproc()->name, tf->trapno,
80105830:	8b 75 e0             	mov    -0x20(%ebp),%esi
    cprintf("pid %d %s: trap %d err %d on cpu %d "
80105833:	8b 4d d8             	mov    -0x28(%ebp),%ecx
80105836:	89 7c 24 14          	mov    %edi,0x14(%esp)
8010583a:	89 54 24 18          	mov    %edx,0x18(%esp)
8010583e:	8b 55 e4             	mov    -0x1c(%ebp),%edx
            myproc()->pid, myproc()->name, tf->trapno,
80105841:	83 c6 78             	add    $0x78,%esi
    cprintf("pid %d %s: trap %d err %d on cpu %d "
80105844:	89 4c 24 1c          	mov    %ecx,0x1c(%esp)
            myproc()->pid, myproc()->name, tf->trapno,
80105848:	89 74 24 08          	mov    %esi,0x8(%esp)
    cprintf("pid %d %s: trap %d err %d on cpu %d "
8010584c:	89 54 24 10          	mov    %edx,0x10(%esp)
80105850:	8b 40 18             	mov    0x18(%eax),%eax
80105853:	c7 04 24 28 77 10 80 	movl   $0x80107728,(%esp)
8010585a:	89 44 24 04          	mov    %eax,0x4(%esp)
8010585e:	e8 ed ad ff ff       	call   80100650 <cprintf>
            tf->err, cpuid(), tf->eip, rcr2());
    myproc()->killed = 1;
80105863:	e8 48 de ff ff       	call   801036b0 <myproc>
80105868:	c7 40 30 01 00 00 00 	movl   $0x1,0x30(%eax)
8010586f:	90                   	nop
  }
...
8010587e:	8b 50 30             	mov    0x30(%eax),%edx
...
80105885:	e8 26 de ff ff       	call   801036b0 <myproc>
8010588a:	85 c0                	test   %eax,%eax
8010588c:	74 0d                	je     8010589b <trap+0xdb>
8010588e:	66 90                	xchg   %ax,%ax
80105890:	e8 1b de ff ff       	call   801036b0 <myproc>
80105895:	83 78 14 04          	cmpl   $0x4,0x14(%eax)
80105899:	74 55                	je     801058f0 <trap+0x130>
     tf->trapno == T_IRQ0+IRQ_TIMER)
    yield();

  // Check if the process has been killed since we yielded
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
8010589b:	e8 10 de ff ff       	call   801036b0 <myproc>
801058a0:	85 c0                	test   %eax,%eax
801058a2:	74 1d                	je     801058c1 <trap+0x101>
801058a4:	e8 07 de ff ff       	call   801036b0 <myproc>
801058a9:	8b 40 30             	mov    0x30(%eax),%eax
801058ac:	85 c0                	test   %eax,%eax
801058ae:	74 11                	je     801058c1 <trap+0x101>
801058b0:	0f b7 43 3c          	movzwl 0x3c(%ebx),%eax
801058b4:	83 e0 03             	and    $0x3,%eax
801058b7:	66 83 f8 03          	cmp    $0x3,%ax
801058bb:	0f 84 e8 00 00 00    	je     801059a9 <trap+0x1e9>
    exit(0);
}
801058c1:	83 c4 3c             	add    $0x3c,%esp
801058c4:	5b                   	pop    %ebx
801058c5:	5e                   	pop    %esi
801058c6:	5f                   	pop    %edi
801058c7:	5d                   	pop    %ebp
...
801058c9:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
801058d0:	0f b7 43 3c          	movzwl 0x3c(%ebx),%eax
...
801058e4:	e8 37 e2 ff ff       	call   80103b20 <exit>
801058e9:	eb 9a                	jmp    80105885 <trap+0xc5>
801058eb:	90                   	nop
801058ec:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
  if(myproc() && myproc()->state == RUNNING &&
801058f0:	83 7b 30 20          	cmpl   $0x20,0x30(%ebx)
801058f4:	75 a5                	jne    8010589b <trap+0xdb>
    yield();
801058f6:	e8 55 e3 ff ff       	call   80103c50 <yield>
801058fb:	eb 9e                	jmp    8010589b <trap+0xdb>
801058fd:	8d 76 00             	lea    0x0(%esi),%esi
    if(cpuid() == 0){
80105900:	e8 8b dd ff ff       	call   80103690 <cpuid>
80105905:	85 c0                	test   %eax,%eax
80105907:	0f 84 c3 00 00 00    	je     801059d0 <trap+0x210>
8010590d:	8d 76 00             	lea    0x0(%esi),%esi
    lapiceoi();
80105910:	e8 6b ce ff ff       	call   80102780 <lapiceoi>
    break;
80105915:	e9 56 ff ff ff       	jmp    80105870 <trap+0xb0>
...
80105925:	e8 56 ce ff ff       	call   80102780 <lapiceoi>
    break;
8010592a:	e9 41 ff ff ff       	jmp    80105870 <trap+0xb0>
8010592f:	90                   	nop
    uartintr();
...
80105940:	8b 7b 38             	mov    0x38(%ebx),%edi
80105943:	0f b7 73 3c          	movzwl 0x3c(%ebx),%esi
80105947:	e8 44 dd ff ff       	call   80103690 <cpuid>
8010594c:	c7 04 24 d0 76 10 80 	movl   $0x801076d0,(%esp)
80105953:	89 7c 24 0c          	mov    %edi,0xc(%esp)
80105957:	89 74 24 08          	mov    %esi,0x8(%esp)
8010595b:	89 44 24 04          	mov    %eax,0x4(%esp)
8010595f:	e8 ec ac ff ff       	call   80100650 <cprintf>
    lapiceoi();
80105964:	e8 17 ce ff ff       	call   80102780 <lapiceoi>
    break;
80105969:	e9 02 ff ff ff       	jmp    80105870 <trap+0xb0>
8010596e:	66 90                	xchg   %ax,%ax
    ideintr();
80105970:	e8 0b c7 ff ff       	call   80102080 <ideintr>
80105975:	eb 96                	jmp    8010590d <trap+0x14d>
80105977:	90                   	nop
80105978:	90                   	nop
80105979:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    if(myproc()->killed)
80105980:	e8 2b dd ff ff       	call   801036b0 <myproc>
80105985:	8b 70 30             	mov    0x30(%eax),%esi
80105988:	85 f6                	test   %esi,%esi
8010598a:	75 34                	jne    801059c0 <trap+0x200>
    myproc()->tf = tf;
8010598c:	e8 1f dd ff ff       	call   801036b0 <myproc>
80105991:	89 58 24             	mov    %ebx,0x24(%eax)
    syscall();
80105994:	e8 b7 ee ff ff       	call   80104850 <syscall>
    if(myproc()->killed)
80105999:	e8 12 dd ff ff       	call   801036b0 <myproc>
8010599e:	8b 48 30             	mov    0x30(%eax),%ecx
801059a1:	85 c9                	test   %ecx,%ecx
801059a3:	0f 84 18 ff ff ff    	je     801058c1 <trap+0x101>
      exit(0);
801059a9:	c7 45 08 00 00 00 00 	movl   $0x0,0x8(%ebp)
}
801059b0:	83 c4 3c             	add    $0x3c,%esp
801059b3:	5b                   	pop    %ebx
801059b4:	5e                   	pop    %esi
801059b5:	5f                   	pop    %edi
801059b6:	5d                   	pop    %ebp
      exit(0);
801059b7:	e9 64 e1 ff ff       	jmp    80103b20 <exit>
801059bc:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
      exit(0);
801059c0:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
801059c7:	e8 54 e1 ff ff       	call   80103b20 <exit>
801059cc:	eb be                	jmp    8010598c <trap+0x1cc>
801059ce:	66 90                	xchg   %ax,%ax
      acquire(&tickslock);
801059d0:	c7 04 24 60 4f 11 80 	movl   $0x80114f60,(%esp)
801059d7:	e8 f4 e9 ff ff       	call   801043d0 <acquire>
      wakeup(&ticks);
801059dc:	c7 04 24 a0 57 11 80 	movl   $0x801157a0,(%esp)
      ticks++;
801059e3:	83 05 a0 57 11 80 01 	addl   $0x1,0x801157a0
      wakeup(&ticks);
801059ea:	e8 41 e4 ff ff       	call   80103e30 <wakeup>
      release(&tickslock);
801059ef:	c7 04 24 60 4f 11 80 	movl   $0x80114f60,(%esp)
801059f6:	e8 45 ea ff ff       	call   80104440 <release>
801059fb:	e9 0d ff ff ff       	jmp    8010590d <trap+0x14d>
80105a00:	0f 20 d7             	mov    %cr2,%edi
      cprintf("unexpected trap %d from cpu %d eip %x (cr2=0x%x)\n",
80105a03:	8b 73 38             	mov    0x38(%ebx),%esi
80105a06:	e8 85 dc ff ff       	call   80103690 <cpuid>
80105a0b:	89 7c 24 10          	mov    %edi,0x10(%esp)
80105a0f:	89 74 24 0c          	mov    %esi,0xc(%esp)
80105a13:	89 44 24 08          	mov    %eax,0x8(%esp)
80105a17:	8b 43 30             	mov    0x30(%ebx),%eax
80105a1a:	c7 04 24 f4 76 10 80 	movl   $0x801076f4,(%esp)
80105a21:	89 44 24 04          	mov    %eax,0x4(%esp)
80105a25:	e8 26 ac ff ff       	call   80100650 <cprintf>
      panic("trap");
80105a2a:	c7 04 24 ca 76 10 80 	movl   $0x801076ca,(%esp)
80105a31:	e8 2a a9 ff ff       	call   80100360 <panic>
...
80105a4a:	74 14                	je     80105a60 <uartgetc+0x20>
  asm volatile("in %1,%0" : "=a" (data) : "d" (port));
...
80105a54:	74 0a                	je     80105a60 <uartgetc+0x20>
80105a56:	b2 f8                	mov    $0xf8,%dl
...
80105a77:	74 3f                	je     80105ab8 <uartputc+0x48>
{
...
80105a82:	53                   	push   %ebx
  if(!uart)
80105a83:	bb 80 00 00 00       	mov    $0x80,%ebx
{
80105a88:	83 ec 10             	sub    $0x10,%esp
80105a8b:	eb 14                	jmp    80105aa1 <uartputc+0x31>
80105a8d:	8d 76 00             	lea    0x0(%esi),%esi
    microdelay(10);
80105a90:	c7 04 24 0a 00 00 00 	movl   $0xa,(%esp)
80105a97:	e8 04 cd ff ff       	call   801027a0 <microdelay>
  for(i = 0; i < 128 && !(inb(COM1+5) & 0x20); i++)
80105a9c:	83 eb 01             	sub    $0x1,%ebx
80105a9f:	74 07                	je     80105aa8 <uartputc+0x38>
80105aa1:	89 f2                	mov    %esi,%edx
80105aa3:	ec                   	in     (%dx),%al
80105aa4:	a8 20                	test   $0x20,%al
80105aa6:	74 e8                	je     80105a90 <uartputc+0x20>
  outb(COM1+0, c);
80105aa8:	0f b6 45 08          	movzbl 0x8(%ebp),%eax
  asm volatile("out %0,%1" : : "a" (data), "d" (port));
80105aac:	ba f8 03 00 00       	mov    $0x3f8,%edx
...
80105ac5:	89 c8                	mov    %ecx,%eax
80105ac7:	57                   	push   %edi
80105ac8:	bf fa 03 00 00       	mov    $0x3fa,%edi
80105acd:	56                   	push   %esi
80105ace:	89 fa                	mov    %edi,%edx
80105ad0:	53                   	push   %ebx
80105ad1:	83 ec 1c             	sub    $0x1c,%esp
80105ad4:	ee                   	out    %al,(%dx)
80105ad5:	be fb 03 00 00       	mov    $0x3fb,%esi
80105ada:	b8 80 ff ff ff       	mov    $0xffffff80,%eax
80105adf:	89 f2                	mov    %esi,%edx
80105ae1:	ee                   	out    %al,(%dx)
80105ae2:	b8 0c 00 00 00       	mov    $0xc,%eax
80105ae7:	b2 f8                	mov    $0xf8,%dl
80105ae9:	ee                   	out    %al,(%dx)
80105aea:	bb f9 03 00 00       	mov    $0x3f9,%ebx
80105aef:	89 c8                	mov    %ecx,%eax
80105af1:	89 da                	mov    %ebx,%edx
80105af3:	ee                   	out    %al,(%dx)
80105af4:	b8 03 00 00 00       	mov    $0x3,%eax
80105af9:	89 f2                	mov    %esi,%edx
80105afb:	ee                   	out    %al,(%dx)
80105afc:	b2 fc                	mov    $0xfc,%dl
80105afe:	89 c8                	mov    %ecx,%eax
80105b00:	ee                   	out    %al,(%dx)
80105b01:	b8 01 00 00 00       	mov    $0x1,%eax
80105b06:	89 da                	mov    %ebx,%edx
80105b08:	ee                   	out    %al,(%dx)
  asm volatile("in %1,%0" : "=a" (data) : "d" (port));
80105b09:	b2 fd                	mov    $0xfd,%dl
80105b0b:	ec                   	in     (%dx),%al
  if(inb(COM1+5) == 0xFF)
80105b0c:	3c ff                	cmp    $0xff,%al
80105b0e:	74 42                	je     80105b52 <uartinit+0x92>
  uart = 1;
80105b10:	c7 05 bc a5 10 80 01 	movl   $0x1,0x8010a5bc
80105b17:	00 00 00 
80105b1a:	89 fa                	mov    %edi,%edx
80105b1c:	ec                   	in     (%dx),%al
80105b1d:	b2 f8                	mov    $0xf8,%dl
80105b1f:	ec                   	in     (%dx),%al
  ioapicenable(IRQ_COM1, 0);
80105b20:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
80105b27:	00 
  for(p="xv6...\n"; *p; p++)
80105b28:	bb ec 77 10 80       	mov    $0x801077ec,%ebx
  ioapicenable(IRQ_COM1, 0);
80105b2d:	c7 04 24 04 00 00 00 	movl   $0x4,(%esp)
80105b34:	e8 77 c7 ff ff       	call   801022b0 <ioapicenable>
  for(p="xv6...\n"; *p; p++)
...
80105b43:	83 c3 01             	add    $0x1,%ebx
    uartputc(*p);
80105b46:	e8 25 ff ff ff       	call   80105a70 <uartputc>
  for(p="xv6...\n"; *p; p++)
80105b4b:	0f be 03             	movsbl (%ebx),%eax
80105b4e:	84 c0                	test   %al,%al
80105b50:	75 ee                	jne    80105b40 <uartinit+0x80>
}
80105b52:	83 c4 1c             	add    $0x1c,%esp
80105b55:	5b                   	pop    %ebx
80105b56:	5e                   	pop    %esi
80105b57:	5f                   	pop    %edi
80105b58:	5d                   	pop    %ebp
...
80105b66:	c7 04 24 40 5a 10 80 	movl   $0x80105a40,(%esp)
80105b6d:	e8 3e ac ff ff       	call   801007b0 <consoleintr>
}
80105b72:	c9                   	leave  
80105b73:	c3                   	ret    
...
80105b76:	6a 00                	push   $0x0
  jmp alltraps
80105b78:	e9 49 fb ff ff       	jmp    801056c6 <alltraps>
...
80105b7f:	6a 01                	push   $0x1
  jmp alltraps
80105b81:	e9 40 fb ff ff       	jmp    801056c6 <alltraps>
...
80105b86:	6a 00                	push   $0x0
  pushl $2
80105b88:	6a 02                	push   $0x2
  jmp alltraps
80105b8a:	e9 37 fb ff ff       	jmp    801056c6 <alltraps>
...
80105b8f:	6a 00                	push   $0x0
  pushl $3
80105b91:	6a 03                	push   $0x3
  jmp alltraps
80105b93:	e9 2e fb ff ff       	jmp    801056c6 <alltraps>
...
80105b9a:	6a 04                	push   $0x4
  jmp alltraps
80105b9c:	e9 25 fb ff ff       	jmp    801056c6 <alltraps>
...
80105ba1:	6a 00                	push   $0x0
  pushl $5
80105ba3:	6a 05                	push   $0x5
  jmp alltraps
80105ba5:	e9 1c fb ff ff       	jmp    801056c6 <alltraps>
...
80105baa:	6a 00                	push   $0x0
  pushl $6
80105bac:	6a 06                	push   $0x6
  jmp alltraps
80105bae:	e9 13 fb ff ff       	jmp    801056c6 <alltraps>
...
80105bb3:	6a 00                	push   $0x0
  pushl $7
80105bb5:	6a 07                	push   $0x7
  jmp alltraps
80105bb7:	e9 0a fb ff ff       	jmp    801056c6 <alltraps>
...
80105bbc:	6a 08                	push   $0x8
  jmp alltraps
80105bbe:	e9 03 fb ff ff       	jmp    801056c6 <alltraps>
...
80105bc3:	6a 00                	push   $0x0
  pushl $9
80105bc5:	6a 09                	push   $0x9
  jmp alltraps
80105bc7:	e9 fa fa ff ff       	jmp    801056c6 <alltraps>

80105bcc <vector10>:
.globl vector10
vector10:
  pushl $10
80105bcc:	6a 0a                	push   $0xa
  jmp alltraps
80105bce:	e9 f3 fa ff ff       	jmp    801056c6 <alltraps>

80105bd3 <vector11>:
.globl vector11
vector11:
  pushl $11
80105bd3:	6a 0b                	push   $0xb
  jmp alltraps
80105bd5:	e9 ec fa ff ff       	jmp    801056c6 <alltraps>

80105bda <vector12>:
.globl vector12
vector12:
  pushl $12
80105bda:	6a 0c                	push   $0xc
  jmp alltraps
80105bdc:	e9 e5 fa ff ff       	jmp    801056c6 <alltraps>

80105be1 <vector13>:
.globl vector13
vector13:
  pushl $13
80105be1:	6a 0d                	push   $0xd
  jmp alltraps
80105be3:	e9 de fa ff ff       	jmp    801056c6 <alltraps>

80105be8 <vector14>:
.globl vector14
vector14:
  pushl $14
80105be8:	6a 0e                	push   $0xe
  jmp alltraps
80105bea:	e9 d7 fa ff ff       	jmp    801056c6 <alltraps>
...
80105bef:	6a 00                	push   $0x0
  pushl $15
80105bf1:	6a 0f                	push   $0xf
  jmp alltraps
80105bf3:	e9 ce fa ff ff       	jmp    801056c6 <alltraps>
...
80105bfa:	6a 10                	push   $0x10
  jmp alltraps
80105bfc:	e9 c5 fa ff ff       	jmp    801056c6 <alltraps>

80105c01 <vector17>:
.globl vector17
vector17:
  pushl $17
80105c01:	6a 11                	push   $0x11
  jmp alltraps
80105c03:	e9 be fa ff ff       	jmp    801056c6 <alltraps>
...
80105c08:	6a 00                	push   $0x0
  pushl $18
80105c0a:	6a 12                	push   $0x12
  jmp alltraps
80105c0c:	e9 b5 fa ff ff       	jmp    801056c6 <alltraps>
...
80105c11:	6a 00                	push   $0x0
  pushl $19
80105c13:	6a 13                	push   $0x13
  jmp alltraps
80105c15:	e9 ac fa ff ff       	jmp    801056c6 <alltraps>
...
80105c1a:	6a 00                	push   $0x0
  pushl $20
80105c1c:	6a 14                	push   $0x14
  jmp alltraps
80105c1e:	e9 a3 fa ff ff       	jmp    801056c6 <alltraps>
...
80105c23:	6a 00                	push   $0x0
  pushl $21
80105c25:	6a 15                	push   $0x15
  jmp alltraps
80105c27:	e9 9a fa ff ff       	jmp    801056c6 <alltraps>
...
80105c2c:	6a 00                	push   $0x0
  pushl $22
80105c2e:	6a 16                	push   $0x16
  jmp alltraps
80105c30:	e9 91 fa ff ff       	jmp    801056c6 <alltraps>
...
80105c35:	6a 00                	push   $0x0
  pushl $23
80105c37:	6a 17                	push   $0x17
  jmp alltraps
80105c39:	e9 88 fa ff ff       	jmp    801056c6 <alltraps>
...
80105c3e:	6a 00                	push   $0x0
  pushl $24
80105c40:	6a 18                	push   $0x18
  jmp alltraps
80105c42:	e9 7f fa ff ff       	jmp    801056c6 <alltraps>
...
80105c47:	6a 00                	push   $0x0
  pushl $25
80105c49:	6a 19                	push   $0x19
  jmp alltraps
80105c4b:	e9 76 fa ff ff       	jmp    801056c6 <alltraps>
...
80105c50:	6a 00                	push   $0x0
  pushl $26
80105c52:	6a 1a                	push   $0x1a
  jmp alltraps
80105c54:	e9 6d fa ff ff       	jmp    801056c6 <alltraps>
...
80105c59:	6a 00                	push   $0x0
  pushl $27
80105c5b:	6a 1b                	push   $0x1b
  jmp alltraps
80105c5d:	e9 64 fa ff ff       	jmp    801056c6 <alltraps>
...
80105c62:	6a 00                	push   $0x0
  pushl $28
80105c64:	6a 1c                	push   $0x1c
  jmp alltraps
80105c66:	e9 5b fa ff ff       	jmp    801056c6 <alltraps>
...
80105c6b:	6a 00                	push   $0x0
  pushl $29
80105c6d:	6a 1d                	push   $0x1d
  jmp alltraps
80105c6f:	e9 52 fa ff ff       	jmp    801056c6 <alltraps>
...
80105c74:	6a 00                	push   $0x0
  pushl $30
80105c76:	6a 1e                	push   $0x1e
  jmp alltraps
80105c78:	e9 49 fa ff ff       	jmp    801056c6 <alltraps>
...
80105c7d:	6a 00                	push   $0x0
  pushl $31
80105c7f:	6a 1f                	push   $0x1f
  jmp alltraps
80105c81:	e9 40 fa ff ff       	jmp    801056c6 <alltraps>
...
80105c86:	6a 00                	push   $0x0
  pushl $32
80105c88:	6a 20                	push   $0x20
  jmp alltraps
80105c8a:	e9 37 fa ff ff       	jmp    801056c6 <alltraps>
...
80105c8f:	6a 00                	push   $0x0
  pushl $33
80105c91:	6a 21                	push   $0x21
  jmp alltraps
80105c93:	e9 2e fa ff ff       	jmp    801056c6 <alltraps>
...
80105c98:	6a 00                	push   $0x0
  pushl $34
80105c9a:	6a 22                	push   $0x22
  jmp alltraps
80105c9c:	e9 25 fa ff ff       	jmp    801056c6 <alltraps>
...
80105ca1:	6a 00                	push   $0x0
  pushl $35
80105ca3:	6a 23                	push   $0x23
  jmp alltraps
80105ca5:	e9 1c fa ff ff       	jmp    801056c6 <alltraps>
...
80105caa:	6a 00                	push   $0x0
  pushl $36
80105cac:	6a 24                	push   $0x24
  jmp alltraps
80105cae:	e9 13 fa ff ff       	jmp    801056c6 <alltraps>
...
80105cb3:	6a 00                	push   $0x0
  pushl $37
80105cb5:	6a 25                	push   $0x25
  jmp alltraps
80105cb7:	e9 0a fa ff ff       	jmp    801056c6 <alltraps>
...
80105cbc:	6a 00                	push   $0x0
  pushl $38
80105cbe:	6a 26                	push   $0x26
  jmp alltraps
80105cc0:	e9 01 fa ff ff       	jmp    801056c6 <alltraps>
...
80105cc5:	6a 00                	push   $0x0
  pushl $39
80105cc7:	6a 27                	push   $0x27
  jmp alltraps
80105cc9:	e9 f8 f9 ff ff       	jmp    801056c6 <alltraps>
...
80105cce:	6a 00                	push   $0x0
  pushl $40
80105cd0:	6a 28                	push   $0x28
  jmp alltraps
80105cd2:	e9 ef f9 ff ff       	jmp    801056c6 <alltraps>
...
80105cd7:	6a 00                	push   $0x0
  pushl $41
80105cd9:	6a 29                	push   $0x29
  jmp alltraps
80105cdb:	e9 e6 f9 ff ff       	jmp    801056c6 <alltraps>
...
80105ce0:	6a 00                	push   $0x0
  pushl $42
80105ce2:	6a 2a                	push   $0x2a
  jmp alltraps
80105ce4:	e9 dd f9 ff ff       	jmp    801056c6 <alltraps>
...
80105ce9:	6a 00                	push   $0x0
  pushl $43
80105ceb:	6a 2b                	push   $0x2b
  jmp alltraps
80105ced:	e9 d4 f9 ff ff       	jmp    801056c6 <alltraps>
...
80105cf2:	6a 00                	push   $0x0
  pushl $44
80105cf4:	6a 2c                	push   $0x2c
  jmp alltraps
80105cf6:	e9 cb f9 ff ff       	jmp    801056c6 <alltraps>
...
80105cfb:	6a 00                	push   $0x0
  pushl $45
80105cfd:	6a 2d                	push   $0x2d
  jmp alltraps
80105cff:	e9 c2 f9 ff ff       	jmp    801056c6 <alltraps>
...
80105d04:	6a 00                	push   $0x0
  pushl $46
80105d06:	6a 2e                	push   $0x2e
  jmp alltraps
80105d08:	e9 b9 f9 ff ff       	jmp    801056c6 <alltraps>
...
80105d0d:	6a 00                	push   $0x0
  pushl $47
80105d0f:	6a 2f                	push   $0x2f
  jmp alltraps
80105d11:	e9 b0 f9 ff ff       	jmp    801056c6 <alltraps>
...
80105d16:	6a 00                	push   $0x0
  pushl $48
80105d18:	6a 30                	push   $0x30
  jmp alltraps
80105d1a:	e9 a7 f9 ff ff       	jmp    801056c6 <alltraps>
...
80105d1f:	6a 00                	push   $0x0
  pushl $49
80105d21:	6a 31                	push   $0x31
  jmp alltraps
80105d23:	e9 9e f9 ff ff       	jmp    801056c6 <alltraps>
...
80105d28:	6a 00                	push   $0x0
  pushl $50
80105d2a:	6a 32                	push   $0x32
  jmp alltraps
80105d2c:	e9 95 f9 ff ff       	jmp    801056c6 <alltraps>
...
80105d31:	6a 00                	push   $0x0
  pushl $51
80105d33:	6a 33                	push   $0x33
  jmp alltraps
80105d35:	e9 8c f9 ff ff       	jmp    801056c6 <alltraps>
...
80105d3a:	6a 00                	push   $0x0
  pushl $52
80105d3c:	6a 34                	push   $0x34
  jmp alltraps
80105d3e:	e9 83 f9 ff ff       	jmp    801056c6 <alltraps>
...
80105d43:	6a 00                	push   $0x0
  pushl $53
80105d45:	6a 35                	push   $0x35
  jmp alltraps
80105d47:	e9 7a f9 ff ff       	jmp    801056c6 <alltraps>
...
80105d4c:	6a 00                	push   $0x0
  pushl $54
80105d4e:	6a 36                	push   $0x36
  jmp alltraps
80105d50:	e9 71 f9 ff ff       	jmp    801056c6 <alltraps>
...
80105d55:	6a 00                	push   $0x0
  pushl $55
80105d57:	6a 37                	push   $0x37
  jmp alltraps
80105d59:	e9 68 f9 ff ff       	jmp    801056c6 <alltraps>
...
80105d5e:	6a 00                	push   $0x0
  pushl $56
80105d60:	6a 38                	push   $0x38
  jmp alltraps
80105d62:	e9 5f f9 ff ff       	jmp    801056c6 <alltraps>
...
80105d67:	6a 00                	push   $0x0
  pushl $57
80105d69:	6a 39                	push   $0x39
  jmp alltraps
80105d6b:	e9 56 f9 ff ff       	jmp    801056c6 <alltraps>
...
80105d70:	6a 00                	push   $0x0
  pushl $58
80105d72:	6a 3a                	push   $0x3a
  jmp alltraps
80105d74:	e9 4d f9 ff ff       	jmp    801056c6 <alltraps>
...
80105d79:	6a 00                	push   $0x0
  pushl $59
80105d7b:	6a 3b                	push   $0x3b
  jmp alltraps
80105d7d:	e9 44 f9 ff ff       	jmp    801056c6 <alltraps>
...
80105d82:	6a 00                	push   $0x0
  pushl $60
80105d84:	6a 3c                	push   $0x3c
  jmp alltraps
80105d86:	e9 3b f9 ff ff       	jmp    801056c6 <alltraps>
...
80105d8b:	6a 00                	push   $0x0
  pushl $61
80105d8d:	6a 3d                	push   $0x3d
  jmp alltraps
80105d8f:	e9 32 f9 ff ff       	jmp    801056c6 <alltraps>
...
80105d94:	6a 00                	push   $0x0
  pushl $62
80105d96:	6a 3e                	push   $0x3e
  jmp alltraps
80105d98:	e9 29 f9 ff ff       	jmp    801056c6 <alltraps>
...
80105d9d:	6a 00                	push   $0x0
  pushl $63
80105d9f:	6a 3f                	push   $0x3f
  jmp alltraps
80105da1:	e9 20 f9 ff ff       	jmp    801056c6 <alltraps>
...
80105da6:	6a 00                	push   $0x0
  pushl $64
80105da8:	6a 40                	push   $0x40
  jmp alltraps
80105daa:	e9 17 f9 ff ff       	jmp    801056c6 <alltraps>
...
80105daf:	6a 00                	push   $0x0
  pushl $65
80105db1:	6a 41                	push   $0x41
  jmp alltraps
80105db3:	e9 0e f9 ff ff       	jmp    801056c6 <alltraps>
...
80105db8:	6a 00                	push   $0x0
  pushl $66
80105dba:	6a 42                	push   $0x42
  jmp alltraps
80105dbc:	e9 05 f9 ff ff       	jmp    801056c6 <alltraps>
...
80105dc1:	6a 00                	push   $0x0
  pushl $67
80105dc3:	6a 43                	push   $0x43
  jmp alltraps
80105dc5:	e9 fc f8 ff ff       	jmp    801056c6 <alltraps>
...
80105dca:	6a 00                	push   $0x0
  pushl $68
80105dcc:	6a 44                	push   $0x44
  jmp alltraps
80105dce:	e9 f3 f8 ff ff       	jmp    801056c6 <alltraps>
...
80105dd3:	6a 00                	push   $0x0
  pushl $69
80105dd5:	6a 45                	push   $0x45
  jmp alltraps
80105dd7:	e9 ea f8 ff ff       	jmp    801056c6 <alltraps>
...
80105ddc:	6a 00                	push   $0x0
  pushl $70
80105dde:	6a 46                	push   $0x46
  jmp alltraps
80105de0:	e9 e1 f8 ff ff       	jmp    801056c6 <alltraps>
...
80105de5:	6a 00                	push   $0x0
  pushl $71
80105de7:	6a 47                	push   $0x47
  jmp alltraps
80105de9:	e9 d8 f8 ff ff       	jmp    801056c6 <alltraps>
...
80105dee:	6a 00                	push   $0x0
  pushl $72
80105df0:	6a 48                	push   $0x48
  jmp alltraps
80105df2:	e9 cf f8 ff ff       	jmp    801056c6 <alltraps>
...
80105df7:	6a 00                	push   $0x0
  pushl $73
80105df9:	6a 49                	push   $0x49
  jmp alltraps
80105dfb:	e9 c6 f8 ff ff       	jmp    801056c6 <alltraps>
...
80105e00:	6a 00                	push   $0x0
  pushl $74
80105e02:	6a 4a                	push   $0x4a
  jmp alltraps
80105e04:	e9 bd f8 ff ff       	jmp    801056c6 <alltraps>
...
80105e09:	6a 00                	push   $0x0
  pushl $75
80105e0b:	6a 4b                	push   $0x4b
  jmp alltraps
80105e0d:	e9 b4 f8 ff ff       	jmp    801056c6 <alltraps>
...
80105e12:	6a 00                	push   $0x0
  pushl $76
80105e14:	6a 4c                	push   $0x4c
  jmp alltraps
80105e16:	e9 ab f8 ff ff       	jmp    801056c6 <alltraps>
...
80105e1b:	6a 00                	push   $0x0
  pushl $77
80105e1d:	6a 4d                	push   $0x4d
  jmp alltraps
80105e1f:	e9 a2 f8 ff ff       	jmp    801056c6 <alltraps>
...
80105e24:	6a 00                	push   $0x0
  pushl $78
80105e26:	6a 4e                	push   $0x4e
  jmp alltraps
80105e28:	e9 99 f8 ff ff       	jmp    801056c6 <alltraps>
...
80105e2d:	6a 00                	push   $0x0
  pushl $79
80105e2f:	6a 4f                	push   $0x4f
  jmp alltraps
80105e31:	e9 90 f8 ff ff       	jmp    801056c6 <alltraps>
...
80105e36:	6a 00                	push   $0x0
  pushl $80
80105e38:	6a 50                	push   $0x50
  jmp alltraps
80105e3a:	e9 87 f8 ff ff       	jmp    801056c6 <alltraps>
...
80105e3f:	6a 00                	push   $0x0
  pushl $81
80105e41:	6a 51                	push   $0x51
  jmp alltraps
80105e43:	e9 7e f8 ff ff       	jmp    801056c6 <alltraps>
...
80105e48:	6a 00                	push   $0x0
  pushl $82
80105e4a:	6a 52                	push   $0x52
  jmp alltraps
80105e4c:	e9 75 f8 ff ff       	jmp    801056c6 <alltraps>
...
80105e51:	6a 00                	push   $0x0
  pushl $83
80105e53:	6a 53                	push   $0x53
  jmp alltraps
80105e55:	e9 6c f8 ff ff       	jmp    801056c6 <alltraps>
...
80105e5a:	6a 00                	push   $0x0
  pushl $84
80105e5c:	6a 54                	push   $0x54
  jmp alltraps
80105e5e:	e9 63 f8 ff ff       	jmp    801056c6 <alltraps>
...
80105e63:	6a 00                	push   $0x0
  pushl $85
80105e65:	6a 55                	push   $0x55
  jmp alltraps
80105e67:	e9 5a f8 ff ff       	jmp    801056c6 <alltraps>
...
80105e6c:	6a 00                	push   $0x0
  pushl $86
80105e6e:	6a 56                	push   $0x56
  jmp alltraps
80105e70:	e9 51 f8 ff ff       	jmp    801056c6 <alltraps>
...
80105e75:	6a 00                	push   $0x0
  pushl $87
80105e77:	6a 57                	push   $0x57
  jmp alltraps
80105e79:	e9 48 f8 ff ff       	jmp    801056c6 <alltraps>
...
80105e7e:	6a 00                	push   $0x0
  pushl $88
80105e80:	6a 58                	push   $0x58
  jmp alltraps
80105e82:	e9 3f f8 ff ff       	jmp    801056c6 <alltraps>
...
80105e87:	6a 00                	push   $0x0
  pushl $89
80105e89:	6a 59                	push   $0x59
  jmp alltraps
80105e8b:	e9 36 f8 ff ff       	jmp    801056c6 <alltraps>
...
80105e90:	6a 00                	push   $0x0
  pushl $90
80105e92:	6a 5a                	push   $0x5a
  jmp alltraps
80105e94:	e9 2d f8 ff ff       	jmp    801056c6 <alltraps>
...
80105e99:	6a 00                	push   $0x0
  pushl $91
80105e9b:	6a 5b                	push   $0x5b
  jmp alltraps
80105e9d:	e9 24 f8 ff ff       	jmp    801056c6 <alltraps>
...
80105ea2:	6a 00                	push   $0x0
  pushl $92
80105ea4:	6a 5c                	push   $0x5c
  jmp alltraps
80105ea6:	e9 1b f8 ff ff       	jmp    801056c6 <alltraps>
...
80105eab:	6a 00                	push   $0x0
  pushl $93
80105ead:	6a 5d                	push   $0x5d
  jmp alltraps
80105eaf:	e9 12 f8 ff ff       	jmp    801056c6 <alltraps>
...
80105eb4:	6a 00                	push   $0x0
  pushl $94
80105eb6:	6a 5e                	push   $0x5e
  jmp alltraps
80105eb8:	e9 09 f8 ff ff       	jmp    801056c6 <alltraps>
...
80105ebd:	6a 00                	push   $0x0
  pushl $95
80105ebf:	6a 5f                	push   $0x5f
  jmp alltraps
80105ec1:	e9 00 f8 ff ff       	jmp    801056c6 <alltraps>
...
80105ec6:	6a 00                	push   $0x0
  pushl $96
80105ec8:	6a 60                	push   $0x60
  jmp alltraps
80105eca:	e9 f7 f7 ff ff       	jmp    801056c6 <alltraps>
...
80105ecf:	6a 00                	push   $0x0
  pushl $97
80105ed1:	6a 61                	push   $0x61
  jmp alltraps
80105ed3:	e9 ee f7 ff ff       	jmp    801056c6 <alltraps>
...
80105ed8:	6a 00                	push   $0x0
  pushl $98
80105eda:	6a 62                	push   $0x62
  jmp alltraps
80105edc:	e9 e5 f7 ff ff       	jmp    801056c6 <alltraps>
...
80105ee1:	6a 00                	push   $0x0
  pushl $99
80105ee3:	6a 63                	push   $0x63
  jmp alltraps
80105ee5:	e9 dc f7 ff ff       	jmp    801056c6 <alltraps>
...
80105eea:	6a 00                	push   $0x0
  pushl $100
80105eec:	6a 64                	push   $0x64
  jmp alltraps
80105eee:	e9 d3 f7 ff ff       	jmp    801056c6 <alltraps>
...
80105ef3:	6a 00                	push   $0x0
  pushl $101
80105ef5:	6a 65                	push   $0x65
  jmp alltraps
80105ef7:	e9 ca f7 ff ff       	jmp    801056c6 <alltraps>
...
80105efc:	6a 00                	push   $0x0
  pushl $102
80105efe:	6a 66                	push   $0x66
  jmp alltraps
80105f00:	e9 c1 f7 ff ff       	jmp    801056c6 <alltraps>
...
80105f05:	6a 00                	push   $0x0
  pushl $103
80105f07:	6a 67                	push   $0x67
  jmp alltraps
80105f09:	e9 b8 f7 ff ff       	jmp    801056c6 <alltraps>
...
80105f0e:	6a 00                	push   $0x0
  pushl $104
80105f10:	6a 68                	push   $0x68
  jmp alltraps
80105f12:	e9 af f7 ff ff       	jmp    801056c6 <alltraps>
...
80105f17:	6a 00                	push   $0x0
  pushl $105
80105f19:	6a 69                	push   $0x69
  jmp alltraps
80105f1b:	e9 a6 f7 ff ff       	jmp    801056c6 <alltraps>
...
80105f20:	6a 00                	push   $0x0
  pushl $106
80105f22:	6a 6a                	push   $0x6a
  jmp alltraps
80105f24:	e9 9d f7 ff ff       	jmp    801056c6 <alltraps>
...
80105f29:	6a 00                	push   $0x0
  pushl $107
80105f2b:	6a 6b                	push   $0x6b
  jmp alltraps
80105f2d:	e9 94 f7 ff ff       	jmp    801056c6 <alltraps>
...
80105f32:	6a 00                	push   $0x0
  pushl $108
80105f34:	6a 6c                	push   $0x6c
  jmp alltraps
80105f36:	e9 8b f7 ff ff       	jmp    801056c6 <alltraps>
...
80105f3b:	6a 00                	push   $0x0
  pushl $109
80105f3d:	6a 6d                	push   $0x6d
  jmp alltraps
80105f3f:	e9 82 f7 ff ff       	jmp    801056c6 <alltraps>
...
80105f44:	6a 00                	push   $0x0
  pushl $110
80105f46:	6a 6e                	push   $0x6e
  jmp alltraps
80105f48:	e9 79 f7 ff ff       	jmp    801056c6 <alltraps>
...
80105f4d:	6a 00                	push   $0x0
  pushl $111
80105f4f:	6a 6f                	push   $0x6f
  jmp alltraps
80105f51:	e9 70 f7 ff ff       	jmp    801056c6 <alltraps>
...
80105f56:	6a 00                	push   $0x0
  pushl $112
80105f58:	6a 70                	push   $0x70
  jmp alltraps
80105f5a:	e9 67 f7 ff ff       	jmp    801056c6 <alltraps>
...
80105f5f:	6a 00                	push   $0x0
  pushl $113
80105f61:	6a 71                	push   $0x71
  jmp alltraps
80105f63:	e9 5e f7 ff ff       	jmp    801056c6 <alltraps>
...
80105f68:	6a 00                	push   $0x0
  pushl $114
80105f6a:	6a 72                	push   $0x72
  jmp alltraps
80105f6c:	e9 55 f7 ff ff       	jmp    801056c6 <alltraps>
...
80105f71:	6a 00                	push   $0x0
  pushl $115
80105f73:	6a 73                	push   $0x73
  jmp alltraps
80105f75:	e9 4c f7 ff ff       	jmp    801056c6 <alltraps>
...
80105f7a:	6a 00                	push   $0x0
  pushl $116
80105f7c:	6a 74                	push   $0x74
  jmp alltraps
80105f7e:	e9 43 f7 ff ff       	jmp    801056c6 <alltraps>
...
80105f83:	6a 00                	push   $0x0
  pushl $117
80105f85:	6a 75                	push   $0x75
  jmp alltraps
80105f87:	e9 3a f7 ff ff       	jmp    801056c6 <alltraps>
...
80105f8c:	6a 00                	push   $0x0
  pushl $118
80105f8e:	6a 76                	push   $0x76
  jmp alltraps
80105f90:	e9 31 f7 ff ff       	jmp    801056c6 <alltraps>
...
80105f95:	6a 00                	push   $0x0
  pushl $119
80105f97:	6a 77                	push   $0x77
  jmp alltraps
80105f99:	e9 28 f7 ff ff       	jmp    801056c6 <alltraps>
...
80105f9e:	6a 00                	push   $0x0
  pushl $120
80105fa0:	6a 78                	push   $0x78
  jmp alltraps
80105fa2:	e9 1f f7 ff ff       	jmp    801056c6 <alltraps>
...
80105fa7:	6a 00                	push   $0x0
  pushl $121
80105fa9:	6a 79                	push   $0x79
  jmp alltraps
80105fab:	e9 16 f7 ff ff       	jmp    801056c6 <alltraps>
...
80105fb0:	6a 00                	push   $0x0
  pushl $122
80105fb2:	6a 7a                	push   $0x7a
  jmp alltraps
80105fb4:	e9 0d f7 ff ff       	jmp    801056c6 <alltraps>
...
80105fb9:	6a 00                	push   $0x0
  pushl $123
80105fbb:	6a 7b                	push   $0x7b
  jmp alltraps
80105fbd:	e9 04 f7 ff ff       	jmp    801056c6 <alltraps>
...
80105fc2:	6a 00                	push   $0x0
  pushl $124
80105fc4:	6a 7c                	push   $0x7c
  jmp alltraps
80105fc6:	e9 fb f6 ff ff       	jmp    801056c6 <alltraps>
...
80105fcb:	6a 00                	push   $0x0
  pushl $125
80105fcd:	6a 7d                	push   $0x7d
  jmp alltraps
80105fcf:	e9 f2 f6 ff ff       	jmp    801056c6 <alltraps>
...
80105fd4:	6a 00                	push   $0x0
  pushl $126
80105fd6:	6a 7e                	push   $0x7e
  jmp alltraps
80105fd8:	e9 e9 f6 ff ff       	jmp    801056c6 <alltraps>
...
80105fdd:	6a 00                	push   $0x0
  pushl $127
80105fdf:	6a 7f                	push   $0x7f
  jmp alltraps
80105fe1:	e9 e0 f6 ff ff       	jmp    801056c6 <alltraps>
...
80105fe8:	68 80 00 00 00       	push   $0x80
  jmp alltraps
80105fed:	e9 d4 f6 ff ff       	jmp    801056c6 <alltraps>
...
80105ff2:	6a 00                	push   $0x0
  pushl $129
80105ff4:	68 81 00 00 00       	push   $0x81
  jmp alltraps
80105ff9:	e9 c8 f6 ff ff       	jmp    801056c6 <alltraps>
...
80105ffe:	6a 00                	push   $0x0
  pushl $130
80106000:	68 82 00 00 00       	push   $0x82
  jmp alltraps
80106005:	e9 bc f6 ff ff       	jmp    801056c6 <alltraps>
...
8010600a:	6a 00                	push   $0x0
  pushl $131
8010600c:	68 83 00 00 00       	push   $0x83
  jmp alltraps
80106011:	e9 b0 f6 ff ff       	jmp    801056c6 <alltraps>
...
80106016:	6a 00                	push   $0x0
  pushl $132
80106018:	68 84 00 00 00       	push   $0x84
  jmp alltraps
8010601d:	e9 a4 f6 ff ff       	jmp    801056c6 <alltraps>
...
80106022:	6a 00                	push   $0x0
  pushl $133
80106024:	68 85 00 00 00       	push   $0x85
  jmp alltraps
80106029:	e9 98 f6 ff ff       	jmp    801056c6 <alltraps>
...
8010602e:	6a 00                	push   $0x0
  pushl $134
80106030:	68 86 00 00 00       	push   $0x86
  jmp alltraps
80106035:	e9 8c f6 ff ff       	jmp    801056c6 <alltraps>
...
8010603a:	6a 00                	push   $0x0
  pushl $135
8010603c:	68 87 00 00 00       	push   $0x87
  jmp alltraps
80106041:	e9 80 f6 ff ff       	jmp    801056c6 <alltraps>
...
80106046:	6a 00                	push   $0x0
  pushl $136
80106048:	68 88 00 00 00       	push   $0x88
  jmp alltraps
8010604d:	e9 74 f6 ff ff       	jmp    801056c6 <alltraps>
...
80106052:	6a 00                	push   $0x0
  pushl $137
80106054:	68 89 00 00 00       	push   $0x89
  jmp alltraps
80106059:	e9 68 f6 ff ff       	jmp    801056c6 <alltraps>
...
8010605e:	6a 00                	push   $0x0
  pushl $138
80106060:	68 8a 00 00 00       	push   $0x8a
  jmp alltraps
80106065:	e9 5c f6 ff ff       	jmp    801056c6 <alltraps>
...
8010606a:	6a 00                	push   $0x0
  pushl $139
8010606c:	68 8b 00 00 00       	push   $0x8b
  jmp alltraps
80106071:	e9 50 f6 ff ff       	jmp    801056c6 <alltraps>
...
80106076:	6a 00                	push   $0x0
  pushl $140
80106078:	68 8c 00 00 00       	push   $0x8c
  jmp alltraps
8010607d:	e9 44 f6 ff ff       	jmp    801056c6 <alltraps>
...
80106082:	6a 00                	push   $0x0
  pushl $141
80106084:	68 8d 00 00 00       	push   $0x8d
  jmp alltraps
80106089:	e9 38 f6 ff ff       	jmp    801056c6 <alltraps>
...
8010608e:	6a 00                	push   $0x0
  pushl $142
80106090:	68 8e 00 00 00       	push   $0x8e
  jmp alltraps
80106095:	e9 2c f6 ff ff       	jmp    801056c6 <alltraps>
...
8010609a:	6a 00                	push   $0x0
  pushl $143
8010609c:	68 8f 00 00 00       	push   $0x8f
  jmp alltraps
801060a1:	e9 20 f6 ff ff       	jmp    801056c6 <alltraps>
...
801060a6:	6a 00                	push   $0x0
  pushl $144
801060a8:	68 90 00 00 00       	push   $0x90
  jmp alltraps
801060ad:	e9 14 f6 ff ff       	jmp    801056c6 <alltraps>
...
801060b2:	6a 00                	push   $0x0
  pushl $145
801060b4:	68 91 00 00 00       	push   $0x91
  jmp alltraps
801060b9:	e9 08 f6 ff ff       	jmp    801056c6 <alltraps>
...
801060be:	6a 00                	push   $0x0
  pushl $146
801060c0:	68 92 00 00 00       	push   $0x92
  jmp alltraps
801060c5:	e9 fc f5 ff ff       	jmp    801056c6 <alltraps>
...
801060ca:	6a 00                	push   $0x0
  pushl $147
801060cc:	68 93 00 00 00       	push   $0x93
  jmp alltraps
801060d1:	e9 f0 f5 ff ff       	jmp    801056c6 <alltraps>
...
801060d6:	6a 00                	push   $0x0
  pushl $148
801060d8:	68 94 00 00 00       	push   $0x94
  jmp alltraps
801060dd:	e9 e4 f5 ff ff       	jmp    801056c6 <alltraps>
...
801060e2:	6a 00                	push   $0x0
  pushl $149
801060e4:	68 95 00 00 00       	push   $0x95
  jmp alltraps
801060e9:	e9 d8 f5 ff ff       	jmp    801056c6 <alltraps>
...
801060ee:	6a 00                	push   $0x0
  pushl $150
801060f0:	68 96 00 00 00       	push   $0x96
  jmp alltraps
801060f5:	e9 cc f5 ff ff       	jmp    801056c6 <alltraps>
...
801060fa:	6a 00                	push   $0x0
  pushl $151
801060fc:	68 97 00 00 00       	push   $0x97
  jmp alltraps
80106101:	e9 c0 f5 ff ff       	jmp    801056c6 <alltraps>
...
80106106:	6a 00                	push   $0x0
  pushl $152
80106108:	68 98 00 00 00       	push   $0x98
  jmp alltraps
8010610d:	e9 b4 f5 ff ff       	jmp    801056c6 <alltraps>
...
80106112:	6a 00                	push   $0x0
  pushl $153
80106114:	68 99 00 00 00       	push   $0x99
  jmp alltraps
80106119:	e9 a8 f5 ff ff       	jmp    801056c6 <alltraps>
...
8010611e:	6a 00                	push   $0x0
  pushl $154
80106120:	68 9a 00 00 00       	push   $0x9a
  jmp alltraps
80106125:	e9 9c f5 ff ff       	jmp    801056c6 <alltraps>
...
8010612a:	6a 00                	push   $0x0
  pushl $155
8010612c:	68 9b 00 00 00       	push   $0x9b
  jmp alltraps
80106131:	e9 90 f5 ff ff       	jmp    801056c6 <alltraps>
...
80106136:	6a 00                	push   $0x0
  pushl $156
80106138:	68 9c 00 00 00       	push   $0x9c
  jmp alltraps
8010613d:	e9 84 f5 ff ff       	jmp    801056c6 <alltraps>
...
80106142:	6a 00                	push   $0x0
  pushl $157
80106144:	68 9d 00 00 00       	push   $0x9d
  jmp alltraps
80106149:	e9 78 f5 ff ff       	jmp    801056c6 <alltraps>
...
8010614e:	6a 00                	push   $0x0
  pushl $158
80106150:	68 9e 00 00 00       	push   $0x9e
  jmp alltraps
80106155:	e9 6c f5 ff ff       	jmp    801056c6 <alltraps>
...
8010615a:	6a 00                	push   $0x0
  pushl $159
8010615c:	68 9f 00 00 00       	push   $0x9f
  jmp alltraps
80106161:	e9 60 f5 ff ff       	jmp    801056c6 <alltraps>
...
80106166:	6a 00                	push   $0x0
  pushl $160
80106168:	68 a0 00 00 00       	push   $0xa0
  jmp alltraps
8010616d:	e9 54 f5 ff ff       	jmp    801056c6 <alltraps>
...
80106172:	6a 00                	push   $0x0
  pushl $161
80106174:	68 a1 00 00 00       	push   $0xa1
  jmp alltraps
80106179:	e9 48 f5 ff ff       	jmp    801056c6 <alltraps>
...
8010617e:	6a 00                	push   $0x0
  pushl $162
80106180:	68 a2 00 00 00       	push   $0xa2
  jmp alltraps
80106185:	e9 3c f5 ff ff       	jmp    801056c6 <alltraps>
...
8010618a:	6a 00                	push   $0x0
  pushl $163
8010618c:	68 a3 00 00 00       	push   $0xa3
  jmp alltraps
80106191:	e9 30 f5 ff ff       	jmp    801056c6 <alltraps>
...
80106196:	6a 00                	push   $0x0
  pushl $164
80106198:	68 a4 00 00 00       	push   $0xa4
  jmp alltraps
8010619d:	e9 24 f5 ff ff       	jmp    801056c6 <alltraps>
...
801061a2:	6a 00                	push   $0x0
  pushl $165
801061a4:	68 a5 00 00 00       	push   $0xa5
  jmp alltraps
801061a9:	e9 18 f5 ff ff       	jmp    801056c6 <alltraps>
...
801061ae:	6a 00                	push   $0x0
  pushl $166
801061b0:	68 a6 00 00 00       	push   $0xa6
  jmp alltraps
801061b5:	e9 0c f5 ff ff       	jmp    801056c6 <alltraps>
...
801061ba:	6a 00                	push   $0x0
  pushl $167
801061bc:	68 a7 00 00 00       	push   $0xa7
  jmp alltraps
801061c1:	e9 00 f5 ff ff       	jmp    801056c6 <alltraps>
...
801061c6:	6a 00                	push   $0x0
  pushl $168
801061c8:	68 a8 00 00 00       	push   $0xa8
  jmp alltraps
801061cd:	e9 f4 f4 ff ff       	jmp    801056c6 <alltraps>
...
801061d2:	6a 00                	push   $0x0
  pushl $169
801061d4:	68 a9 00 00 00       	push   $0xa9
  jmp alltraps
801061d9:	e9 e8 f4 ff ff       	jmp    801056c6 <alltraps>
...
801061de:	6a 00                	push   $0x0
  pushl $170
801061e0:	68 aa 00 00 00       	push   $0xaa
  jmp alltraps
801061e5:	e9 dc f4 ff ff       	jmp    801056c6 <alltraps>
...
801061ea:	6a 00                	push   $0x0
  pushl $171
801061ec:	68 ab 00 00 00       	push   $0xab
  jmp alltraps
801061f1:	e9 d0 f4 ff ff       	jmp    801056c6 <alltraps>
...
801061f6:	6a 00                	push   $0x0
  pushl $172
801061f8:	68 ac 00 00 00       	push   $0xac
  jmp alltraps
801061fd:	e9 c4 f4 ff ff       	jmp    801056c6 <alltraps>
...
80106202:	6a 00                	push   $0x0
  pushl $173
80106204:	68 ad 00 00 00       	push   $0xad
  jmp alltraps
80106209:	e9 b8 f4 ff ff       	jmp    801056c6 <alltraps>
...
8010620e:	6a 00                	push   $0x0
  pushl $174
80106210:	68 ae 00 00 00       	push   $0xae
  jmp alltraps
80106215:	e9 ac f4 ff ff       	jmp    801056c6 <alltraps>
...
8010621a:	6a 00                	push   $0x0
  pushl $175
8010621c:	68 af 00 00 00       	push   $0xaf
  jmp alltraps
80106221:	e9 a0 f4 ff ff       	jmp    801056c6 <alltraps>
...
80106226:	6a 00                	push   $0x0
  pushl $176
80106228:	68 b0 00 00 00       	push   $0xb0
  jmp alltraps
8010622d:	e9 94 f4 ff ff       	jmp    801056c6 <alltraps>
...
80106232:	6a 00                	push   $0x0
  pushl $177
80106234:	68 b1 00 00 00       	push   $0xb1
  jmp alltraps
80106239:	e9 88 f4 ff ff       	jmp    801056c6 <alltraps>
...
8010623e:	6a 00                	push   $0x0
  pushl $178
80106240:	68 b2 00 00 00       	push   $0xb2
  jmp alltraps
80106245:	e9 7c f4 ff ff       	jmp    801056c6 <alltraps>
...
8010624a:	6a 00                	push   $0x0
  pushl $179
8010624c:	68 b3 00 00 00       	push   $0xb3
  jmp alltraps
80106251:	e9 70 f4 ff ff       	jmp    801056c6 <alltraps>
...
80106256:	6a 00                	push   $0x0
  pushl $180
80106258:	68 b4 00 00 00       	push   $0xb4
  jmp alltraps
8010625d:	e9 64 f4 ff ff       	jmp    801056c6 <alltraps>
...
80106262:	6a 00                	push   $0x0
  pushl $181
80106264:	68 b5 00 00 00       	push   $0xb5
  jmp alltraps
80106269:	e9 58 f4 ff ff       	jmp    801056c6 <alltraps>
...
8010626e:	6a 00                	push   $0x0
  pushl $182
80106270:	68 b6 00 00 00       	push   $0xb6
  jmp alltraps
80106275:	e9 4c f4 ff ff       	jmp    801056c6 <alltraps>
...
8010627a:	6a 00                	push   $0x0
  pushl $183
8010627c:	68 b7 00 00 00       	push   $0xb7
  jmp alltraps
80106281:	e9 40 f4 ff ff       	jmp    801056c6 <alltraps>
...
80106286:	6a 00                	push   $0x0
  pushl $184
80106288:	68 b8 00 00 00       	push   $0xb8
  jmp alltraps
8010628d:	e9 34 f4 ff ff       	jmp    801056c6 <alltraps>
...
80106292:	6a 00                	push   $0x0
  pushl $185
80106294:	68 b9 00 00 00       	push   $0xb9
  jmp alltraps
80106299:	e9 28 f4 ff ff       	jmp    801056c6 <alltraps>
...
8010629e:	6a 00                	push   $0x0
  pushl $186
801062a0:	68 ba 00 00 00       	push   $0xba
  jmp alltraps
801062a5:	e9 1c f4 ff ff       	jmp    801056c6 <alltraps>
...
801062aa:	6a 00                	push   $0x0
  pushl $187
801062ac:	68 bb 00 00 00       	push   $0xbb
  jmp alltraps
801062b1:	e9 10 f4 ff ff       	jmp    801056c6 <alltraps>
...
801062b6:	6a 00                	push   $0x0
  pushl $188
801062b8:	68 bc 00 00 00       	push   $0xbc
  jmp alltraps
801062bd:	e9 04 f4 ff ff       	jmp    801056c6 <alltraps>
...
801062c2:	6a 00                	push   $0x0
  pushl $189
801062c4:	68 bd 00 00 00       	push   $0xbd
  jmp alltraps
801062c9:	e9 f8 f3 ff ff       	jmp    801056c6 <alltraps>
...
801062ce:	6a 00                	push   $0x0
  pushl $190
801062d0:	68 be 00 00 00       	push   $0xbe
  jmp alltraps
801062d5:	e9 ec f3 ff ff       	jmp    801056c6 <alltraps>
...
801062da:	6a 00                	push   $0x0
  pushl $191
801062dc:	68 bf 00 00 00       	push   $0xbf
  jmp alltraps
801062e1:	e9 e0 f3 ff ff       	jmp    801056c6 <alltraps>
...
801062e6:	6a 00                	push   $0x0
  pushl $192
801062e8:	68 c0 00 00 00       	push   $0xc0
  jmp alltraps
801062ed:	e9 d4 f3 ff ff       	jmp    801056c6 <alltraps>
...
801062f2:	6a 00                	push   $0x0
  pushl $193
801062f4:	68 c1 00 00 00       	push   $0xc1
  jmp alltraps
801062f9:	e9 c8 f3 ff ff       	jmp    801056c6 <alltraps>
...
801062fe:	6a 00                	push   $0x0
  pushl $194
80106300:	68 c2 00 00 00       	push   $0xc2
  jmp alltraps
80106305:	e9 bc f3 ff ff       	jmp    801056c6 <alltraps>
...
8010630a:	6a 00                	push   $0x0
  pushl $195
8010630c:	68 c3 00 00 00       	push   $0xc3
  jmp alltraps
80106311:	e9 b0 f3 ff ff       	jmp    801056c6 <alltraps>
...
80106316:	6a 00                	push   $0x0
  pushl $196
80106318:	68 c4 00 00 00       	push   $0xc4
  jmp alltraps
8010631d:	e9 a4 f3 ff ff       	jmp    801056c6 <alltraps>
...
80106322:	6a 00                	push   $0x0
  pushl $197
80106324:	68 c5 00 00 00       	push   $0xc5
  jmp alltraps
80106329:	e9 98 f3 ff ff       	jmp    801056c6 <alltraps>
...
8010632e:	6a 00                	push   $0x0
  pushl $198
80106330:	68 c6 00 00 00       	push   $0xc6
  jmp alltraps
80106335:	e9 8c f3 ff ff       	jmp    801056c6 <alltraps>
...
8010633a:	6a 00                	push   $0x0
  pushl $199
8010633c:	68 c7 00 00 00       	push   $0xc7
  jmp alltraps
80106341:	e9 80 f3 ff ff       	jmp    801056c6 <alltraps>
...
80106346:	6a 00                	push   $0x0
  pushl $200
80106348:	68 c8 00 00 00       	push   $0xc8
  jmp alltraps
8010634d:	e9 74 f3 ff ff       	jmp    801056c6 <alltraps>
...
80106352:	6a 00                	push   $0x0
  pushl $201
80106354:	68 c9 00 00 00       	push   $0xc9
  jmp alltraps
80106359:	e9 68 f3 ff ff       	jmp    801056c6 <alltraps>
...
8010635e:	6a 00                	push   $0x0
  pushl $202
80106360:	68 ca 00 00 00       	push   $0xca
  jmp alltraps
80106365:	e9 5c f3 ff ff       	jmp    801056c6 <alltraps>
...
8010636a:	6a 00                	push   $0x0
  pushl $203
8010636c:	68 cb 00 00 00       	push   $0xcb
  jmp alltraps
80106371:	e9 50 f3 ff ff       	jmp    801056c6 <alltraps>
...
80106376:	6a 00                	push   $0x0
  pushl $204
80106378:	68 cc 00 00 00       	push   $0xcc
  jmp alltraps
8010637d:	e9 44 f3 ff ff       	jmp    801056c6 <alltraps>
...
80106382:	6a 00                	push   $0x0
  pushl $205
80106384:	68 cd 00 00 00       	push   $0xcd
  jmp alltraps
80106389:	e9 38 f3 ff ff       	jmp    801056c6 <alltraps>
...
8010638e:	6a 00                	push   $0x0
  pushl $206
80106390:	68 ce 00 00 00       	push   $0xce
  jmp alltraps
80106395:	e9 2c f3 ff ff       	jmp    801056c6 <alltraps>
...
8010639a:	6a 00                	push   $0x0
  pushl $207
8010639c:	68 cf 00 00 00       	push   $0xcf
  jmp alltraps
801063a1:	e9 20 f3 ff ff       	jmp    801056c6 <alltraps>
...
801063a6:	6a 00                	push   $0x0
  pushl $208
801063a8:	68 d0 00 00 00       	push   $0xd0
  jmp alltraps
801063ad:	e9 14 f3 ff ff       	jmp    801056c6 <alltraps>
...
801063b2:	6a 00                	push   $0x0
  pushl $209
801063b4:	68 d1 00 00 00       	push   $0xd1
  jmp alltraps
801063b9:	e9 08 f3 ff ff       	jmp    801056c6 <alltraps>
...
801063be:	6a 00                	push   $0x0
  pushl $210
801063c0:	68 d2 00 00 00       	push   $0xd2
  jmp alltraps
801063c5:	e9 fc f2 ff ff       	jmp    801056c6 <alltraps>
...
801063ca:	6a 00                	push   $0x0
  pushl $211
801063cc:	68 d3 00 00 00       	push   $0xd3
  jmp alltraps
801063d1:	e9 f0 f2 ff ff       	jmp    801056c6 <alltraps>
...
801063d6:	6a 00                	push   $0x0
  pushl $212
801063d8:	68 d4 00 00 00       	push   $0xd4
  jmp alltraps
801063dd:	e9 e4 f2 ff ff       	jmp    801056c6 <alltraps>
...
801063e2:	6a 00                	push   $0x0
  pushl $213
801063e4:	68 d5 00 00 00       	push   $0xd5
  jmp alltraps
801063e9:	e9 d8 f2 ff ff       	jmp    801056c6 <alltraps>
...
801063ee:	6a 00                	push   $0x0
  pushl $214
801063f0:	68 d6 00 00 00       	push   $0xd6
  jmp alltraps
801063f5:	e9 cc f2 ff ff       	jmp    801056c6 <alltraps>
...
801063fa:	6a 00                	push   $0x0
  pushl $215
801063fc:	68 d7 00 00 00       	push   $0xd7
  jmp alltraps
80106401:	e9 c0 f2 ff ff       	jmp    801056c6 <alltraps>
...
80106406:	6a 00                	push   $0x0
  pushl $216
80106408:	68 d8 00 00 00       	push   $0xd8
  jmp alltraps
8010640d:	e9 b4 f2 ff ff       	jmp    801056c6 <alltraps>
...
80106412:	6a 00                	push   $0x0
  pushl $217
80106414:	68 d9 00 00 00       	push   $0xd9
  jmp alltraps
80106419:	e9 a8 f2 ff ff       	jmp    801056c6 <alltraps>
...
8010641e:	6a 00                	push   $0x0
  pushl $218
80106420:	68 da 00 00 00       	push   $0xda
  jmp alltraps
80106425:	e9 9c f2 ff ff       	jmp    801056c6 <alltraps>
...
8010642a:	6a 00                	push   $0x0
  pushl $219
8010642c:	68 db 00 00 00       	push   $0xdb
  jmp alltraps
80106431:	e9 90 f2 ff ff       	jmp    801056c6 <alltraps>
...
80106436:	6a 00                	push   $0x0
  pushl $220
80106438:	68 dc 00 00 00       	push   $0xdc
  jmp alltraps
8010643d:	e9 84 f2 ff ff       	jmp    801056c6 <alltraps>
...
80106442:	6a 00                	push   $0x0
  pushl $221
80106444:	68 dd 00 00 00       	push   $0xdd
  jmp alltraps
80106449:	e9 78 f2 ff ff       	jmp    801056c6 <alltraps>
...
8010644e:	6a 00                	push   $0x0
  pushl $222
80106450:	68 de 00 00 00       	push   $0xde
  jmp alltraps
80106455:	e9 6c f2 ff ff       	jmp    801056c6 <alltraps>
...
8010645a:	6a 00                	push   $0x0
  pushl $223
8010645c:	68 df 00 00 00       	push   $0xdf
  jmp alltraps
80106461:	e9 60 f2 ff ff       	jmp    801056c6 <alltraps>
...
80106466:	6a 00                	push   $0x0
  pushl $224
80106468:	68 e0 00 00 00       	push   $0xe0
  jmp alltraps
8010646d:	e9 54 f2 ff ff       	jmp    801056c6 <alltraps>
...
80106472:	6a 00                	push   $0x0
  pushl $225
80106474:	68 e1 00 00 00       	push   $0xe1
  jmp alltraps
80106479:	e9 48 f2 ff ff       	jmp    801056c6 <alltraps>
...
8010647e:	6a 00                	push   $0x0
  pushl $226
80106480:	68 e2 00 00 00       	push   $0xe2
  jmp alltraps
80106485:	e9 3c f2 ff ff       	jmp    801056c6 <alltraps>
...
8010648a:	6a 00                	push   $0x0
  pushl $227
8010648c:	68 e3 00 00 00       	push   $0xe3
  jmp alltraps
80106491:	e9 30 f2 ff ff       	jmp    801056c6 <alltraps>
...
80106496:	6a 00                	push   $0x0
  pushl $228
80106498:	68 e4 00 00 00       	push   $0xe4
  jmp alltraps
8010649d:	e9 24 f2 ff ff       	jmp    801056c6 <alltraps>
...
801064a2:	6a 00                	push   $0x0
  pushl $229
801064a4:	68 e5 00 00 00       	push   $0xe5
  jmp alltraps
801064a9:	e9 18 f2 ff ff       	jmp    801056c6 <alltraps>
...
801064ae:	6a 00                	push   $0x0
  pushl $230
801064b0:	68 e6 00 00 00       	push   $0xe6
  jmp alltraps
801064b5:	e9 0c f2 ff ff       	jmp    801056c6 <alltraps>
...
801064ba:	6a 00                	push   $0x0
  pushl $231
801064bc:	68 e7 00 00 00       	push   $0xe7
  jmp alltraps
801064c1:	e9 00 f2 ff ff       	jmp    801056c6 <alltraps>
...
801064c6:	6a 00                	push   $0x0
  pushl $232
801064c8:	68 e8 00 00 00       	push   $0xe8
  jmp alltraps
801064cd:	e9 f4 f1 ff ff       	jmp    801056c6 <alltraps>
...
801064d2:	6a 00                	push   $0x0
  pushl $233
801064d4:	68 e9 00 00 00       	push   $0xe9
  jmp alltraps
801064d9:	e9 e8 f1 ff ff       	jmp    801056c6 <alltraps>
...
801064de:	6a 00                	push   $0x0
  pushl $234
801064e0:	68 ea 00 00 00       	push   $0xea
  jmp alltraps
801064e5:	e9 dc f1 ff ff       	jmp    801056c6 <alltraps>
...
801064ea:	6a 00                	push   $0x0
  pushl $235
801064ec:	68 eb 00 00 00       	push   $0xeb
  jmp alltraps
801064f1:	e9 d0 f1 ff ff       	jmp    801056c6 <alltraps>
...
801064f6:	6a 00                	push   $0x0
  pushl $236
801064f8:	68 ec 00 00 00       	push   $0xec
  jmp alltraps
801064fd:	e9 c4 f1 ff ff       	jmp    801056c6 <alltraps>
...
80106502:	6a 00                	push   $0x0
  pushl $237
80106504:	68 ed 00 00 00       	push   $0xed
  jmp alltraps
80106509:	e9 b8 f1 ff ff       	jmp    801056c6 <alltraps>
...
8010650e:	6a 00                	push   $0x0
  pushl $238
80106510:	68 ee 00 00 00       	push   $0xee
  jmp alltraps
80106515:	e9 ac f1 ff ff       	jmp    801056c6 <alltraps>
...
8010651a:	6a 00                	push   $0x0
  pushl $239
8010651c:	68 ef 00 00 00       	push   $0xef
  jmp alltraps
80106521:	e9 a0 f1 ff ff       	jmp    801056c6 <alltraps>
...
80106526:	6a 00                	push   $0x0
  pushl $240
80106528:	68 f0 00 00 00       	push   $0xf0
  jmp alltraps
8010652d:	e9 94 f1 ff ff       	jmp    801056c6 <alltraps>
...
80106532:	6a 00                	push   $0x0
  pushl $241
80106534:	68 f1 00 00 00       	push   $0xf1
  jmp alltraps
80106539:	e9 88 f1 ff ff       	jmp    801056c6 <alltraps>
...
8010653e:	6a 00                	push   $0x0
  pushl $242
80106540:	68 f2 00 00 00       	push   $0xf2
  jmp alltraps
80106545:	e9 7c f1 ff ff       	jmp    801056c6 <alltraps>
...
8010654a:	6a 00                	push   $0x0
  pushl $243
8010654c:	68 f3 00 00 00       	push   $0xf3
  jmp alltraps
80106551:	e9 70 f1 ff ff       	jmp    801056c6 <alltraps>
...
80106556:	6a 00                	push   $0x0
  pushl $244
80106558:	68 f4 00 00 00       	push   $0xf4
  jmp alltraps
8010655d:	e9 64 f1 ff ff       	jmp    801056c6 <alltraps>
...
80106562:	6a 00                	push   $0x0
  pushl $245
80106564:	68 f5 00 00 00       	push   $0xf5
  jmp alltraps
80106569:	e9 58 f1 ff ff       	jmp    801056c6 <alltraps>
...
8010656e:	6a 00                	push   $0x0
  pushl $246
80106570:	68 f6 00 00 00       	push   $0xf6
  jmp alltraps
80106575:	e9 4c f1 ff ff       	jmp    801056c6 <alltraps>
...
8010657a:	6a 00                	push   $0x0
  pushl $247
8010657c:	68 f7 00 00 00       	push   $0xf7
  jmp alltraps
80106581:	e9 40 f1 ff ff       	jmp    801056c6 <alltraps>
...
80106586:	6a 00                	push   $0x0
  pushl $248
80106588:	68 f8 00 00 00       	push   $0xf8
  jmp alltraps
8010658d:	e9 34 f1 ff ff       	jmp    801056c6 <alltraps>
...
80106592:	6a 00                	push   $0x0
  pushl $249
80106594:	68 f9 00 00 00       	push   $0xf9
  jmp alltraps
80106599:	e9 28 f1 ff ff       	jmp    801056c6 <alltraps>
...
8010659e:	6a 00                	push   $0x0
  pushl $250
801065a0:	68 fa 00 00 00       	push   $0xfa
  jmp alltraps
801065a5:	e9 1c f1 ff ff       	jmp    801056c6 <alltraps>
...
801065aa:	6a 00                	push   $0x0
  pushl $251
801065ac:	68 fb 00 00 00       	push   $0xfb
  jmp alltraps
801065b1:	e9 10 f1 ff ff       	jmp    801056c6 <alltraps>
...
801065b6:	6a 00                	push   $0x0
  pushl $252
801065b8:	68 fc 00 00 00       	push   $0xfc
  jmp alltraps
801065bd:	e9 04 f1 ff ff       	jmp    801056c6 <alltraps>
...
801065c2:	6a 00                	push   $0x0
  pushl $253
801065c4:	68 fd 00 00 00       	push   $0xfd
  jmp alltraps
801065c9:	e9 f8 f0 ff ff       	jmp    801056c6 <alltraps>
...
801065ce:	6a 00                	push   $0x0
  pushl $254
801065d0:	68 fe 00 00 00       	push   $0xfe
  jmp alltraps
801065d5:	e9 ec f0 ff ff       	jmp    801056c6 <alltraps>
...
801065da:	6a 00                	push   $0x0
  pushl $255
801065dc:	68 ff 00 00 00       	push   $0xff
  jmp alltraps
801065e1:	e9 e0 f0 ff ff       	jmp    801056c6 <alltraps>
...
8010660e:	81 c3 00 00 00 80    	add    $0x80000000,%ebx
  ...
  return &pgtab[PTX(va)];
80106614:	c1 ee 0a             	shr    $0xa,%esi
}
80106617:	83 c4 1c             	add    $0x1c,%esp
  return &pgtab[PTX(va)];
8010661a:	89 f2                	mov    %esi,%edx
...
80106632:	74 34                	je     80106668 <walkpgdir+0x78>
80106634:	e8 67 be ff ff       	call   801024a0 <kalloc>
80106639:	85 c0                	test   %eax,%eax
8010663b:	89 c3                	mov    %eax,%ebx
8010663d:	74 29                	je     80106668 <walkpgdir+0x78>
    memset(pgtab, 0, PGSIZE);
8010663f:	c7 44 24 08 00 10 00 	movl   $0x1000,0x8(%esp)
80106646:	00 
80106647:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
8010664e:	00 
8010664f:	89 04 24             	mov    %eax,(%esp)
80106652:	e8 39 de ff ff       	call   80104490 <memset>
    *pde = V2P(pgtab) | PTE_P | PTE_W | PTE_U;
80106657:	8d 83 00 00 00 80    	lea    -0x80000000(%ebx),%eax
8010665d:	83 c8 07             	or     $0x7,%eax
80106660:	89 07                	mov    %eax,(%edi)
80106662:	eb b0                	jmp    80106614 <walkpgdir+0x24>
...
8010668b:	8b 7d 08             	mov    0x8(%ebp),%edi
  a = (char*)PGROUNDDOWN((uint)va);
8010668e:	81 e3 00 f0 ff ff    	and    $0xfffff000,%ebx
{
80106694:	89 45 e0             	mov    %eax,-0x20(%ebp)
  last = (char*)PGROUNDDOWN(((uint)va) + size - 1);
80106697:	8d 44 0a ff          	lea    -0x1(%edx,%ecx,1),%eax
8010669b:	89 45 e4             	mov    %eax,-0x1c(%ebp)
  for(;;){
    ...
    if(*pte & PTE_P)
      panic("remap");
    *pte = pa | perm | PTE_P;
8010669e:	83 4d 0c 01          	orl    $0x1,0xc(%ebp)
  last = (char*)PGROUNDDOWN(((uint)va) + size - 1);
801066a2:	81 65 e4 00 f0 ff ff 	andl   $0xfffff000,-0x1c(%ebp)
801066a9:	29 df                	sub    %ebx,%edi
801066ab:	eb 18                	jmp    801066c5 <mappages+0x45>
801066ad:	8d 76 00             	lea    0x0(%esi),%esi
    if(*pte & PTE_P)
801066b0:	f6 00 01             	testb  $0x1,(%eax)
801066b3:	75 3d                	jne    801066f2 <mappages+0x72>
    *pte = pa | perm | PTE_P;
801066b5:	0b 75 0c             	or     0xc(%ebp),%esi
    if(a == last)
801066b8:	3b 5d e4             	cmp    -0x1c(%ebp),%ebx
    *pte = pa | perm | PTE_P;
801066bb:	89 30                	mov    %esi,(%eax)
    if(a == last)
801066bd:	74 29                	je     801066e8 <mappages+0x68>
      break;
    a += PGSIZE;
801066bf:	81 c3 00 10 00 00    	add    $0x1000,%ebx
    if((pte = walkpgdir(pgdir, a, 1)) == 0)
801066c5:	8b 45 e0             	mov    -0x20(%ebp),%eax
801066c8:	b9 01 00 00 00       	mov    $0x1,%ecx
801066cd:	89 da                	mov    %ebx,%edx
801066cf:	8d 34 3b             	lea    (%ebx,%edi,1),%esi
801066d2:	e8 19 ff ff ff       	call   801065f0 <walkpgdir>
...
801066f1:	c3                   	ret    
      panic("remap");
801066f2:	c7 04 24 f4 77 10 80 	movl   $0x801077f4,(%esp)
...
80106709:	53                   	push   %ebx
  ...
  a = PGROUNDUP(newsz);
8010670a:	8d 99 ff 0f 00 00    	lea    0xfff(%ecx),%ebx
deallocuvm(pde_t *pgdir, uint oldsz, uint newsz)
80106710:	83 ec 1c             	sub    $0x1c,%esp
  a = PGROUNDUP(newsz);
80106713:	81 e3 00 f0 ff ff    	and    $0xfffff000,%ebx
  for(; a  < oldsz; a += PGSIZE){
80106719:	39 d3                	cmp    %edx,%ebx
deallocuvm(pde_t *pgdir, uint oldsz, uint newsz)
8010671b:	89 4d e0             	mov    %ecx,-0x20(%ebp)
  for(; a  < oldsz; a += PGSIZE){
8010671e:	72 3b                	jb     8010675b <deallocuvm.part.0+0x5b>
80106720:	eb 5e                	jmp    80106780 <deallocuvm.part.0+0x80>
...
8010672d:	74 22                	je     80106751 <deallocuvm.part.0+0x51>
      pa = PTE_ADDR(*pte);
      if(pa == 0)
8010672f:	81 e2 00 f0 ff ff    	and    $0xfffff000,%edx
80106735:	74 54                	je     8010678b <deallocuvm.part.0+0x8b>
        panic("kfree");
      char *v = P2V(pa);
80106737:	81 c2 00 00 00 80    	add    $0x80000000,%edx
      kfree(v);
8010673d:	89 14 24             	mov    %edx,(%esp)
80106740:	89 45 e4             	mov    %eax,-0x1c(%ebp)
80106743:	e8 a8 bb ff ff       	call   801022f0 <kfree>
      *pte = 0;
80106748:	8b 45 e4             	mov    -0x1c(%ebp),%eax
8010674b:	c7 00 00 00 00 00    	movl   $0x0,(%eax)
  for(; a  < oldsz; a += PGSIZE){
80106751:	81 c3 00 10 00 00    	add    $0x1000,%ebx
80106757:	39 f3                	cmp    %esi,%ebx
80106759:	73 25                	jae    80106780 <deallocuvm.part.0+0x80>
    pte = walkpgdir(pgdir, (char*)a, 0);
8010675b:	31 c9                	xor    %ecx,%ecx
8010675d:	89 da                	mov    %ebx,%edx
8010675f:	89 f8                	mov    %edi,%eax
80106761:	e8 8a fe ff ff       	call   801065f0 <walkpgdir>
    if(!pte)
80106766:	85 c0                	test   %eax,%eax
80106768:	75 be                	jne    80106728 <deallocuvm.part.0+0x28>
      a = PGADDR(PDX(a) + 1, 0, 0) - PGSIZE;
8010676a:	81 e3 00 00 c0 ff    	and    $0xffc00000,%ebx
80106770:	81 c3 00 f0 3f 00    	add    $0x3ff000,%ebx
  for(; a  < oldsz; a += PGSIZE){
80106776:	81 c3 00 10 00 00    	add    $0x1000,%ebx
8010677c:	39 f3                	cmp    %esi,%ebx
8010677e:	72 db                	jb     8010675b <deallocuvm.part.0+0x5b>
    }
  }
  return newsz;
}
80106780:	8b 45 e0             	mov    -0x20(%ebp),%eax
80106783:	83 c4 1c             	add    $0x1c,%esp
80106786:	5b                   	pop    %ebx
80106787:	5e                   	pop    %esi
80106788:	5f                   	pop    %edi
80106789:	5d                   	pop    %ebp
8010678a:	c3                   	ret    
        panic("kfree");
8010678b:	c7 04 24 66 71 10 80 	movl   $0x80107166,(%esp)
80106792:	e8 c9 9b ff ff       	call   80100360 <panic>
...
801067a3:	83 ec 18             	sub    $0x18,%esp
  c = &cpus[cpuid()];
801067a6:	e8 e5 ce ff ff       	call   80103690 <cpuid>
  c->gdt[SEG_KCODE] = SEG(STA_X|STA_R, 0, 0xffffffff, 0);
801067ab:	31 c9                	xor    %ecx,%ecx
801067ad:	ba ff ff ff ff       	mov    $0xffffffff,%edx
  c = &cpus[cpuid()];
801067b2:	69 c0 b0 00 00 00    	imul   $0xb0,%eax,%eax
801067b8:	05 80 27 11 80       	add    $0x80112780,%eax
  c->gdt[SEG_KCODE] = SEG(STA_X|STA_R, 0, 0xffffffff, 0);
801067bd:	66 89 50 78          	mov    %dx,0x78(%eax)
  c->gdt[SEG_KDATA] = SEG(STA_W, 0, 0xffffffff, 0);
801067c1:	ba ff ff ff ff       	mov    $0xffffffff,%edx
  lgdt(c->gdt, sizeof(c->gdt));
801067c6:	83 c0 70             	add    $0x70,%eax
  c->gdt[SEG_KCODE] = SEG(STA_X|STA_R, 0, 0xffffffff, 0);
801067c9:	66 89 48 0a          	mov    %cx,0xa(%eax)
  c->gdt[SEG_KDATA] = SEG(STA_W, 0, 0xffffffff, 0);
801067cd:	31 c9                	xor    %ecx,%ecx
801067cf:	66 89 50 10          	mov    %dx,0x10(%eax)
  c->gdt[SEG_UCODE] = SEG(STA_X|STA_R, 0, 0xffffffff, DPL_USER);
801067d3:	ba ff ff ff ff       	mov    $0xffffffff,%edx
  c->gdt[SEG_KDATA] = SEG(STA_W, 0, 0xffffffff, 0);
801067d8:	66 89 48 12          	mov    %cx,0x12(%eax)
  c->gdt[SEG_UCODE] = SEG(STA_X|STA_R, 0, 0xffffffff, DPL_USER);
801067dc:	31 c9                	xor    %ecx,%ecx
801067de:	66 89 50 18          	mov    %dx,0x18(%eax)
  c->gdt[SEG_UDATA] = SEG(STA_W, 0, 0xffffffff, DPL_USER);
801067e2:	ba ff ff ff ff       	mov    $0xffffffff,%edx
  c->gdt[SEG_UCODE] = SEG(STA_X|STA_R, 0, 0xffffffff, DPL_USER);
801067e7:	66 89 48 1a          	mov    %cx,0x1a(%eax)
  c->gdt[SEG_UDATA] = SEG(STA_W, 0, 0xffffffff, DPL_USER);
801067eb:	31 c9                	xor    %ecx,%ecx
  c->gdt[SEG_KCODE] = SEG(STA_X|STA_R, 0, 0xffffffff, 0);
801067ed:	c6 40 0d 9a          	movb   $0x9a,0xd(%eax)
801067f1:	c6 40 0e cf          	movb   $0xcf,0xe(%eax)
  c->gdt[SEG_KDATA] = SEG(STA_W, 0, 0xffffffff, 0);
801067f5:	c6 40 15 92          	movb   $0x92,0x15(%eax)
801067f9:	c6 40 16 cf          	movb   $0xcf,0x16(%eax)
  c->gdt[SEG_UCODE] = SEG(STA_X|STA_R, 0, 0xffffffff, DPL_USER);
801067fd:	c6 40 1d fa          	movb   $0xfa,0x1d(%eax)
80106801:	c6 40 1e cf          	movb   $0xcf,0x1e(%eax)
  c->gdt[SEG_UDATA] = SEG(STA_W, 0, 0xffffffff, DPL_USER);
80106805:	c6 40 25 f2          	movb   $0xf2,0x25(%eax)
80106809:	c6 40 26 cf          	movb   $0xcf,0x26(%eax)
8010680d:	66 89 50 20          	mov    %dx,0x20(%eax)
  pd[0] = size-1;
80106811:	ba 2f 00 00 00       	mov    $0x2f,%edx
  c->gdt[SEG_KCODE] = SEG(STA_X|STA_R, 0, 0xffffffff, 0);
80106816:	c6 40 0c 00          	movb   $0x0,0xc(%eax)
8010681a:	c6 40 0f 00          	movb   $0x0,0xf(%eax)
  c->gdt[SEG_KDATA] = SEG(STA_W, 0, 0xffffffff, 0);
8010681e:	c6 40 14 00          	movb   $0x0,0x14(%eax)
80106822:	c6 40 17 00          	movb   $0x0,0x17(%eax)
  c->gdt[SEG_UCODE] = SEG(STA_X|STA_R, 0, 0xffffffff, DPL_USER);
80106826:	c6 40 1c 00          	movb   $0x0,0x1c(%eax)
8010682a:	c6 40 1f 00          	movb   $0x0,0x1f(%eax)
  c->gdt[SEG_UDATA] = SEG(STA_W, 0, 0xffffffff, DPL_USER);
8010682e:	66 89 48 22          	mov    %cx,0x22(%eax)
80106832:	c6 40 24 00          	movb   $0x0,0x24(%eax)
80106836:	c6 40 27 00          	movb   $0x0,0x27(%eax)
8010683a:	66 89 55 f2          	mov    %dx,-0xe(%ebp)
  pd[1] = (uint)p;
8010683e:	66 89 45 f4          	mov    %ax,-0xc(%ebp)
  pd[2] = (uint)p >> 16;
80106842:	c1 e8 10             	shr    $0x10,%eax
80106845:	66 89 45 f6          	mov    %ax,-0xa(%ebp)
  asm volatile("lgdt (%0)" : : "r" (pd));
80106849:	8d 45 f2             	lea    -0xe(%ebp),%eax
8010684c:	0f 01 10             	lgdtl  (%eax)
}
8010684f:	c9                   	leave  
80106850:	c3                   	ret    
80106851:	eb 0d                	jmp    80106860 <switchkvm>
80106853:	90                   	nop
80106854:	90                   	nop
80106855:	90                   	nop
80106856:	90                   	nop
...
80106860:	a1 a4 57 11 80       	mov    0x801157a4,%eax
{
...
8010688e:	0f 84 cd 00 00 00    	je     80106961 <switchuvm+0xe1>
  if(p->kstack == 0)
80106894:	8b 46 10             	mov    0x10(%esi),%eax
80106897:	85 c0                	test   %eax,%eax
80106899:	0f 84 da 00 00 00    	je     80106979 <switchuvm+0xf9>
  if(p->pgdir == 0)
8010689f:	8b 7e 0c             	mov    0xc(%esi),%edi
801068a2:	85 ff                	test   %edi,%edi
801068a4:	0f 84 c3 00 00 00    	je     8010696d <switchuvm+0xed>
  pushcli();
801068aa:	e8 31 da ff ff       	call   801042e0 <pushcli>
  mycpu()->gdt[SEG_TSS] = SEG16(STS_T32A, &mycpu()->ts,
801068af:	e8 5c cd ff ff       	call   80103610 <mycpu>
801068b4:	89 c3                	mov    %eax,%ebx
801068b6:	e8 55 cd ff ff       	call   80103610 <mycpu>
801068bb:	89 c7                	mov    %eax,%edi
801068bd:	e8 4e cd ff ff       	call   80103610 <mycpu>
801068c2:	83 c7 08             	add    $0x8,%edi
801068c5:	89 45 e4             	mov    %eax,-0x1c(%ebp)
801068c8:	e8 43 cd ff ff       	call   80103610 <mycpu>
801068cd:	8b 4d e4             	mov    -0x1c(%ebp),%ecx
801068d0:	ba 67 00 00 00       	mov    $0x67,%edx
801068d5:	66 89 93 98 00 00 00 	mov    %dx,0x98(%ebx)
801068dc:	66 89 bb 9a 00 00 00 	mov    %di,0x9a(%ebx)
801068e3:	c6 83 9d 00 00 00 99 	movb   $0x99,0x9d(%ebx)
801068ea:	83 c1 08             	add    $0x8,%ecx
801068ed:	c1 e9 10             	shr    $0x10,%ecx
801068f0:	83 c0 08             	add    $0x8,%eax
801068f3:	c1 e8 18             	shr    $0x18,%eax
801068f6:	88 8b 9c 00 00 00    	mov    %cl,0x9c(%ebx)
801068fc:	c6 83 9e 00 00 00 40 	movb   $0x40,0x9e(%ebx)
80106903:	88 83 9f 00 00 00    	mov    %al,0x9f(%ebx)
  mycpu()->ts.iomb = (ushort) 0xFFFF;
80106909:	bb ff ff ff ff       	mov    $0xffffffff,%ebx
  mycpu()->gdt[SEG_TSS].s = 0;
8010690e:	e8 fd cc ff ff       	call   80103610 <mycpu>
80106913:	80 a0 9d 00 00 00 ef 	andb   $0xef,0x9d(%eax)
  mycpu()->ts.ss0 = SEG_KDATA << 3;
8010691a:	e8 f1 cc ff ff       	call   80103610 <mycpu>
8010691f:	b9 10 00 00 00       	mov    $0x10,%ecx
80106924:	66 89 48 10          	mov    %cx,0x10(%eax)
  mycpu()->ts.esp0 = (uint)p->kstack + KSTACKSIZE;
80106928:	e8 e3 cc ff ff       	call   80103610 <mycpu>
8010692d:	8b 56 10             	mov    0x10(%esi),%edx
80106930:	8d 8a 00 10 00 00    	lea    0x1000(%edx),%ecx
80106936:	89 48 0c             	mov    %ecx,0xc(%eax)
  mycpu()->ts.iomb = (ushort) 0xFFFF;
80106939:	e8 d2 cc ff ff       	call   80103610 <mycpu>
8010693e:	66 89 58 6e          	mov    %bx,0x6e(%eax)
  asm volatile("ltr %0" : : "r" (sel));
80106942:	b8 28 00 00 00       	mov    $0x28,%eax
80106947:	0f 00 d8             	ltr    %ax
  lcr3(V2P(p->pgdir));  // switch to process's address space
8010694a:	8b 46 0c             	mov    0xc(%esi),%eax
...
8010695b:	5d                   	pop    %ebp
  popcli();
8010695c:	e9 bf d9 ff ff       	jmp    80104320 <popcli>
    panic("switchuvm: no process");
80106961:	c7 04 24 fa 77 10 80 	movl   $0x801077fa,(%esp)
80106968:	e8 f3 99 ff ff       	call   80100360 <panic>
    panic("switchuvm: no pgdir");
8010696d:	c7 04 24 25 78 10 80 	movl   $0x80107825,(%esp)
80106974:	e8 e7 99 ff ff       	call   80100360 <panic>
    panic("switchuvm: no kstack");
80106979:	c7 04 24 10 78 10 80 	movl   $0x80107810,(%esp)
80106980:	e8 db 99 ff ff       	call   80100360 <panic>
80106985:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
...
801069a8:	89 45 e4             	mov    %eax,-0x1c(%ebp)
  if(sz >= PGSIZE)
801069ab:	77 54                	ja     80106a01 <inituvm+0x71>
  mem = kalloc();
801069ad:	e8 ee ba ff ff       	call   801024a0 <kalloc>
  memset(mem, 0, PGSIZE);
801069b2:	c7 44 24 08 00 10 00 	movl   $0x1000,0x8(%esp)
801069b9:	00 
801069ba:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
801069c1:	00 
  mem = kalloc();
801069c2:	89 c3                	mov    %eax,%ebx
  memset(mem, 0, PGSIZE);
801069c4:	89 04 24             	mov    %eax,(%esp)
801069c7:	e8 c4 da ff ff       	call   80104490 <memset>
  mappages(pgdir, 0, PGSIZE, V2P(mem), PTE_W|PTE_U);
801069cc:	8d 83 00 00 00 80    	lea    -0x80000000(%ebx),%eax
801069d2:	b9 00 10 00 00       	mov    $0x1000,%ecx
801069d7:	89 04 24             	mov    %eax,(%esp)
801069da:	8b 45 e4             	mov    -0x1c(%ebp),%eax
801069dd:	31 d2                	xor    %edx,%edx
801069df:	c7 44 24 04 06 00 00 	movl   $0x6,0x4(%esp)
801069e6:	00 
801069e7:	e8 94 fc ff ff       	call   80106680 <mappages>
  memmove(mem, init, sz);
801069ec:	89 75 10             	mov    %esi,0x10(%ebp)
801069ef:	89 7d 0c             	mov    %edi,0xc(%ebp)
801069f2:	89 5d 08             	mov    %ebx,0x8(%ebp)
}
801069f5:	83 c4 1c             	add    $0x1c,%esp
801069f8:	5b                   	pop    %ebx
801069f9:	5e                   	pop    %esi
801069fa:	5f                   	pop    %edi
801069fb:	5d                   	pop    %ebp
  memmove(mem, init, sz);
801069fc:	e9 2f db ff ff       	jmp    80104530 <memmove>
    panic("inituvm: more than a page");
80106a01:	c7 04 24 39 78 10 80 	movl   $0x80107839,(%esp)
80106a08:	e8 53 99 ff ff       	call   80100360 <panic>
...
80106a20:	0f 85 98 00 00 00    	jne    80106abe <loaduvm+0xae>
...
80106a2f:	eb 77                	jmp    80106aa8 <loaduvm+0x98>
...
80106a47:	76 5f                	jbe    80106aa8 <loaduvm+0x98>
80106a49:	8b 55 0c             	mov    0xc(%ebp),%edx
    if((pte = walkpgdir(pgdir, addr+i, 0)) == 0)
80106a4c:	31 c9                	xor    %ecx,%ecx
80106a4e:	8b 45 08             	mov    0x8(%ebp),%eax
80106a51:	01 da                	add    %ebx,%edx
80106a53:	e8 98 fb ff ff       	call   801065f0 <walkpgdir>
80106a58:	85 c0                	test   %eax,%eax
80106a5a:	74 56                	je     80106ab2 <loaduvm+0xa2>
    pa = PTE_ADDR(*pte);
80106a5c:	8b 00                	mov    (%eax),%eax
      n = PGSIZE;
80106a5e:	bf 00 10 00 00       	mov    $0x1000,%edi
80106a63:	8b 4d 14             	mov    0x14(%ebp),%ecx
    pa = PTE_ADDR(*pte);
80106a66:	25 00 f0 ff ff       	and    $0xfffff000,%eax
      n = PGSIZE;
80106a6b:	81 fe 00 10 00 00    	cmp    $0x1000,%esi
80106a71:	0f 42 fe             	cmovb  %esi,%edi
    if(readi(ip, P2V(pa), offset+i, n) != n)
80106a74:	05 00 00 00 80       	add    $0x80000000,%eax
80106a79:	89 44 24 04          	mov    %eax,0x4(%esp)
80106a7d:	8b 45 10             	mov    0x10(%ebp),%eax
80106a80:	01 d9                	add    %ebx,%ecx
80106a82:	89 7c 24 0c          	mov    %edi,0xc(%esp)
80106a86:	89 4c 24 08          	mov    %ecx,0x8(%esp)
80106a8a:	89 04 24             	mov    %eax,(%esp)
80106a8d:	e8 ce ae ff ff       	call   80101960 <readi>
80106a92:	39 f8                	cmp    %edi,%eax
80106a94:	74 a2                	je     80106a38 <loaduvm+0x28>
}
80106a96:	83 c4 1c             	add    $0x1c,%esp
      return -1;
...
80106aa8:	83 c4 1c             	add    $0x1c,%esp
  return 0;
...
80106ab2:	c7 04 24 53 78 10 80 	movl   $0x80107853,(%esp)
80106ab9:	e8 a2 98 ff ff       	call   80100360 <panic>
    panic("loaduvm: addr must be page aligned");
80106abe:	c7 04 24 f4 78 10 80 	movl   $0x801078f4,(%esp)
...
80106ade:	0f 88 7e 00 00 00    	js     80106b62 <allocuvm+0x92>
  if(newsz < oldsz)
80106ae4:	3b 7d 0c             	cmp    0xc(%ebp),%edi
    return oldsz;
80106ae7:	8b 45 0c             	mov    0xc(%ebp),%eax
  if(newsz < oldsz)
80106aea:	72 78                	jb     80106b64 <allocuvm+0x94>
  a = PGROUNDUP(oldsz);
80106aec:	8d 98 ff 0f 00 00    	lea    0xfff(%eax),%ebx
80106af2:	81 e3 00 f0 ff ff    	and    $0xfffff000,%ebx
  for(; a < newsz; a += PGSIZE){
80106af8:	39 df                	cmp    %ebx,%edi
80106afa:	77 4a                	ja     80106b46 <allocuvm+0x76>
80106afc:	eb 72                	jmp    80106b70 <allocuvm+0xa0>
80106afe:	66 90                	xchg   %ax,%ax
    memset(mem, 0, PGSIZE);
80106b00:	c7 44 24 08 00 10 00 	movl   $0x1000,0x8(%esp)
80106b07:	00 
80106b08:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
80106b0f:	00 
80106b10:	89 04 24             	mov    %eax,(%esp)
80106b13:	e8 78 d9 ff ff       	call   80104490 <memset>
    if(mappages(pgdir, (char*)a, PGSIZE, V2P(mem), PTE_W|PTE_U) < 0){
80106b18:	8d 86 00 00 00 80    	lea    -0x80000000(%esi),%eax
80106b1e:	b9 00 10 00 00       	mov    $0x1000,%ecx
80106b23:	89 04 24             	mov    %eax,(%esp)
80106b26:	8b 45 08             	mov    0x8(%ebp),%eax
80106b29:	89 da                	mov    %ebx,%edx
80106b2b:	c7 44 24 04 06 00 00 	movl   $0x6,0x4(%esp)
80106b32:	00 
80106b33:	e8 48 fb ff ff       	call   80106680 <mappages>
80106b38:	85 c0                	test   %eax,%eax
80106b3a:	78 44                	js     80106b80 <allocuvm+0xb0>
  for(; a < newsz; a += PGSIZE){
80106b3c:	81 c3 00 10 00 00    	add    $0x1000,%ebx
80106b42:	39 df                	cmp    %ebx,%edi
80106b44:	76 2a                	jbe    80106b70 <allocuvm+0xa0>
    mem = kalloc();
80106b46:	e8 55 b9 ff ff       	call   801024a0 <kalloc>
    if(mem == 0){
80106b4b:	85 c0                	test   %eax,%eax
    mem = kalloc();
80106b4d:	89 c6                	mov    %eax,%esi
    if(mem == 0){
80106b4f:	75 af                	jne    80106b00 <allocuvm+0x30>
      cprintf("allocuvm out of memory\n");
80106b51:	c7 04 24 71 78 10 80 	movl   $0x80107871,(%esp)
80106b58:	e8 f3 9a ff ff       	call   80100650 <cprintf>
  if(newsz >= oldsz)
80106b5d:	3b 7d 0c             	cmp    0xc(%ebp),%edi
80106b60:	77 48                	ja     80106baa <allocuvm+0xda>
      return 0;
80106b62:	31 c0                	xor    %eax,%eax
}
80106b64:	83 c4 1c             	add    $0x1c,%esp
80106b67:	5b                   	pop    %ebx
80106b68:	5e                   	pop    %esi
80106b69:	5f                   	pop    %edi
80106b6a:	5d                   	pop    %ebp
...
80106b70:	83 c4 1c             	add    $0x1c,%esp
...
80106b80:	c7 04 24 89 78 10 80 	movl   $0x80107889,(%esp)
80106b87:	e8 c4 9a ff ff       	call   80100650 <cprintf>
  if(newsz >= oldsz)
80106b8c:	3b 7d 0c             	cmp    0xc(%ebp),%edi
80106b8f:	76 0d                	jbe    80106b9e <allocuvm+0xce>
80106b91:	8b 4d 0c             	mov    0xc(%ebp),%ecx
80106b94:	89 fa                	mov    %edi,%edx
80106b96:	8b 45 08             	mov    0x8(%ebp),%eax
80106b99:	e8 62 fb ff ff       	call   80106700 <deallocuvm.part.0>
      kfree(mem);
80106b9e:	89 34 24             	mov    %esi,(%esp)
80106ba1:	e8 4a b7 ff ff       	call   801022f0 <kfree>
      return 0;
80106ba6:	31 c0                	xor    %eax,%eax
80106ba8:	eb ba                	jmp    80106b64 <allocuvm+0x94>
80106baa:	8b 4d 0c             	mov    0xc(%ebp),%ecx
80106bad:	89 fa                	mov    %edi,%edx
80106baf:	8b 45 08             	mov    0x8(%ebp),%eax
80106bb2:	e8 49 fb ff ff       	call   80106700 <deallocuvm.part.0>
      return 0;
80106bb7:	31 c0                	xor    %eax,%eax
80106bb9:	eb a9                	jmp    80106b64 <allocuvm+0x94>
80106bbb:	90                   	nop
...
80106bce:	73 08                	jae    80106bd8 <deallocuvm+0x18>
}
80106bd0:	5d                   	pop    %ebp
80106bd1:	e9 2a fb ff ff       	jmp    80106700 <deallocuvm.part.0>
80106bd6:	66 90                	xchg   %ax,%ax
80106bd8:	89 d0                	mov    %edx,%eax
80106bda:	5d                   	pop    %ebp
80106bdb:	c3                   	ret    
...
80106be5:	83 ec 10             	sub    $0x10,%esp
80106be8:	8b 75 08             	mov    0x8(%ebp),%esi
  uint i;

  if(pgdir == 0)
80106beb:	85 f6                	test   %esi,%esi
80106bed:	74 59                	je     80106c48 <freevm+0x68>
80106bef:	31 c9                	xor    %ecx,%ecx
80106bf1:	ba 00 00 00 80       	mov    $0x80000000,%edx
80106bf6:	89 f0                	mov    %esi,%eax
    panic("freevm: no pgdir");
  deallocuvm(pgdir, KERNBASE, 0);
  for(i = 0; i < NPDENTRIES; i++){
80106bf8:	31 db                	xor    %ebx,%ebx
80106bfa:	e8 01 fb ff ff       	call   80106700 <deallocuvm.part.0>
80106bff:	eb 12                	jmp    80106c13 <freevm+0x33>
80106c01:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
80106c08:	83 c3 01             	add    $0x1,%ebx
80106c0b:	81 fb 00 04 00 00    	cmp    $0x400,%ebx
80106c11:	74 27                	je     80106c3a <freevm+0x5a>
    if(pgdir[i] & PTE_P){
80106c13:	8b 14 9e             	mov    (%esi,%ebx,4),%edx
80106c16:	f6 c2 01             	test   $0x1,%dl
80106c19:	74 ed                	je     80106c08 <freevm+0x28>
      char * v = P2V(PTE_ADDR(pgdir[i]));
80106c1b:	81 e2 00 f0 ff ff    	and    $0xfffff000,%edx
  for(i = 0; i < NPDENTRIES; i++){
80106c21:	83 c3 01             	add    $0x1,%ebx
      char * v = P2V(PTE_ADDR(pgdir[i]));
80106c24:	81 c2 00 00 00 80    	add    $0x80000000,%edx
      kfree(v);
80106c2a:	89 14 24             	mov    %edx,(%esp)
80106c2d:	e8 be b6 ff ff       	call   801022f0 <kfree>
  for(i = 0; i < NPDENTRIES; i++){
80106c32:	81 fb 00 04 00 00    	cmp    $0x400,%ebx
80106c38:	75 d9                	jne    80106c13 <freevm+0x33>
    }
  }
  kfree((char*)pgdir);
...
80106c42:	5d                   	pop    %ebp
  kfree((char*)pgdir);
80106c43:	e9 a8 b6 ff ff       	jmp    801022f0 <kfree>
    panic("freevm: no pgdir");
80106c48:	c7 04 24 a5 78 10 80 	movl   $0x801078a5,(%esp)
80106c4f:	e8 0c 97 ff ff       	call   80100360 <panic>
...
80106c68:	e8 33 b8 ff ff       	call   801024a0 <kalloc>
80106c6d:	85 c0                	test   %eax,%eax
80106c6f:	89 c6                	mov    %eax,%esi
80106c71:	74 6d                	je     80106ce0 <setupkvm+0x80>
  memset(pgdir, 0, PGSIZE);
80106c73:	c7 44 24 08 00 10 00 	movl   $0x1000,0x8(%esp)
80106c7a:	00 
  for(k = kmap; k < &kmap[NELEM(kmap)]; k++)
80106c7b:	bb 20 a4 10 80       	mov    $0x8010a420,%ebx
  memset(pgdir, 0, PGSIZE);
80106c80:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
80106c87:	00 
80106c88:	89 04 24             	mov    %eax,(%esp)
80106c8b:	e8 00 d8 ff ff       	call   80104490 <memset>
    if(mappages(pgdir, k->virt, k->phys_end - k->phys_start,
80106c90:	8b 53 0c             	mov    0xc(%ebx),%edx
80106c93:	8b 43 04             	mov    0x4(%ebx),%eax
80106c96:	8b 4b 08             	mov    0x8(%ebx),%ecx
80106c99:	89 54 24 04          	mov    %edx,0x4(%esp)
80106c9d:	8b 13                	mov    (%ebx),%edx
80106c9f:	89 04 24             	mov    %eax,(%esp)
80106ca2:	29 c1                	sub    %eax,%ecx
80106ca4:	89 f0                	mov    %esi,%eax
80106ca6:	e8 d5 f9 ff ff       	call   80106680 <mappages>
80106cab:	85 c0                	test   %eax,%eax
80106cad:	78 19                	js     80106cc8 <setupkvm+0x68>
  for(k = kmap; k < &kmap[NELEM(kmap)]; k++)
80106caf:	83 c3 10             	add    $0x10,%ebx
80106cb2:	81 fb 60 a4 10 80    	cmp    $0x8010a460,%ebx
80106cb8:	72 d6                	jb     80106c90 <setupkvm+0x30>
80106cba:	89 f0                	mov    %esi,%eax
}
...
80106cc4:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
      freevm(pgdir);
80106cc8:	89 34 24             	mov    %esi,(%esp)
80106ccb:	e8 10 ff ff ff       	call   80106be0 <freevm>
}
...
80106ce2:	eb d8                	jmp    80106cbc <setupkvm+0x5c>
...
80106cf3:	83 ec 08             	sub    $0x8,%esp
  kpgdir = setupkvm();
80106cf6:	e8 65 ff ff ff       	call   80106c60 <setupkvm>
80106cfb:	a3 a4 57 11 80       	mov    %eax,0x801157a4
  lcr3(V2P(kpgdir));   // switch to the kernel page table
...
80106d15:	83 ec 18             	sub    $0x18,%esp
  pte = walkpgdir(pgdir, uva, 0);
80106d18:	8b 55 0c             	mov    0xc(%ebp),%edx
80106d1b:	8b 45 08             	mov    0x8(%ebp),%eax
80106d1e:	e8 cd f8 ff ff       	call   801065f0 <walkpgdir>
  if(pte == 0)
...
80106d2b:	c3                   	ret    
    panic("clearpteu");
80106d2c:	c7 04 24 b6 78 10 80 	movl   $0x801078b6,(%esp)
80106d33:	e8 28 96 ff ff       	call   80100360 <panic>
80106d38:	90                   	nop
...
80106d46:	83 ec 2c             	sub    $0x2c,%esp
  ...
  if((d = setupkvm()) == 0)
80106d49:	e8 12 ff ff ff       	call   80106c60 <setupkvm>
80106d4e:	85 c0                	test   %eax,%eax
80106d50:	89 45 e0             	mov    %eax,-0x20(%ebp)
80106d53:	0f 84 b9 00 00 00    	je     80106e12 <copyuvm+0xd2>
    return 0;
  for(i = 0; i < sz; i += PGSIZE){
...
80106d68:	81 c6 00 00 00 80    	add    $0x80000000,%esi
80106d6e:	c7 44 24 08 00 10 00 	movl   $0x1000,0x8(%esp)
80106d75:	00 
80106d76:	89 74 24 04          	mov    %esi,0x4(%esp)
80106d7a:	89 04 24             	mov    %eax,(%esp)
80106d7d:	e8 ae d7 ff ff       	call   80104530 <memmove>
    if(mappages(d, (void*)i, PGSIZE, V2P(mem), flags) < 0) {
80106d82:	8b 45 e4             	mov    -0x1c(%ebp),%eax
80106d85:	b9 00 10 00 00       	mov    $0x1000,%ecx
80106d8a:	89 fa                	mov    %edi,%edx
80106d8c:	89 44 24 04          	mov    %eax,0x4(%esp)
80106d90:	8d 83 00 00 00 80    	lea    -0x80000000(%ebx),%eax
80106d96:	89 04 24             	mov    %eax,(%esp)
80106d99:	8b 45 e0             	mov    -0x20(%ebp),%eax
80106d9c:	e8 df f8 ff ff       	call   80106680 <mappages>
80106da1:	85 c0                	test   %eax,%eax
80106da3:	78 63                	js     80106e08 <copyuvm+0xc8>
  for(i = 0; i < sz; i += PGSIZE){
80106da5:	81 c7 00 10 00 00    	add    $0x1000,%edi
80106dab:	39 7d 0c             	cmp    %edi,0xc(%ebp)
80106dae:	76 48                	jbe    80106df8 <copyuvm+0xb8>
    if((pte = walkpgdir(pgdir, (void *) i, 0)) == 0)
80106db0:	8b 45 08             	mov    0x8(%ebp),%eax
80106db3:	31 c9                	xor    %ecx,%ecx
80106db5:	89 fa                	mov    %edi,%edx
80106db7:	e8 34 f8 ff ff       	call   801065f0 <walkpgdir>
80106dbc:	85 c0                	test   %eax,%eax
80106dbe:	74 62                	je     80106e22 <copyuvm+0xe2>
    if(!(*pte & PTE_P))
80106dc0:	8b 00                	mov    (%eax),%eax
80106dc2:	a8 01                	test   $0x1,%al
80106dc4:	74 50                	je     80106e16 <copyuvm+0xd6>
    pa = PTE_ADDR(*pte);
80106dc6:	89 c6                	mov    %eax,%esi
    flags = PTE_FLAGS(*pte);
80106dc8:	25 ff 0f 00 00       	and    $0xfff,%eax
80106dcd:	89 45 e4             	mov    %eax,-0x1c(%ebp)
    pa = PTE_ADDR(*pte);
80106dd0:	81 e6 00 f0 ff ff    	and    $0xfffff000,%esi
    if((mem = kalloc()) == 0)
80106dd6:	e8 c5 b6 ff ff       	call   801024a0 <kalloc>
80106ddb:	85 c0                	test   %eax,%eax
80106ddd:	89 c3                	mov    %eax,%ebx
80106ddf:	75 87                	jne    80106d68 <copyuvm+0x28>
    }
  }
  return d;
...
bad:
  freevm(d);
80106de1:	8b 45 e0             	mov    -0x20(%ebp),%eax
80106de4:	89 04 24             	mov    %eax,(%esp)
80106de7:	e8 f4 fd ff ff       	call   80106be0 <freevm>
  return 0;
80106dec:	31 c0                	xor    %eax,%eax
}
80106dee:	83 c4 2c             	add    $0x2c,%esp
80106df1:	5b                   	pop    %ebx
80106df2:	5e                   	pop    %esi
80106df3:	5f                   	pop    %edi
80106df4:	5d                   	pop    %ebp
...
80106dfb:	83 c4 2c             	add    $0x2c,%esp
80106dfe:	5b                   	pop    %ebx
80106dff:	5e                   	pop    %esi
80106e00:	5f                   	pop    %edi
80106e01:	5d                   	pop    %ebp
...
80106e04:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
      kfree(mem);
80106e08:	89 1c 24             	mov    %ebx,(%esp)
80106e0b:	e8 e0 b4 ff ff       	call   801022f0 <kfree>
      goto bad;
80106e10:	eb cf                	jmp    80106de1 <copyuvm+0xa1>
    return 0;
80106e12:	31 c0                	xor    %eax,%eax
80106e14:	eb d8                	jmp    80106dee <copyuvm+0xae>
      panic("copyuvm: page not present");
80106e16:	c7 04 24 da 78 10 80 	movl   $0x801078da,(%esp)
80106e1d:	e8 3e 95 ff ff       	call   80100360 <panic>
      panic("copyuvm: pte should exist");
80106e22:	c7 04 24 c0 78 10 80 	movl   $0x801078c0,(%esp)
...
80106e7c:	8b 4d 0c             	mov    0xc(%ebp),%ecx
...
80106e84:	75 3a                	jne    80106ec0 <copyout+0x50>
80106e86:	eb 68                	jmp    80106ef0 <copyout+0x80>
    va0 = (uint)PGROUNDDOWN(va);
    pa0 = uva2ka(pgdir, (char*)va0);
    if(pa0 == 0)
      return -1;
    n = PGSIZE - (va - va0);
80106e88:	8b 4d e4             	mov    -0x1c(%ebp),%ecx
80106e8b:	89 f2                	mov    %esi,%edx
    if(n > len)
      n = len;
    memmove(pa0 + (va - va0), buf, n);
80106e8d:	89 7c 24 04          	mov    %edi,0x4(%esp)
    n = PGSIZE - (va - va0);
80106e91:	29 ca                	sub    %ecx,%edx
80106e93:	81 c2 00 10 00 00    	add    $0x1000,%edx
80106e99:	39 da                	cmp    %ebx,%edx
80106e9b:	0f 47 d3             	cmova  %ebx,%edx
    memmove(pa0 + (va - va0), buf, n);
80106e9e:	29 f1                	sub    %esi,%ecx
80106ea0:	01 c8                	add    %ecx,%eax
80106ea2:	89 54 24 08          	mov    %edx,0x8(%esp)
80106ea6:	89 04 24             	mov    %eax,(%esp)
80106ea9:	89 55 e4             	mov    %edx,-0x1c(%ebp)
80106eac:	e8 7f d6 ff ff       	call   80104530 <memmove>
    len -= n;
    buf += n;
80106eb1:	8b 55 e4             	mov    -0x1c(%ebp),%edx
    va = va0 + PGSIZE;
80106eb4:	8d 8e 00 10 00 00    	lea    0x1000(%esi),%ecx
    buf += n;
80106eba:	01 d7                	add    %edx,%edi
  while(len > 0){
80106ebc:	29 d3                	sub    %edx,%ebx
80106ebe:	74 30                	je     80106ef0 <copyout+0x80>
    pa0 = uva2ka(pgdir, (char*)va0);
80106ec0:	8b 45 08             	mov    0x8(%ebp),%eax
    va0 = (uint)PGROUNDDOWN(va);
80106ec3:	89 ce                	mov    %ecx,%esi
80106ec5:	81 e6 00 f0 ff ff    	and    $0xfffff000,%esi
    pa0 = uva2ka(pgdir, (char*)va0);
80106ecb:	89 74 24 04          	mov    %esi,0x4(%esp)
    va0 = (uint)PGROUNDDOWN(va);
80106ecf:	89 4d e4             	mov    %ecx,-0x1c(%ebp)
    pa0 = uva2ka(pgdir, (char*)va0);
80106ed2:	89 04 24             	mov    %eax,(%esp)
80106ed5:	e8 56 ff ff ff       	call   80106e30 <uva2ka>
    if(pa0 == 0)
80106eda:	85 c0                	test   %eax,%eax
80106edc:	75 aa                	jne    80106e88 <copyout+0x18>
  }
  return 0;
}
80106ede:	83 c4 1c             	add    $0x1c,%esp
      return -1;
...
80106ef0:	83 c4 1c             	add    $0x1c,%esp
  return 0;
