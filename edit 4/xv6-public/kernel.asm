...
80105283:	e8 88 1b 00 00       	call   80106e10 <shm_close>
}
80105288:	c9                   	leave  
80105289:	c3                   	ret    
...
80106d21:	74 77                	je     80106d9a <shm_open+0xaa>
...
80106d2e:	8d 04 5b             	lea    (%ebx,%ebx,2),%eax
80106d31:	c1 e0 02             	shl    $0x2,%eax
80106d34:	83 80 fc 54 11 80 01 	addl   $0x1,-0x7feeab04(%eax)
   uint va = PGROUNDUP(cur->sz);
80106d3b:	8b 16                	mov    (%esi),%edx
...
80106d3d:	8b 80 f8 54 11 80    	mov    -0x7feeab08(%eax),%eax
80106d43:	c7 44 24 10 06 00 00 	movl   $0x6,0x10(%esp)
80106d4a:	00 
80106d4b:	c7 44 24 08 00 10 00 	movl   $0x1000,0x8(%esp)
80106d52:	00 
   uint va = PGROUNDUP(cur->sz);
80106d53:	8d 9a ff 0f 00 00    	lea    0xfff(%edx),%ebx
80106d59:	81 e3 00 f0 ff ff    	and    $0xfffff000,%ebx
   mappages(cur->pgdir, (void *)va, PGSIZE, V2P(shm_table.shm_pages[i].frame), PTE_W | PTE_U);
80106d5f:	05 00 00 00 80       	add    $0x80000000,%eax
80106d64:	89 5c 24 04          	mov    %ebx,0x4(%esp)
80106d68:	89 44 24 0c          	mov    %eax,0xc(%esp)
...
80106d7a:	89 18                	mov    %ebx,(%eax)
   
   //You should also update sz since your virtual address space expanded
   cur->sz = va + PGSIZE;
80106d7c:	81 c3 00 10 00 00    	add    $0x1000,%ebx
80106d82:	89 1e                	mov    %ebx,(%esi)
   release(&(shm_table.lock));
80106d84:	c7 04 24 c0 54 11 80 	movl   $0x801154c0,(%esp)
80106d8b:	e8 b0 d4 ff ff       	call   80104240 <release>
   return 0; //added to remove compiler warning -- you should decide what to return
}
80106d90:	83 c4 2c             	add    $0x2c,%esp
...
80106d99:	c3                   	ret    
  for(i = 0; i < max; ++i) {
80106d9a:	b8 f4 54 11 80       	mov    $0x801154f4,%eax
80106d9f:	30 db                	xor    %bl,%bl
80106da1:	eb 10                	jmp    80106db3 <shm_open+0xc3>
80106da3:	90                   	nop
80106da4:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
	   for(i = 0; i < max; ++i) {
80106da8:	83 c3 01             	add    $0x1,%ebx
80106dab:	83 c0 0c             	add    $0xc,%eax
80106dae:	83 fb 40             	cmp    $0x40,%ebx
80106db1:	74 15                	je     80106dc8 <shm_open+0xd8>
		   if(!shm_table.shm_pages[i].id && !shm_table.shm_pages[i].frame && !shm_table.shm_pages[i].refcnt) {
80106db3:	8b 38                	mov    (%eax),%edi
80106db5:	85 ff                	test   %edi,%edi
80106db7:	75 ef                	jne    80106da8 <shm_open+0xb8>
80106db9:	8b 48 04             	mov    0x4(%eax),%ecx
80106dbc:	85 c9                	test   %ecx,%ecx
80106dbe:	75 e8                	jne    80106da8 <shm_open+0xb8>
80106dc0:	8b 50 08             	mov    0x8(%eax),%edx
80106dc3:	85 d2                	test   %edx,%edx
80106dc5:	75 e1                	jne    80106da8 <shm_open+0xb8>
80106dc7:	90                   	nop
	   shm_table.shm_pages[i].id = id;
80106dc8:	8d 3c 5b             	lea    (%ebx,%ebx,2),%edi
80106dcb:	c1 e7 02             	shl    $0x2,%edi
80106dce:	89 b7 f4 54 11 80    	mov    %esi,-0x7feeab0c(%edi)
	   mem = kalloc();
80106dd4:	e8 d7 b6 ff ff       	call   801024b0 <kalloc>
	   memset(mem, 0, PGSIZE);
80106dd9:	c7 44 24 08 00 10 00 	movl   $0x1000,0x8(%esp)
80106de0:	00 
80106de1:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
80106de8:	00 
	   mem = kalloc();
80106de9:	89 c6                	mov    %eax,%esi
	   memset(mem, 0, PGSIZE);
80106deb:	89 04 24             	mov    %eax,(%esp)
80106dee:	e8 9d d4 ff ff       	call   80104290 <memset>
	   shm_table.shm_pages[i].frame = mem;
80106df3:	89 b7 f8 54 11 80    	mov    %esi,-0x7feeab08(%edi)
	   shm_table.shm_pages[i].refcnt = 1;
80106df9:	c7 87 fc 54 11 80 01 	movl   $0x1,-0x7feeab04(%edi)
80106e00:	00 00 00 
80106e03:	e9 1f ff ff ff       	jmp    80106d27 <shm_open+0x37>
80106e08:	90                   	nop
...
80106e14:	83 ec 14             	sub    $0x14,%esp
80106e17:	8b 5d 08             	mov    0x8(%ebp),%ebx
   //you write this too!
   acquire(&(shm_table.lock));
80106e1a:	c7 04 24 c0 54 11 80 	movl   $0x801154c0,(%esp)
80106e21:	e8 2a d3 ff ff       	call   80104150 <acquire>
80106e26:	b8 f4 54 11 80       	mov    $0x801154f4,%eax
80106e2b:	eb 0d                	jmp    80106e3a <shm_close+0x2a>
80106e2d:	8d 76 00             	lea    0x0(%esi),%esi
80106e30:	83 c0 0c             	add    $0xc,%eax
   unsigned int i;
   for (i = 0; i < 64; ++i) {
80106e33:	3d f4 57 11 80       	cmp    $0x801157f4,%eax
80106e38:	74 1b                	je     80106e55 <shm_close+0x45>
	   //Find the shared memory page id to close
	   if (shm_table.shm_pages[i].id == id) {
80106e3a:	3b 18                	cmp    (%eax),%ebx
80106e3c:	75 f2                	jne    80106e30 <shm_close+0x20>
		   //Decrement the count if ther shared memory page has a reference count
		   if (shm_table.shm_pages[i].refcnt >= 0) {
80106e3e:	8b 50 08             	mov    0x8(%eax),%edx
80106e41:	85 d2                	test   %edx,%edx
80106e43:	78 2b                	js     80106e70 <shm_close+0x60>
			   --shm_table.shm_pages[i].refcnt;
80106e45:	83 ea 01             	sub    $0x1,%edx
80106e48:	83 c0 0c             	add    $0xc,%eax
80106e4b:	89 50 fc             	mov    %edx,-0x4(%eax)
   for (i = 0; i < 64; ++i) {
80106e4e:	3d f4 57 11 80       	cmp    $0x801157f4,%eax
80106e53:	75 e5                	jne    80106e3a <shm_close+0x2a>
			   shm_table.shm_pages[i].frame = 0;
			   shm_table.shm_pages[i].refcnt = 0;
		   }
	   }
   ...
   release(&(shm_table.lock));
80106e55:	c7 04 24 c0 54 11 80 	movl   $0x801154c0,(%esp)
80106e5c:	e8 df d3 ff ff       	call   80104240 <release>
   return 0; //added to remove compiler warning -- you should decide what to return
}
80106e61:	83 c4 14             	add    $0x14,%esp
...
80106e70:	c7 00 00 00 00 00    	movl   $0x0,(%eax)
			   shm_table.shm_pages[i].frame = 0;
80106e76:	c7 40 04 00 00 00 00 	movl   $0x0,0x4(%eax)
			   shm_table.shm_pages[i].refcnt = 0;
80106e7d:	c7 40 08 00 00 00 00 	movl   $0x0,0x8(%eax)
80106e84:	eb aa                	jmp    80106e30 <shm_close+0x20>
